...
`;function Ee(){const t=c.useRef(null);return c.useEffect(()=>{const n=t.current;if(!n)return;const o=requestAnimationFrame(()=>n.classList.add("ss-cursor-ready"));let d=-1,l=-1;const a=s=>{n.style.left=s.clientX+"px",n.style.top=s.clientY+"px",d>=0&&(s.clientX!==d||s.clientY!==l)&&(n.style.opacity="1"),d=s.clientX,l=s.clientY},g=()=>{n.style.opacity="0"},p=s=>s.preventDefault();return window.addEventListener("mousemove",a),document.addEventListener("mouseleave",g),document.addEventListener("dragstart",p),()=>{cancelAnimationFrame(o),window.removeEventListener("mousemove",a),document.removeEventListener("mouseleave",g),document.removeEventListener("dragstart",p)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function L(){const t=c.useCallback(()=>document.body.classList.add("ss-hover"),[]),n=c.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:n}}const P=[.32,.72,0,1],T=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,$={initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:T?.001:.28,ease:"linear"}};function Se(){const[t,n]=c.useState("home"),[o,d]=c.useState(null),[l,a]=c.useState(null),g=t==="about";c.useEffect(()=>{if(document.getElementById("ss-global"))return;const s=document.createElement("style");s.id="ss-global",s.innerHTML=ke,document.head.appendChild(s)},[]),c.useEffect(()=>{const s=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=s,document.body.style.backgroundColor=s},[t]);const p=c.useCallback(s=>{s!==t&&(d(null),a(null),n(s))},[t]);return c.useEffect(()=>{const s=r=>{if(l){r.key==="Escape"&&a(null);return}if(o){r.key==="Escape"&&d(null);return}};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[l,o]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(Ee,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:ve.map(s=>e.jsx("li",{children:e.jsx(Te,{label:s.charAt(0).toUpperCase()+s.slice(1),active:t===s,onClick:()=>p(s),onLight:g})},s))})]}),e.jsxs(K,{children:[t==="home"&&e.jsx(Ce,{onNavigate:p},"home"),t==="work"&&e.jsx(Ve,{onCardClick:d},"work"),t==="about"&&e.jsx(xe,{},"about"),t==="contact"&&e.jsx(Ye,{},"contact")]}),e.jsx(K,{children:o&&e.jsx(Ke,{project:o,onClose:()=>d(null),onMediaClick:a})}),e.jsx(K,{children:l&&e.jsx(Je,{item:l,onClose:()=>a(null),onItemClick:a})})]})}function Te({label:t,active:n,onClick:o,onLight:d}){const l=L();return e.jsx("button",{onClick:o,"aria-current":n?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:n?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:d?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:n?1:.86,textShadow:d?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...l,children:t})}function je(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const n=t.__realmSupported();return{ok:!!n.ok,why:n.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const ie=["Shyon","Shiri"],Ne=P,Ae={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Ie={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ne}}};function Re({isMobile:t}){return e.jsx(b.h1,{className:"ss-hero-name","aria-label":ie.join(" "),variants:Ae,initial:"hidden",animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:ie.map(n=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...n].map((o,d)=>e.jsx(b.span,{className:"ss-hero-ch",variants:Ie,children:o},n+d))},n))})}function Ce({onNavigate:t}){const[n,o]=c.useState(!1),[d,l]=c.useState(window.innerWidth<=640),[a]=c.useState(je),g=L(),p=c.useRef(null),[s,r]=c.useState(!1),f=c.useRef(!1);c.useEffect(()=>{const y=()=>{l(window.innerWidth<=640)};return window.addEventListener("resize",y),()=>window.removeEventListener("resize",y)},[]);const w=c.useRef(null);c.useEffect(()=>()=>w.current?.(),[]);const v=y=>{w.current?.();const h=p.current;h&&y==="open"&&(h.dataset.locked="false",r(!0));const A=h?.querySelector(`[data-slide="${y}"]`);if(!h||!A)return;const H=h.scrollTop,R=Math.min(h.scrollHeight-h.clientHeight,H+A.getBoundingClientRect().top-h.getBoundingClientRect().top);if(T){h.scrollTo({top:R,behavior:"instant"});return}const u=R-H,j=Math.min(2600,1200+Math.abs(u)*.45)*.75,B=performance.now(),C=h.style.scrollSnapType,I=h.style.scrollBehavior;h.style.scrollSnapType="none",h.style.scrollBehavior="auto";let E=0;const S=()=>{cancelAnimationFrame(E),h.style.scrollSnapType=C,h.style.scrollBehavior=I,h.removeEventListener("wheel",S),h.removeEventListener("touchstart",S),h.removeEventListener("pointerdown",S),window.removeEventListener("keydown",S),w.current=null};w.current=S,h.addEventListener("wheel",S,{passive:!0}),h.addEventListener("touchstart",S,{passive:!0}),h.addEventListener("pointerdown",S,{passive:!0}),window.addEventListener("keydown",S);const N=O=>{const i=Math.min(1,(O-B)/j),m=(1-Math.cos(Math.PI*i))/2;h.scrollTop=H+u*m,i<1?E=requestAnimationFrame(N):S()};E=requestAnimationFrame(N)};return e.jsxs(b.div,{...$,ref:p,className:"ss-home-page ss-home-scroll","data-locked":!s,onScroll:y=>{const h=y.currentTarget;s&&(h.scrollTop>4&&(f.current=!0),f.current&&h.scrollTop<=1&&(w.current?.(),f.current=!1,h.dataset.locked="true",r(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>o(!0),className:n?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:d?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Re,{isMobile:d}),e.jsxs(b.div,{className:"ss-hero-summary",initial:T?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:T?0:.5,ease:P},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>v("open"),...g,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(Y,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(b.img,{className:"ss-open-img",variants:ne,src:"/assets/story/story_sunset.jpg",alt:"The cottage and footbridge beside the river at sunset.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(X,{className:"ss-open-title",text:"My LEGO Portfolio",variant:ce,stagger:.07}),e.jsx(X,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:oe,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(Y,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(re,{pair:!0,kicker:"Navigation",body:"The coffee shop opens client work, the cottage holds selected projects, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it"})]})}),e.jsxs(Y,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(re,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(Me,{})]})]}),e.jsxs(Y,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(b.img,{className:"ss-open-img",variants:ne,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(b.dl,{className:"ss-figs",variants:de,children:Le.map(y=>e.jsxs(b.div,{className:"ss-fig",variants:De,children:[e.jsxs("dd",{children:[y.n,e.jsx("i",{children:y.unit})]}),e.jsx("dt",{children:y.label})]},y.label))}),e.jsx(X,{className:"ss-open-line",text:a.ok?"Controls are displayed on entry.":"View my LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:oe,stagger:.018}),e.jsxs(b.div,{variants:he,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[a.ok?e.jsxs("a",{href:"/lego.html",...g,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),a.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:y=>{(y.key==="Enter"||y.key===" ")&&t("work")},...g,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:a.ok?"or browse the work":"Browse the work"})]})]})]})]}),s&&e.jsx(Ue,{scrollRef:p})]},"home")}const z=P,Pe={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},de={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},ce={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:z}}},oe={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:z}}},he={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:z}}},Be={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:z}}},He={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:z,staggerChildren:.13,delayChildren:.14}}},ne={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:z}}};function X({text:t,variant:n,className:o,style:d}){const l=[];return t.split(`
`).forEach((a,g)=>{g>0&&l.push(e.jsx("br",{},"br"+g));const p=a.split(" ");p.forEach((s,r)=>l.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[s,r<p.length-1?" ":""]},g+"-"+r)))}),e.jsx(b.p,{className:o,style:d,variants:n,children:l})}const Oe={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:P}}},q=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function Me(){const[t,n]=c.useState(0);return e.jsxs(b.div,{className:"ss-sheet",variants:de,children:[e.jsx("div",{className:"ss-sheet-grid",children:q.map((o,d)=>e.jsxs(b.button,{className:`ss-cell${d===t?" on":""}`,variants:He,onMouseEnter:()=>n(d),onFocus:()=>n(d),"aria-label":o.scene,children:[e.jsx(b.span,{className:"ss-cell-shot",variants:Oe,children:e.jsx("img",{src:o.src,alt:o.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:o.scene})]},o.src))}),e.jsxs(b.p,{className:"ss-sheet-cap",variants:Be,children:[e.jsx("b",{children:q[t].scene}),q[t].caption]})]})}const Le=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],De={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:P}}},J=[{id:"shop",name:"The Coffee Shop",cat:"Client Work",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU streetwear brand."}],ze={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:P}}},_e={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:P}}};function Fe(){const t=c.useRef(null),n=c.useRef(null),[o,d]=c.useState({left:0,top:0,w:0,h:0}),[l,a]=c.useState({w:0,h:0}),[g,p]=c.useState({l:0,r:0}),[s,r]=c.useState(0),[f,w]=c.useState(null),[v,y]=c.useState(!1);c.useEffect(()=>{const u=t.current;if(!u)return;const j=2400,B=1350,C=()=>{const E=u.getBoundingClientRect();if(!E.width||!E.height)return;const S=Math.min(E.width/j,E.height/B),N=j*S,O=B*S;d({left:(E.width-N)/2,top:(E.height-O)/2,w:N,h:O});const i=document.documentElement.clientWidth;let m=0,k=i;for(let x=u;x&&x!==document.documentElement;x=x.parentElement)if(getComputedStyle(x).overflowX!=="visible"){const W=x.getBoundingClientRect();m=Math.max(m,W.left),k=Math.min(k,W.right)}p({l:m+8-E.left,r:Math.min(k-8,i-64)-E.left}),a({w:E.width,h:E.height})};C();const I=new ResizeObserver(C);return I.observe(u),()=>I.disconnect()},[]),c.useLayoutEffect(()=>{if(!f)return;const u=n.current;u&&r(u.offsetHeight)},[f,l.w]);const h=J.find(u=>u.id===f)||null,A=h?H(h):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(b.div,{className:"ss-map-stage",ref:t,variants:he,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:o.left,top:o.top,width:o.w,height:o.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),J.map(u=>e.jsxs(b.button,{variants:ze,className:`ss-map-pin${u.flip?" flip":""}${f===u.id?" on":""}`+(f===u.id&&A?.covered?" hushed":""),style:{left:u.x+"%",top:u.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{v||w(u.id)},onMouseLeave:()=>{v||w(null)},onFocus:()=>w(u.id),onClick:()=>{const j=f===u.id&&v;y(!j),w(j?null:u.id)},"aria-label":u.name+", "+u.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:u.cat})]},u.id))]})]}),R()]});function H(u){if(!l.w||!o.w)return;const j=10,B=20,C=16,I=Math.min(l.w*.28,306),E=s||I*9/16+104,S=D=>({x:o.left+o.w*D.x/100,y:o.top+o.h*D.y/100}),N=S(u),O=J.filter(D=>D.id!==u.id).map(S),i=u.x<50,m=u.y<55,k=[[i,m],[i,!m],[!i,m],[!i,!m]];let x=null;for(const[D,W]of k){const pe=Math.min(j,g.l),me=Math.max(l.w-j,g.r),_=Math.max(pe,Math.min(D?N.x+B:N.x-B-I,me-I)),F=Math.max(j,Math.min(W?N.y+B:N.y-B-E,l.h-E-j));let G=10*O.filter(U=>U.x>_-C&&U.x<_+I+C&&U.y>F-C&&U.y<F+E+C).length;const Z=14+7.6*u.cat.length,Q=u.flip?N.x-10-Z:N.x+10,ee=Q<_+I+4&&Q+Z>_-4&&N.y-11<F+E+4&&N.y+11>F-4;ee&&G++;const te={left:_,top:F,hits:G,tag:ee};if(!G){x=te;break}(!x||G<x.hits)&&(x=te)}return{style:{left:x.left,top:x.top,right:"auto",bottom:"auto"},covered:x.tag}}function R(){return e.jsx(K,{children:h&&e.jsxs(b.div,{ref:n,className:"ss-map-card",style:A?.style,variants:_e,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:h.src,alt:h.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:h.name}),e.jsx("p",{children:h.line})]})]},h.id)})}}function Y({id:t,label:n,className:o,stagger:d,children:l}){const a=d?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Pe;return e.jsx(b.section,{className:`ss-slide ss-snap${o?" "+o:""}`,"data-slide":t,"data-label":n,variants:a,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:l})})}function We(t){const[n,o]=c.useState(T?1:0);return c.useEffect(()=>{if(T)return;const d=t.current;if(!d)return;const l=d.closest(".ss-home-scroll");let a=0;const g=()=>{a=0;const s=window.innerHeight||1,r=d.getBoundingClientRect(),f=(s-r.top)/Math.max(1,r.height*.75);o(f<0?0:f>1?1:f)},p=()=>{a||(a=requestAnimationFrame(g))};return(l||window).addEventListener("scroll",p,{passive:!0}),window.addEventListener("resize",p),g(),()=>{a&&cancelAnimationFrame(a),(l||window).removeEventListener("scroll",p),window.removeEventListener("resize",p)}},[t]),n}function Ge({text:t,p:n}){const o=t.split(" "),d=o.length;return e.jsx(e.Fragment,{children:o.map((l,a)=>{const g=a/d*.82,p=Math.min(1,Math.max(0,(n-g)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*p).toFixed(3)})`,transition:"color .12s linear"},children:[l,a<d-1?" ":""]},l+a)})})}function re({kicker:t,body:n,pair:o,children:d}){const l=e.jsx(X,{className:"ss-story-kicker",text:t,variant:ce,stagger:.055}),a=c.useRef(null),g=We(a),p=e.jsx(Ge,{text:n,p:g});return o?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:l}),e.jsx("div",{className:"ss-chapter-body",ref:a,children:p})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[l,e.jsx("div",{className:"ss-chapter-body",ref:a,children:p}),d]})}function Ue({scrollRef:t}){const[n,o]=c.useState([]),[d,l]=c.useState(0),a=c.useRef([]);c.useEffect(()=>{const s=t.current;if(!s)return;const r=Array.from(s.querySelectorAll("[data-slide]"));a.current=r,o(r.map(w=>({id:w.dataset.slide||"",label:w.dataset.label||""})));const f=new IntersectionObserver(w=>{for(const v of w)if(v.isIntersecting){const y=a.current.indexOf(v.target);y>=0&&l(y)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return r.forEach(w=>f.observe(w)),()=>f.disconnect()},[t]);const g=s=>{const r=t.current,f=a.current[s];!r||!f||r.scrollTo({top:r.scrollTop+f.getBoundingClientRect().top-r.getBoundingClientRect().top,behavior:T?"auto":"smooth"})};if(n.length<2)return null;const p=d>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${p?" on":""}`,"aria-hidden":!p,children:n.map((s,r)=>e.jsx("button",{type:"button",className:`ss-deck-tick${r===d?" on":""}`,onClick:()=>g(r),"aria-label":s.label,"aria-current":r===d,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:s.label})},s.id))}),e.jsxs("div",{className:`ss-deck-count${p?" on":""}`,children:[e.jsx("b",{children:String(d+1).padStart(2,"0")})," / ",String(n.length).padStart(2,"0")]})]})}function le({index:t,orbit:n,radius:o,style:d,...l}){const a=se(n,p=>{const s=(t-p)*2*Math.PI/M.length,r=Math.sin(s)*o/Math.sin(2*Math.PI/M.length),f=(Math.cos(s)-1)*220;return`translate3d(${r}px,0,${f}px) rotateY(${-Math.sin(s)*34}deg) scale(${.9+.1*Math.cos(s)})`}),g=se(n,p=>Math.round((Math.cos((t-p)*2*Math.PI/M.length)+1)*100)+1);return e.jsx(b.div,{...l,draggable:!1,onDragStart:p=>p.preventDefault(),style:{...d,transform:a,zIndex:g,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const n=L(),[o,d]=c.useState({width:window.innerWidth,height:window.innerHeight}),l=o.width>=1024;c.useEffect(()=>{const i=()=>{d({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]);const a=M.length,[g,p]=c.useState(0),s=(g%a+a)%a,r=fe(0),[f,w]=c.useState(!1),v=i=>{r.stop(),w(!0),we(r,i,{duration:T?0:.62,ease:P,onComplete:()=>{p(i),w(!1)}})};c.useEffect(()=>()=>r.stop(),[r]);const y=i=>{v(i+Math.round((r.get()-i)/a)*a)},h=c.useRef(null),A=c.useRef(!1),H=i=>v(Math.round(r.get())+i),R=o.width<=640,u=l?380:Math.min(o.width*(R?.64:.7),R?290:330),j=Math.min(u*1.32,Math.max(R?230:290,o.height*(R?.42:.5))),B=u*(l?1.4:R?1.08:1.24),C={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},I=M[s]?.id,E=I==="professional-services",S=E?"#14110b":"var(--white)",N=E?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",O=C[I]||C["creative-projects"];return e.jsx(b.div,{...$,className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:R?"max(580px, 100dvh)":"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(b.div,{"aria-hidden":"true",animate:{backgroundColor:O.base},transition:{duration:T?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(C).map(([i,m])=>e.jsx(b.div,{"aria-hidden":"true",animate:{opacity:i===I?1:0},transition:{duration:T?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:m.glow}},i)),e.jsx("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:e.jsx(b.h2,{initial:T?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:S,textShadow:N,transition:"color 0.7s ease"},children:"Work"})}),e.jsx("div",{className:"ss-work-carousel",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:"50%",height:j+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pinch-zoom",userSelect:"none"},onPointerDown:i=>{!i.isPrimary||i.button!==0||(h.current={id:i.pointerId,x:i.clientX,y:i.clientY,dragging:!1,orbitStart:r.get()},A.current=!1)},onPointerMove:i=>{const m=h.current;if(!m||m.id!==i.pointerId)return;const k=i.clientX-m.x,x=i.clientY-m.y;Math.hypot(k,x)>8&&(A.current=!0),!m.dragging&&Math.abs(k)>10&&Math.abs(k)>Math.abs(x)*1.25&&(m.dragging=!0,r.stop(),w(!0),m.orbitStart=r.get(),i.currentTarget.setPointerCapture(i.pointerId)),m.dragging&&r.set(m.orbitStart-Math.max(-.65,Math.min(.65,k*.65/u)))},onPointerUp:i=>{const m=h.current;if(!m||m.id!==i.pointerId)return;const k=i.clientX-m.x,x=i.clientY-m.y;m.dragging&&Math.abs(k)>=Math.max(28,u*.12)&&Math.abs(k)>Math.abs(x)*1.25?v(Math.round(m.orbitStart)+(k<0?1:-1)):m.dragging&&v(Math.round(r.get())),h.current=null,i.currentTarget.hasPointerCapture(i.pointerId)&&i.currentTarget.releasePointerCapture(i.pointerId)},onPointerCancel:()=>{h.current=null,A.current=!0,v(Math.round(r.get()))},onLostPointerCapture:i=>{h.current?.id===i.pointerId&&(h.current=null,A.current=!0,v(Math.round(r.get())))},onClickCapture:i=>{A.current&&i.detail!==0&&(i.preventDefault(),i.stopPropagation())},onKeyDown:i=>{if(i.key==="ArrowLeft"||i.key==="ArrowRight"){i.preventDefault();const m=(s+(i.key==="ArrowRight"?1:-1)+a)%a,k=i.currentTarget;y(m),requestAnimationFrame(()=>k.querySelectorAll('[role="button"]')[m]?.focus({preventScroll:!0}))}},children:M.map((i,m)=>{const k=(m-s+a)%a;return i.id==="nabu"?e.jsxs(le,{index:m,orbit:r,radius:B,className:"ss-project-card ss-project-card-nabu","data-active":k===0&&!f,role:"button",tabIndex:0,"aria-label":`${k===0?"Open":"Select"} ${i.title}`,onKeyDown:x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),k===0&&!f?t(i):y(m))},onClick:()=>{A.current||(k===0&&!f?t(i):y(m))},...n,style:{position:"absolute",width:u,height:j,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(u,j*.78)*25.5/1080}px, ${-Math.min(u,j*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:S,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:i.title})})]},i.id):e.jsxs(le,{index:m,orbit:r,radius:B,role:"button",tabIndex:0,"aria-label":`${k===0?"Open":"Select"} ${i.title}`,onKeyDown:x=>{(x.key==="Enter"||x.key===" ")&&(x.preventDefault(),k===0&&!f?t(i):y(m))},className:"ss-card ss-project-card","data-active":k===0&&!f,onClick:()=>{A.current||(k===0&&!f?t(i):y(m))},...n,style:{position:"absolute",width:u,height:j,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:i.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:R?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:i.title})})})]},i.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:R?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>H(-1),style:{color:S,width:44,height:44},children:"←"}),M.map((i,m)=>e.jsx("button",{type:"button","aria-label":`Show ${i.title}`,"aria-pressed":m===s,onClick:()=>y(m),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:m===s?26:8,height:8,borderRadius:980,background:m===s?"#38bdf8":E?"#777":"#aaa",transition:"width .3s ease"}})},i.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>H(1),style:{color:S,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=L(),n=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(b.div,{...$,className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(b.h2,{initial:T?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(b.p,{initial:T?!1:{opacity:0},animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(b.div,{initial:T?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:n.map(o=>e.jsxs("a",{className:"ss-contact-entry",href:o.href,target:o.target,rel:o.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:o.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:o.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},o.label))})]})]},"contact")}function Ke({project:t,onClose:n,onMediaClick:o}){const d=L(),l=c.useRef(null);c.useEffect(()=>{const s=document.activeElement,r=l.current;r?.querySelector("button")?.focus({preventScroll:!0});const f=w=>{if(w.key!=="Tab"||!r)return;const v=Array.from(r.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(A=>A.getClientRects().length>0),y=v[0],h=v[v.length-1];w.shiftKey&&document.activeElement===y?(w.preventDefault(),h?.focus()):!w.shiftKey&&document.activeElement===h&&(w.preventDefault(),y?.focus())};return r?.addEventListener("keydown",f),()=>{r?.removeEventListener("keydown",f),s?.isConnected&&s.focus({preventScroll:!0})}},[]);const[a,g]=c.useState(window.innerWidth),p=a>=1024;return c.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),c.useEffect(()=>{const s=()=>{g(window.innerWidth)};return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),e.jsx(b.div,{ref:l,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:T?.001:.4},onClick:n,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(b.div,{initial:{opacity:0,scale:T?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:T?1:.96},transition:{duration:T?.001:.4,ease:P},onClick:s=>s.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:n,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...d,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const s=t.media.filter(w=>!w.hidden),r=a<=640?2:a<=1023?3:4,f=Array.from({length:r},()=>[]);return s.forEach((w,v)=>f[v%r].push(w)),f.map((w,v)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:w.map((y,h)=>e.jsx(Xe,{item:y,onClick:()=>o(y)},h))},v))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(s=>!s.hidden).map((s,r)=>e.jsx(qe,{item:s,onClick:()=>o(s)},r))}),!p&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse"})]})})}function Xe({item:t,onClick:n}){const o=L(),d=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:n,...o,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:d},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({item:t,onClick:n}){const o=L();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:n,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...o,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Je({item:t,onClose:n,onItemClick:o}){const d=L(),l=c.useRef(null);c.useEffect(()=>{const g=document.activeElement,p=l.current;p?.querySelector("button")?.focus({preventScroll:!0});const s=r=>{if(r.key!=="Tab"||!p)return;const f=Array.from(p.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(y=>y.getClientRects().length>0),w=f[0],v=f[f.length-1];r.shiftKey&&document.activeElement===w?(r.preventDefault(),v?.focus()):!r.shiftKey&&document.activeElement===v&&(r.preventDefault(),w?.focus())};return p?.addEventListener("keydown",s),()=>{p?.removeEventListener("keydown",s),g?.isConnected&&g.focus({preventScroll:!0})}},[]);const a=t;return e.jsx(b.div,{ref:l,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:T?.001:.25},onClick:n,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(b.div,{initial:{opacity:0,scale:T?1:.985},animate:{opacity:1,scale:1},exit:{opacity:0,scale:1},transition:{duration:T?.001:.25,ease:P},onClick:g=>g.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:n,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...d,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:a.removeBackground?"transparent":"inherit",position:"relative"},children:a.type==="video"?e.jsx("video",{src:a.src,poster:a.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},a.src):e.jsx("img",{src:a.src,alt:a.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:a.scale?`scale(${a.scale})`:"scale(1)"}},a.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((g,p)=>e.jsxs("button",{onClick:()=>{const s=M.flatMap(r=>r.media).find(r=>r.title===g);s&&o&&o(s)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...d,children:["View ",g," →"]},p))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...d,children:"Visit Website →"})]})]})})}be.createRoot(document.getElementById("root")).render(e.jsx(c.StrictMode,{children:e.jsx(Se,{})}));
