...
`;function xe(){const t=r.useRef(null);return r.useEffect(()=>{const i=t.current;if(!i)return;const n=requestAnimationFrame(()=>i.classList.add("ss-cursor-ready"));let l=-1,a=-1;const s=c=>{i.style.left=c.clientX+"px",i.style.top=c.clientY+"px",l>=0&&(c.clientX!==l||c.clientY!==a)&&(i.style.opacity="1"),l=c.clientX,a=c.clientY},h=()=>{i.style.opacity="0"},m=c=>c.preventDefault();return window.addEventListener("mousemove",s),document.addEventListener("mouseleave",h),document.addEventListener("dragstart",m),()=>{cancelAnimationFrame(n),window.removeEventListener("mousemove",s),document.removeEventListener("mouseleave",h),document.removeEventListener("dragstart",m)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function P(){const t=r.useCallback(()=>document.body.classList.add("ss-hover"),[]),i=r.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:i}}const E=[.32,.72,0,1],D=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,$=D?{initial:{opacity:0},animate:{opacity:1,transition:{duration:.001}},exit:{opacity:0,transition:{duration:.001}}}:{initial:{opacity:0,scale:1.012},animate:{opacity:1,scale:1,transition:{duration:.62,ease:E,opacity:{duration:.42,ease:"linear"}}},exit:{opacity:0,transition:{duration:.42,ease:"linear"}}};function ve(){const[t,i]=r.useState("home"),[n,l]=r.useState(null),[a,s]=r.useState(null),[h,m]=r.useState(window.innerWidth>=1024),c=O.indexOf(t),d=t==="about",w=r.useRef(!1),v=P();r.useEffect(()=>{if(document.getElementById("ss-global"))return;const o=document.createElement("style");o.id="ss-global",o.innerHTML=be,document.head.appendChild(o)},[]),r.useEffect(()=>{const o=()=>{m(window.innerWidth>=1024)};return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[]),r.useEffect(()=>{const o=t==="about"?"#ede8e0":"#060606";document.documentElement.style.backgroundColor=o,document.body.style.backgroundColor=o},[t]);const T=r.useRef(c);r.useEffect(()=>{T.current=c},[c]);const R=r.useRef(t);r.useEffect(()=>{R.current=t},[t]);const j=r.useRef(!1);r.useEffect(()=>{j.current=!!n||!!a},[n,a]);const S=r.useCallback(o=>{o!==t&&(l(null),s(null),i(o))},[t]);r.useEffect(()=>{const o=u=>{if(j.current||w.current||R.current==="home"||R.current==="work"&&window.innerWidth<1024)return;const y=u.target;if(y.closest(".ss-modal-grid")||y.closest(".ss-media-viewer")||Math.abs(u.deltaX)>Math.abs(u.deltaY)*.5)return;const p=u.deltaY>0?1:-1,f=Math.max(0,Math.min(O.length-1,T.current+p));f!==T.current&&(w.current=!0,i(O[f]),setTimeout(()=>{w.current=!1},1100))};return window.addEventListener("wheel",o,{passive:!0}),()=>window.removeEventListener("wheel",o)},[]);const N=r.useRef(0),H=r.useRef(0);return r.useEffect(()=>{const o=y=>{N.current=y.touches[0].clientY,H.current=y.touches[0].clientX},u=y=>{if(j.current||w.current||R.current==="home"||R.current==="work"||y.target.closest(".ss-modal-grid"))return;const f=N.current-y.changedTouches[0].clientY,b=H.current-y.changedTouches[0].clientX;if(Math.abs(f)<120||Math.abs(f)<Math.abs(b)*3)return;const k=f>0?1:-1,A=Math.max(0,Math.min(O.length-1,T.current+k));A!==T.current&&(w.current=!0,i(O[A]),setTimeout(()=>{w.current=!1},1100))};return window.addEventListener("touchstart",o,{passive:!0}),window.addEventListener("touchend",u,{passive:!0}),()=>{window.removeEventListener("touchstart",o),window.removeEventListener("touchend",u)}},[]),r.useEffect(()=>{const o=u=>{if(a){u.key==="Escape"&&s(null);return}if(n){u.key==="Escape"&&l(null);return}t!=="home"&&((u.key==="ArrowDown"||u.key==="ArrowRight")&&i(O[Math.min(O.length-1,c+1)]),(u.key==="ArrowUp"||u.key==="ArrowLeft")&&i(O[Math.max(0,c-1)]))};return window.addEventListener("keydown",o),()=>window.removeEventListener("keydown",o)},[c,a,n]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx(xe,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:O.map(o=>e.jsx("li",{children:e.jsx(ke,{label:o.charAt(0).toUpperCase()+o.slice(1),active:t===o,onClick:()=>S(o),onLight:d})},o))})]}),e.jsx("div",{style:{position:"fixed",right:"max(32px, calc(32px + env(safe-area-inset-right)))",top:"50%",transform:"translateY(-50%)",zIndex:400,display:"flex",flexDirection:"column",gap:12},children:O.map(o=>e.jsx("button",{onClick:()=>S(o),className:"ss-tap","aria-label":o,style:{width:10,height:10,borderRadius:"50%",border:`1px solid ${d?"rgba(20,17,11,.42)":"rgba(245,242,237,.4)"}`,background:t===o?d?"#14110b":"var(--white)":"transparent",transform:t===o?"scale(1.5)":"scale(1)",transition:"all 0.4s ease",cursor:"none",position:"relative"},...v},o))}),e.jsxs(K,{children:[t==="home"&&e.jsx(Ae,{onNavigate:S},"home"),t==="work"&&e.jsx(Fe,{onCardClick:l},"work"),t==="about"&&e.jsx(Ge,{},"about"),t==="contact"&&e.jsx(Ue,{},"contact")]}),e.jsx(K,{children:n&&e.jsx(Ve,{project:n,onClose:()=>l(null),onMediaClick:s})}),e.jsx(K,{children:a&&e.jsx(qe,{item:a,onClose:()=>s(null),onItemClick:s})})]})}function ke({label:t,active:i,onClick:n,onLight:l}){const a=P();return e.jsxs("button",{onClick:n,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:l?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:i?1:.86,textShadow:l?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...a,children:[t,e.jsx("span",{style:{position:"absolute",bottom:-4,left:0,height:1,background:"var(--sky)",width:i?"100%":0,transition:"width 0.4s var(--ease-out)",display:"none"}})]})}function Ee(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const i=t.__realmSupported();return{ok:!!i.ok,why:i.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const ne=["Shyon","Shiri"],Te=E,Se={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},je={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Te}}};function Ne({isMobile:t}){return e.jsx(g.h1,{className:"ss-hero-name","aria-label":ne.join(" "),variants:Se,initial:"hidden",animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:ne.map(i=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...i].map((n,l)=>e.jsx(g.span,{className:"ss-hero-ch",variants:je,children:n},i+l))},i))})}function Ae({onNavigate:t}){const[i,n]=r.useState(!1),[l,a]=r.useState(window.innerWidth<=640),[s]=r.useState(Ee),h=P(),m=r.useRef(null);r.useEffect(()=>{const d=()=>{a(window.innerWidth<=640)};return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]);const c=()=>{const d=m.current;d&&d.scrollTo({top:d.clientHeight,behavior:"smooth"})};return e.jsxs(g.div,{...$,ref:m,className:"ss-home-page ss-home-scroll",style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",alt:"",onLoad:()=>n(!0),className:i?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{style:{position:"absolute",bottom:l?"14vh":"24vh",left:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ne,{isMobile:l}),e.jsxs(g.p,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.8,delay:.58,ease:E},style:{marginTop:16,maxWidth:460,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:["Click"," ",e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&t("work")},...h,style:{color:"#38bdf8",textDecoration:"underline",textUnderlineOffset:"3px",textDecorationThickness:"1.5px",fontWeight:600,cursor:"none"},children:"here"})," ","to browse my site, or scroll down for the interactive 3D environment built into it."]})]}),e.jsx(g.button,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:1.15},className:"ss-story-cue",onClick:c,...h,style:{cursor:"none"},children:e.jsx("span",{className:"ss-cue-arrow",children:"▼"})})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(F,{id:"open",label:"My Lego Realm",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(g.img,{className:"ss-open-img",variants:le,src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the Ruins, the Coffee Shop, the Cottage across the river, and the Modern House with a car on its driveway.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(U,{className:"ss-open-title",text:"My Lego Realm",variant:ee,stagger:.07}),e.jsx(U,{className:"ss-open-line",text:"An interactive real-time 3D environment, built brick by brick in Blender. Walk the town and step inside any building to see the work it holds.",variant:re,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(F,{id:"map",label:"The town",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(Z,{pair:!0,kicker:"What it is",body:"A small town built on a LEGO-inspired baseplate. Each structure holds a different branch of the work, and walking into one is how you open it."}),e.jsx(ze,{}),e.jsx("div",{className:"ss-map-hint",children:"Pick a structure to see what it holds"})]})}),e.jsx(F,{id:"why",label:"Why I made it",className:"ss-slide-why",stagger:.2,children:e.jsxs("div",{className:"ss-quiet",children:[e.jsx(Z,{pair:!0,kicker:`Why I
made it`,body:"The environment is a work sample in its own right. Building it took the same disciplines the rest of the portfolio presents, hard-surface modeling and UV work in Blender, real-time rendering and collision in the browser, and the front-end engineering that ties the two together. It also goes back to where my work started, stop-motion films built from LEGO, and to the technologies I have taken on since."}),e.jsx(Ce,{scene:"The player figure",src:"/assets/story/story_figure_front.jpg",caption:"A younger me by design. Assembled from separate parts rather than one mesh: each was modeled and textured on its own, then measured into place and bound to the rig at load time."})]})}),e.jsxs(F,{id:"shop",label:"How I made it",className:"ss-slide-shop",stagger:.18,children:[e.jsx(Z,{pair:!0,kicker:`How I
made it`,body:"Every structure was assembled from individual bricks in Blender. Most are my own builds, with some free assets worked in and modified to fit. Each model is exported as glTF, Draco compressed, and loaded by a custom Three.js engine that runs directly in the browser. The world uses the exact LEGO stud pitch as its grid, collision is rasterized per brick rather than per bounding box, stair climbing runs on a walkable heightmap, and the lighting completes a full day cycle every seven minutes."}),e.jsx(He,{})]})]}),e.jsxs(F,{id:"close",label:s.ok?"Try it":"The finished build",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(g.img,{className:"ss-open-img",variants:le,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(g.dl,{className:"ss-figs",variants:de,children:Be.map(d=>e.jsxs(g.div,{className:"ss-fig",variants:Oe,children:[e.jsxs("dd",{children:[d.n,e.jsx("i",{children:d.unit})]}),e.jsx("dt",{children:d.label})]},d.label))}),e.jsx(U,{className:"ss-open-title ss-close-title",text:s.ok?"Walk it yourself":"The finished build",variant:ee,stagger:.07}),e.jsx(U,{className:"ss-open-line",text:s.ok?"The full version runs on this site, with the day cycle and all four portals active.":"The full version runs on this site on a desktop or laptop, with the day cycle and all four portals active.",variant:re,stagger:.018}),e.jsxs(g.div,{variants:he,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[s.ok?e.jsxs("a",{href:"/lego.html",...h,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"Enter My Lego Realm"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),s.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:d=>{(d.key==="Enter"||d.key===" ")&&t("work")},...h,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:s.ok?"or browse the work":"Browse the work"})]})]})]})]}),e.jsx(Me,{scrollRef:m})]},"home")}const W=E,Re={hidden:{},show:{transition:{staggerChildren:.14,delayChildren:.06}}},de={hidden:{},show:{transition:{staggerChildren:.11,delayChildren:.04}}},ee={hidden:{opacity:0,y:"0.55em",rotateX:-68,transformPerspective:700},show:{opacity:1,y:"0em",rotateX:0,transition:{duration:.66,ease:W}}},re={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.5,ease:W}}},he={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:W}}},Ie={hidden:{opacity:0,clipPath:"inset(0% 100% 0% 0%)"},show:{opacity:1,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.62,ease:W}}},ce={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:W}}},pe={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:W,staggerChildren:.13,delayChildren:.14}}},le={hidden:{opacity:0,scale:1.09},show:{opacity:1,scale:1,transition:{duration:1.9,ease:W}}};function U({text:t,variant:i,stagger:n=.03,className:l,style:a}){const s=[];return t.split(`
`).forEach((h,m)=>{m>0&&s.push(e.jsx("br",{},"br"+m));const c=h.split(" ");c.forEach((d,w)=>s.push(e.jsxs(g.span,{className:"ss-w",variants:i,style:{display:"inline-block",willChange:"transform"},children:[d,w<c.length-1?" ":""]},m+"-"+w)))}),e.jsx(g.p,{className:l,style:a,variants:{hidden:{},show:{transition:{staggerChildren:n}}},children:s})}const me={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:E}}};function Ce({scene:t,src:i,caption:n}){return e.jsxs(g.figure,{className:"ss-plate",variants:pe,children:[e.jsx(g.span,{className:"ss-plate-label",variants:Ie,children:t}),e.jsx(g.div,{className:"ss-plate-shot",variants:me,children:e.jsx("img",{src:i,alt:t,loading:"lazy",decoding:"async"})}),e.jsx(g.figcaption,{variants:ce,children:n})]})}const J=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The Coffee Shop part way up: walls built to the halfway course, the roof and awning not yet placed, the umbrella pole still bare. Every piece is a separate modeled brick that snaps to the same stud grid the engine uses."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"The ruins in Edit Mode, built up to the doorway arch with the upper storey still to come. The highlighted course is the one going on next."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull prop in the UV Editing workspace. On the left the mesh is unwrapped flat over its painted texture, on the right the same texture is shown mapped onto the model. Every printed detail in the world is applied this way."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The Modern House with the ground floor closed and the upper storey just started. The node graph under the viewport defines the tinted window glass: fully metallic, zero roughness, reduced alpha."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"The Cottage with its walls finished and the roof not yet on, in a rendered viewport under a warm sun. Renders like this were used to check color and lighting before export."}];function He(){const[t,i]=r.useState(0);return e.jsxs(g.div,{className:"ss-sheet",variants:de,children:[e.jsx("div",{className:"ss-sheet-grid",children:J.map((n,l)=>e.jsxs(g.button,{className:`ss-cell${l===t?" on":""}`,variants:pe,onMouseEnter:()=>i(l),onFocus:()=>i(l),"aria-label":n.scene,children:[e.jsx(g.span,{className:"ss-cell-shot",variants:me,children:e.jsx("img",{src:n.src,alt:n.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:n.scene})]},n.src))}),e.jsxs(g.p,{className:"ss-sheet-cap",variants:ce,children:[e.jsx("b",{children:J[t].scene}),J[t].caption]})]})}const Be=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],Oe={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:E}}},Q=[{id:"shop",name:"The Coffee Shop",cat:"Professional Services",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Personal Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Self-directed work. 3D modeling and rendering, product prototypes, custom hardware, photography and fabrication."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU streetwear brand."}],Le={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:E}}},Pe={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:E}}};function ze(){const t=r.useRef(null),i=r.useRef(null),[n,l]=r.useState({left:0,top:0,w:0,h:0}),[a,s]=r.useState({w:0,h:0}),[h,m]=r.useState({l:0,r:0}),[c,d]=r.useState(0),[w,v]=r.useState(null),[T,R]=r.useState(!1);r.useEffect(()=>{const o=t.current;if(!o)return;const u=2400,y=1350,p=()=>{const b=o.getBoundingClientRect();if(!b.width||!b.height)return;const k=Math.min(b.width/u,b.height/y),A=u*k,x=y*k;l({left:(b.width-A)/2,top:(b.height-x)/2,w:A,h:x});const B=document.documentElement.clientWidth;let C=0,L=B;for(let I=o;I&&I!==document.documentElement;I=I.parentElement)if(getComputedStyle(I).overflowX!=="visible"){const V=I.getBoundingClientRect();C=Math.max(C,V.left),L=Math.min(L,V.right)}m({l:C+8-b.left,r:Math.min(L-8,B-64)-b.left}),s({w:b.width,h:b.height})};p();const f=new ResizeObserver(p);return f.observe(o),()=>f.disconnect()},[]),r.useLayoutEffect(()=>{if(!w)return;const o=i.current;o&&d(o.offsetHeight)},[w,a.w]);const j=Q.find(o=>o.id===w)||null,S=j?N(j):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(g.div,{className:"ss-map-stage",ref:t,variants:he,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:n.left,top:n.top,width:n.w,height:n.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),Q.map(o=>e.jsxs(g.button,{variants:Le,className:`ss-map-pin${o.flip?" flip":""}${w===o.id?" on":""}`+(w===o.id&&S?.covered?" hushed":""),style:{left:o.x+"%",top:o.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{T||v(o.id)},onMouseLeave:()=>{T||v(null)},onFocus:()=>v(o.id),onClick:()=>{const u=w===o.id&&T;R(!u),v(u?null:o.id)},"aria-label":o.name+", "+o.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:o.cat})]},o.id))]})]}),H()]});function N(o){if(!a.w||!n.w)return;const u=10,y=20,p=16,f=Math.min(a.w*.28,306),b=c||f*9/16+104,k=z=>({x:n.left+n.w*z.x/100,y:n.top+n.h*z.y/100}),A=k(o),x=Q.filter(z=>z.id!==o.id).map(k),B=o.x<50,C=o.y<55,L=[[B,C],[B,!C],[!B,C],[!B,!C]];let I=null;for(const[z,V]of L){const ge=Math.min(u,h.l),ue=Math.max(a.w-u,h.r),M=Math.max(ge,Math.min(z?A.x+y:A.x-y-f,ue-f)),_=Math.max(u,Math.min(V?A.y+y:A.y-y-b,a.h-b-u));let Y=10*x.filter(X=>X.x>M-p&&X.x<M+f+p&&X.y>_-p&&X.y<_+b+p).length;const te=14+7.6*o.cat.length,ae=o.flip?A.x-10-te:A.x+10,se=ae<M+f+4&&ae+te>M-4&&A.y-11<_+b+4&&A.y+11>_-4;se&&Y++;const ie={left:M,top:_,hits:Y,tag:se};if(!Y){I=ie;break}(!I||Y<I.hits)&&(I=ie)}return{style:{left:I.left,top:I.top,right:"auto",bottom:"auto"},covered:I.tag}}function H(){return e.jsx(K,{children:j&&e.jsxs(g.div,{ref:i,className:"ss-map-card",style:S?.style,variants:Pe,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:j.src,alt:j.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:j.name}),e.jsx("p",{children:j.line})]})]},j.id)})}}function F({id:t,label:i,className:n,stagger:l,children:a}){const s=l?{hidden:{},show:{transition:{staggerChildren:l,delayChildren:.06}}}:Re;return e.jsx(g.section,{className:`ss-slide ss-snap${n?" "+n:""}`,"data-slide":t,"data-label":i,variants:s,initial:"hidden",whileInView:"show",viewport:{amount:.35},children:e.jsx("div",{className:"ss-slide-inner",children:a})})}function De(t){const[i,n]=r.useState(D?1:0);return r.useEffect(()=>{if(D)return;const l=t.current;if(!l)return;const a=l.closest(".ss-home-scroll");let s=0;const h=()=>{s=0;const c=window.innerHeight||1,d=l.getBoundingClientRect(),w=(c-d.top)/Math.max(1,d.height*.75);n(w<0?0:w>1?1:w)},m=()=>{s||(s=requestAnimationFrame(h))};return(a||window).addEventListener("scroll",m,{passive:!0}),window.addEventListener("resize",m),h(),()=>{s&&cancelAnimationFrame(s),(a||window).removeEventListener("scroll",m),window.removeEventListener("resize",m)}},[t]),i}function We({text:t,p:i}){const n=t.split(" "),l=n.length;return e.jsx(e.Fragment,{children:n.map((a,s)=>{const h=s/l*.82,m=Math.min(1,Math.max(0,(i-h)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*m).toFixed(3)})`,transition:"color .12s linear"},children:[a,s<l-1?" ":""]},a+s)})})}function Z({kicker:t,body:i,pair:n,children:l}){const a=e.jsx(U,{className:"ss-story-kicker",text:t,variant:ee,stagger:.055}),s=r.useRef(null),h=De(s),m=e.jsx(We,{text:i,p:h});return n?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:a}),e.jsx("div",{className:"ss-chapter-body",ref:s,children:m})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[a,e.jsx("div",{className:"ss-chapter-body",ref:s,children:m}),l]})}function Me({scrollRef:t}){const[i,n]=r.useState([]),[l,a]=r.useState(0),s=r.useRef([]);r.useEffect(()=>{const c=t.current;if(!c)return;const d=Array.from(c.querySelectorAll("[data-slide]"));s.current=d,n(d.map(v=>({id:v.dataset.slide||"",label:v.dataset.label||""})));const w=new IntersectionObserver(v=>{for(const T of v)if(T.isIntersecting){const R=s.current.indexOf(T.target);R>=0&&a(R)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return d.forEach(v=>w.observe(v)),()=>w.disconnect()},[t]);const h=c=>{const d=t.current,w=s.current[c];!d||!w||d.scrollTo({top:d.scrollTop+w.getBoundingClientRect().top-d.getBoundingClientRect().top,behavior:"smooth"})};if(i.length<2)return null;const m=l>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${m?" on":""}`,"aria-hidden":!m,children:i.map((c,d)=>e.jsx("button",{type:"button",className:`ss-deck-tick${d===l?" on":""}`,onClick:()=>h(d),"aria-label":c.label,"aria-current":d===l,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:c.label})},c.id))}),e.jsxs("div",{className:`ss-deck-count${m?" on":""}`,children:[e.jsx("b",{children:String(l+1).padStart(2,"0")})," / ",String(i.length).padStart(2,"0")]})]})}function _e({base:t,emit:i}){const n=r.useRef(null),l=r.useRef({base:t,emit:i});return r.useEffect(()=>{l.current={base:t,emit:i}},[t,i]),r.useEffect(()=>{const a=n.current;if(!a)return;const s=a.getContext("2d");if(!s)return;const h=Math.min(window.devicePixelRatio||1,2);let m=0,c=0,d=0,w=performance.now();const v=()=>{m=a.clientWidth,c=a.clientHeight,a.width=Math.max(1,Math.floor(m*h)),a.height=Math.max(1,Math.floor(c*h)),s.setTransform(h,0,0,h,0,0)};v(),window.addEventListener("resize",v);const T=Array.from({length:12},()=>({x:Math.random(),y:Math.random(),r:110+Math.random()*280,vx:(Math.random()-.5)*.024,vy:(Math.random()-.5)*.024,ph:Math.random()*Math.PI*2,sp:.07+Math.random()*.12,a:.14+Math.random()*.12})),R=o=>{const u=o.replace("#",""),y=parseInt(u.length===3?u.split("").map(p=>p+p).join(""):u,16);return{r:y>>16&255,g:y>>8&255,b:y&255}},j=o=>{const u=o.split(",").map(Number);return{r:u[0],g:u[1],b:u[2]}},S=R(t),N=j(i),H=o=>{const u=Math.min(.05,(o-w)/1e3);w=o;const y=R(l.current.base),p=j(l.current.emit),f=Math.min(1,u*1.3);S.r+=(y.r-S.r)*f,S.g+=(y.g-S.g)*f,S.b+=(y.b-S.b)*f,N.r+=(p.r-N.r)*f,N.g+=(p.g-N.g)*f,N.b+=(p.b-N.b)*f,s.fillStyle=`rgb(${S.r|0},${S.g|0},${S.b|0})`,s.fillRect(0,0,m,c);const b=N.r|0,k=N.g|0,A=N.b|0;for(const x of T){x.x+=x.vx*u,x.y+=x.vy*u,x.ph+=x.sp*u,x.x<-.2&&(x.x=1.2),x.x>1.2&&(x.x=-.2),x.y<-.2&&(x.y=1.2),x.y>1.2&&(x.y=-.2);const B=(x.x+Math.sin(x.ph)*.02)*m,C=(x.y+Math.cos(x.ph*.8)*.02)*c,L=s.createRadialGradient(B,C,0,B,C,x.r);L.addColorStop(0,`rgba(${b},${k},${A},${x.a})`),L.addColorStop(1,`rgba(${b},${k},${A},0)`),s.fillStyle=L,s.beginPath(),s.arc(B,C,x.r,0,Math.PI*2),s.fill()}d=requestAnimationFrame(H)};return d=requestAnimationFrame(H),()=>{cancelAnimationFrame(d),window.removeEventListener("resize",v)}},[]),e.jsx("canvas",{ref:n,"aria-hidden":!0,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block",zIndex:0}})}function Fe({onCardClick:t}){const i=P(),[n,l]=r.useState(window.innerWidth>=1024);r.useEffect(()=>{const p=()=>{l(window.innerWidth>=1024)};return window.addEventListener("resize",p),()=>window.removeEventListener("resize",p)},[]);const[a,s]=r.useState(0),h=G.length,m=r.useRef(0),c=r.useRef(!1);r.useEffect(()=>{const p=setTimeout(()=>s(f=>(f+1)%h),3e4);return()=>clearTimeout(p)},[a,h]);const d=p=>s(f=>(f+p+h)%h),w=window.innerWidth<=640,v=n?380:Math.min(window.innerWidth*.7,330),T=Math.min(v*1.32,window.innerHeight*.56),R=v*(n?1.12:.7),j={"creative-projects":{base:"#030b05",emit:"46,224,120"},"professional-services":{base:"#ffffff",emit:"150,152,158"},nabu:{base:"#0d1015",emit:"84,168,255"}},S=G[a]?.id,N=S==="professional-services",H=N?"#14110b":"var(--white)",o=H,u=N?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",y=j[S]||j["creative-projects"];return e.jsxs(g.div,{...$,style:{position:"absolute",inset:0,overflow:"hidden",background:"#0c0d0f"},children:[e.jsx(_e,{base:y.base,emit:y.emit}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,pointerEvents:"none",opacity:.03,backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='wn'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23wn)'/%3E%3C/svg%3E")`,backgroundSize:"180px"}}),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"44px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(g.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8,delay:.1,ease:E},style:{fontSize:"clamp(38px,5vw,84px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:H,textShadow:u,transition:"color 0.7s ease"},children:"Work"}),e.jsx(g.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.35,ease:E},style:{marginTop:10,maxWidth:640},children:n&&e.jsx("p",{style:{fontSize:15,lineHeight:1.45,color:o,textShadow:u,transition:"color 0.7s ease"},children:"Commissioned client work, plus personal and academic projects across various mediums."})})]}),e.jsx("div",{style:{position:"absolute",left:0,right:0,top:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",perspective:1800,touchAction:"pan-y",userSelect:"none"},onPointerDown:p=>{m.current=p.clientX,c.current=!1},onPointerMove:p=>{Math.abs(p.clientX-m.current)>8&&(c.current=!0)},onPointerUp:p=>{const f=p.clientX-m.current;f<-48?d(1):f>48&&d(-1)},children:G.map((p,f)=>{const b=(f-a+h)%h,k=b===0?{x:0,scale:1,rotateY:0,opacity:1,z:3}:b===1?{x:R,scale:.82,rotateY:-14,opacity:1,z:2}:{x:-R,scale:.82,rotateY:14,opacity:1,z:2};return p.id==="nabu"?e.jsxs(g.div,{animate:{x:k.x,scale:k.scale,rotateY:k.rotateY,opacity:k.opacity},transition:{duration:.6,ease:E},onClick:()=>{c.current||(b===0?t(p):s(f))},...i,style:{position:"absolute",width:v,height:T,zIndex:k.z,cursor:"none",transformStyle:"preserve-3d",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:p.img,alt:p.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",display:"block",pointerEvents:"none",filter:b===0?"drop-shadow(0 26px 55px rgba(0,0,0,.55))":"none",transition:"filter .5s ease"}}),e.jsxs("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:H,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:p.title}),e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginTop:7},children:p.tag})]})]},p.id):e.jsxs(g.div,{className:"ss-card",animate:{x:k.x,scale:k.scale,rotateY:k.rotateY,opacity:k.opacity},transition:{duration:.6,ease:E},onClick:()=>{c.current||(b===0?t(p):s(f))},...i,style:{position:"absolute",width:v,height:T,zIndex:k.z,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:b===0?"0 40px 90px rgba(0,0,0,.6)":"0 20px 50px rgba(0,0,0,.5)",transformStyle:"preserve-3d"},children:[e.jsx("img",{src:p.img,alt:p.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:p.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"24px 22px",pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginBottom:6},children:p.tag}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:p.title}),b===0&&e.jsx("span",{style:{fontSize:13,color:"var(--white)",whiteSpace:"nowrap",fontWeight:500},children:"View →"})]})]})]},p.id)})}),e.jsx("div",{style:{position:"absolute",bottom:w?22:30,left:0,right:0,display:"flex",justifyContent:"center",gap:9,zIndex:20},children:G.map((p,f)=>e.jsx("div",{onClick:()=>s(f),...i,style:{width:f===a?26:8,height:8,borderRadius:980,background:f===a?"#38bdf8":N?"rgba(20,17,11,.3)":"rgba(245,242,237,.28)",cursor:"none",transition:"all .45s var(--ease-out)"}},f))})]},"work")}function Ge(){const[t,i]=r.useState(!1);return e.jsx(g.div,{...$,style:{position:"absolute",inset:0,background:"var(--cream)",overflow:"hidden"},className:"ss-about-page",children:e.jsxs("div",{className:"ss-about-grid",style:{display:"grid",gridTemplateColumns:"1fr 1fr",height:"100%",width:"100%"},children:[e.jsxs("div",{className:"ss-about-text-column",style:{display:"flex",flexDirection:"column",justifyContent:"center",padding:"clamp(32px, 6vh, 80px) 60px clamp(32px, 6vh, 80px) 8vw",overflow:"hidden"},children:[e.jsx(g.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.7,delay:.1,ease:E},className:"ss-about-subtitle",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--accent)",marginBottom:14},children:"Designer & Maker"}),e.jsx(g.h2,{initial:{opacity:0,x:-30},animate:{opacity:1,x:0},transition:{duration:.8,delay:.2,ease:E},style:{fontFamily:"var(--sf)",fontSize:"clamp(44px,5.2vw,88px)",fontWeight:700,letterSpacing:"-0.035em",lineHeight:1.03,color:"#060606",marginBottom:18},children:"About Me"}),e.jsx(g.div,{className:"ss-about-rule",initial:{width:0},animate:{width:80},transition:{duration:1,delay:.5,ease:E},style:{height:1,background:"#060606",margin:"16px 0"}}),e.jsxs(g.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.55,ease:E},children:[e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:17,fontWeight:400,lineHeight:1.55,letterSpacing:"-0.005em",color:"#3a3a3a",maxWidth:480},children:"I'm a graphic designer and developer in the Bay Area, with a BA in Graphic Design from San Jose State, 2025. I take a project from identity through to a deployed site, so design, front end, and deployment are one job rather than three handoffs. I also evaluate multimodal AI systems against rubrics, writing the corrected ground truth where models fail."}),e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:17,fontWeight:400,lineHeight:1.55,letterSpacing:"-0.005em",color:"#3a3a3a",maxWidth:480,marginTop:20},children:"Most of what I design ends up physical or interactive rather than sitting on a page. That is why the same portfolio holds 3D-printed hardware enclosures, a welded steel sculpture, and a LEGO world running in this browser."})]})]}),e.jsxs(g.div,{className:"ss-about-photo-col",initial:{opacity:0},animate:{opacity:1},transition:{duration:.9,delay:.1},style:{position:"relative",overflow:"hidden",background:"#1a1a1a"},children:[e.jsx("img",{src:"/assets/Shyon_About.png",alt:"Shyon Shiri",onLoad:()=>i(!0),className:t?"ss-about-photo ss-about-photo-active":"ss-about-photo",style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 10%",filter:"grayscale(20%) contrast(1.05)"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to right, rgba(237,232,224,.2) 0%, transparent 30%), linear-gradient(to bottom, rgba(6,6,6,.35) 0%, transparent 30%, transparent 60%, rgba(6,6,6,.18) 100%)"}})]})]})},"about")}function Ue(){const t=P(),i=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(g.div,{...$,style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}}),e.jsxs("div",{style:{position:"relative",zIndex:10,padding:window.innerWidth<=640?"0 18px":"0 9vw",width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(g.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.9,delay:.35,ease:E},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:700,letterSpacing:"-0.038em",lineHeight:1.02,color:"var(--white)"},children:["Let's Work",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(g.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:.5},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(g.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.65,ease:E},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:i.map((n,l)=>e.jsxs("a",{href:n.href,target:n.target,rel:n.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},onMouseEnter:a=>{a.currentTarget.style.background="rgba(56,189,248,.07)",a.currentTarget.style.paddingLeft="24px"},onMouseLeave:a=>{a.currentTarget.style.background="transparent",a.currentTarget.style.paddingLeft="8px"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?11:12.5,fontWeight:600,letterSpacing:"0.02em",fontVariantNumeric:"tabular-nums",color:"var(--sky)",width:34,flexShrink:0},children:String(l+1).padStart(2,"0")}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:n.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:n.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},n.label))})]})]},"contact")}function Ve({project:t,onClose:i,onMediaClick:n}){const l=P(),[a,s]=r.useState(window.innerWidth>=1024);return r.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),r.useEffect(()=>{const h=()=>{s(window.innerWidth>=1024)};return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),e.jsx(g.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:D?.001:.4},onClick:i,style:{position:"fixed",inset:0,zIndex:2e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(g.div,{initial:{opacity:0,scale:D?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:D?1:.96},transition:{duration:D?.001:.4,ease:E},onClick:h=>h.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:i,className:"ss-modal-close",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...l,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"A selection of projects that demonstrate my range across various creative disciplines and mediums.":t.id==="professional-services"?"Client-focused work including UI/UX, web development, branding and marketing assets.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const h=t.media.filter(d=>!d.hidden),m=window.innerWidth<=640?2:window.innerWidth<=1023?3:4,c=Array.from({length:m},()=>[]);return h.forEach((d,w)=>c[w%m].push(d)),c.map((d,w)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:d.map((v,T)=>e.jsx(Ye,{item:v,onClick:()=>n(v)},T))},w))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, 220px)",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(h=>!h.hidden).map((h,m)=>e.jsx(Xe,{item:h,onClick:()=>n(h)},m))}),!a&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"↻ Swipe to explore"})]})})}function Ye({item:t,onClick:i}){const n=P(),l=t.aspectRatio||"4/3";return e.jsxs("div",{className:"ss-scell",onClick:i,...n,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:l},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:t.year})]})]})}function Xe({item:t,onClick:i}){const n=P();return e.jsxs("div",{className:"ss-tile",onClick:i,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...n,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:t.year})]})]})}function qe({item:t,onClose:i,onItemClick:n}){const l=P(),a=t;return e.jsx(g.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.35},onClick:i,style:{position:"fixed",inset:0,zIndex:3e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(g.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.96},transition:{duration:.35,ease:E},onClick:s=>s.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:i,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...l,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:a.removeBackground?"transparent":"inherit",position:"relative"},children:a.type==="video"?e.jsx("video",{src:a.src,poster:a.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},a.src):e.jsx("img",{src:a.src,alt:a.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:a.scale?`scale(${a.scale})`:"scale(1)"}},a.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:t.year}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((s,h)=>e.jsxs("button",{onClick:()=>{const m=G.flatMap(c=>c.media).find(c=>c.title===s);m&&n&&n(m)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...l,children:["View ",s," →"]},h))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...l,children:"Visit Website →"})]})]})})}ye.createRoot(document.getElementById("root")).render(e.jsx(r.StrictMode,{children:e.jsx(ve,{})}));
