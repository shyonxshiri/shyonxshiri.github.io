...
`;function Ee(){const t=h.useRef(null);return h.useEffect(()=>{const l=t.current;if(!l)return;const o=requestAnimationFrame(()=>l.classList.add("ss-cursor-ready"));let c=-1,d=-1;const s=i=>{l.style.left=i.clientX+"px",l.style.top=i.clientY+"px",c>=0&&(i.clientX!==c||i.clientY!==d)&&(l.style.opacity="1"),c=i.clientX,d=i.clientY},m=()=>{l.style.opacity="0"},g=i=>i.preventDefault();return window.addEventListener("mousemove",s),document.addEventListener("mouseleave",m),document.addEventListener("dragstart",g),()=>{cancelAnimationFrame(o),window.removeEventListener("mousemove",s),document.removeEventListener("mouseleave",m),document.removeEventListener("dragstart",g)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function O(){const t=h.useCallback(()=>document.body.classList.add("ss-hover"),[]),l=h.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:l}}const C=[.32,.72,0,1],v=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,Z={initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:v?.001:.28,ease:"linear"}};function Se(){const[t,l]=h.useState("home"),[o,c]=h.useState(null),[d,s]=h.useState(null),m=t==="about";h.useEffect(()=>{if(document.getElementById("ss-global"))return;const i=document.createElement("style");i.id="ss-global",i.innerHTML=ke,document.head.appendChild(i)},[]),h.useEffect(()=>{const i=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=i,document.body.style.backgroundColor=i},[t]);const g=h.useCallback(i=>{i!==t&&(c(null),s(null),l(i))},[t]);return h.useEffect(()=>{const i=r=>{if(d){r.key==="Escape"&&s(null);return}if(o){r.key==="Escape"&&c(null);return}};return window.addEventListener("keydown",i),()=>window.removeEventListener("keydown",i)},[d,o]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(Ee,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:ve.map(i=>e.jsx("li",{children:e.jsx(Te,{label:i.charAt(0).toUpperCase()+i.slice(1),active:t===i,onClick:()=>g(i),onLight:m})},i))})]}),e.jsxs(X,{children:[t==="home"&&e.jsx(Ce,{onNavigate:g},"home"),t==="work"&&e.jsx(Ve,{onCardClick:c},"work"),t==="about"&&e.jsx(xe,{},"about"),t==="contact"&&e.jsx(Ye,{},"contact")]}),e.jsx(X,{children:o&&e.jsx(Ke,{project:o,onClose:()=>c(null),onMediaClick:s})}),e.jsx(X,{children:d&&e.jsx(Je,{item:d,onClose:()=>s(null),onItemClick:s})})]})}function Te({label:t,active:l,onClick:o,onLight:c}){const d=O();return e.jsx("button",{onClick:o,"aria-current":l?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:l?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:c?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:l?1:.86,textShadow:c?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...d,children:t})}function je(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const l=t.__realmSupported();return{ok:!!l.ok,why:l.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const ie=["Shyon","Shiri"],Ne=C,Ae={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Ie={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ne}}};function Re({isMobile:t}){return e.jsx(w.h1,{className:"ss-hero-name","aria-label":ie.join(" "),variants:Ae,initial:"hidden",animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:ie.map(l=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...l].map((o,c)=>e.jsx(w.span,{className:"ss-hero-ch",variants:Ie,children:o},l+c))},l))})}function Ce({onNavigate:t}){const[l,o]=h.useState(!1),[c,d]=h.useState(window.innerWidth<=640),[s]=h.useState(je),m=O(),g=h.useRef(null);h.useEffect(()=>{const p=()=>{d(window.innerWidth<=640)};return window.addEventListener("resize",p),()=>window.removeEventListener("resize",p)},[]);const i=h.useRef(null);h.useEffect(()=>()=>i.current?.(),[]);const r=p=>{i.current?.();const n=g.current,b=n?.querySelector(`[data-slide="${p}"]`);if(!n||!b)return;const x=n.scrollTop,S=Math.min(n.scrollHeight-n.clientHeight,x+b.getBoundingClientRect().top-n.getBoundingClientRect().top);if(v){n.scrollTo({top:S,behavior:"instant"});return}const j=S-x,P=Math.min(2600,1200+Math.abs(j)*.45)*.75,H=performance.now(),f=n.style.scrollSnapType,N=n.style.scrollBehavior;n.style.scrollSnapType="none",n.style.scrollBehavior="auto";let I=0;const k=()=>{cancelAnimationFrame(I),n.style.scrollSnapType=f,n.style.scrollBehavior=N,n.removeEventListener("wheel",k),n.removeEventListener("touchstart",k),n.removeEventListener("pointerdown",k),window.removeEventListener("keydown",k),i.current=null};i.current=k,n.addEventListener("wheel",k,{passive:!0}),n.addEventListener("touchstart",k,{passive:!0}),n.addEventListener("pointerdown",k,{passive:!0}),window.addEventListener("keydown",k);const A=T=>{const B=Math.min(1,(T-H)/P),a=(1-Math.cos(Math.PI*B))/2;n.scrollTop=x+j*a,B<1?I=requestAnimationFrame(A):k()};I=requestAnimationFrame(A)};return e.jsxs(w.div,{...Z,ref:g,className:"ss-home-page ss-home-scroll",style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>o(!0),className:l?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:c?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Re,{isMobile:c}),e.jsxs(w.div,{className:"ss-hero-summary",initial:v?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:v?0:.5,ease:C},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>r("open"),...m,children:"View My LEGO Portfolio"})})]})]}),e.jsx(w.button,{initial:v?!1:{opacity:0},animate:{opacity:1},transition:{duration:.35,delay:v?0:.7},className:"ss-story-cue",onClick:()=>r("open"),"aria-label":"Scroll to my LEGO Portfolio",...m,style:{cursor:"none"},children:e.jsx("span",{className:"ss-cue-arrow",children:"▼"})})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(K,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(w.img,{className:"ss-open-img",variants:ne,src:"/assets/story/story_sunset.jpg",alt:"The cottage and footbridge beside the river at sunset.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(q,{className:"ss-open-title",text:"My LEGO Portfolio",variant:ce,stagger:.07}),e.jsx(q,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:oe,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(K,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(re,{pair:!0,kicker:"Navigation",body:"The coffee shop opens client work, the cottage holds selected projects, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it"})]})}),e.jsxs(K,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(re,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(Me,{})]})]}),e.jsxs(K,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(w.img,{className:"ss-open-img",variants:ne,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(w.dl,{className:"ss-figs",variants:de,children:Le.map(p=>e.jsxs(w.div,{className:"ss-fig",variants:De,children:[e.jsxs("dd",{children:[p.n,e.jsx("i",{children:p.unit})]}),e.jsx("dt",{children:p.label})]},p.label))}),e.jsx(q,{className:"ss-open-line",text:s.ok?"Controls are displayed on entry.":"View my LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:oe,stagger:.018}),e.jsxs(w.div,{variants:he,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[s.ok?e.jsxs("a",{href:"/lego.html",...m,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),s.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:p=>{(p.key==="Enter"||p.key===" ")&&t("work")},...m,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:s.ok?"or browse the work":"Browse the work"})]})]})]})]}),e.jsx(Ue,{scrollRef:g})]},"home")}const z=C,Pe={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},de={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},ce={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:z}}},oe={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:z}}},he={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:z}}},Be={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:z}}},He={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:z,staggerChildren:.13,delayChildren:.14}}},ne={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:z}}};function q({text:t,variant:l,className:o,style:c}){const d=[];return t.split(`
`).forEach((s,m)=>{m>0&&d.push(e.jsx("br",{},"br"+m));const g=s.split(" ");g.forEach((i,r)=>d.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[i,r<g.length-1?" ":""]},m+"-"+r)))}),e.jsx(w.p,{className:o,style:c,variants:l,children:d})}const Oe={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:C}}},J=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function Me(){const[t,l]=h.useState(0);return e.jsxs(w.div,{className:"ss-sheet",variants:de,children:[e.jsx("div",{className:"ss-sheet-grid",children:J.map((o,c)=>e.jsxs(w.button,{className:`ss-cell${c===t?" on":""}`,variants:He,onMouseEnter:()=>l(c),onFocus:()=>l(c),"aria-label":o.scene,children:[e.jsx(w.span,{className:"ss-cell-shot",variants:Oe,children:e.jsx("img",{src:o.src,alt:o.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:o.scene})]},o.src))}),e.jsxs(w.p,{className:"ss-sheet-cap",variants:Be,children:[e.jsx("b",{children:J[t].scene}),J[t].caption]})]})}const Le=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],De={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:C}}},$=[{id:"shop",name:"The Coffee Shop",cat:"Client Work",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU streetwear brand."}],ze={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:C}}},_e={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:C}}};function Fe(){const t=h.useRef(null),l=h.useRef(null),[o,c]=h.useState({left:0,top:0,w:0,h:0}),[d,s]=h.useState({w:0,h:0}),[m,g]=h.useState({l:0,r:0}),[i,r]=h.useState(0),[p,n]=h.useState(null),[b,x]=h.useState(!1);h.useEffect(()=>{const f=t.current;if(!f)return;const N=2400,I=1350,k=()=>{const T=f.getBoundingClientRect();if(!T.width||!T.height)return;const B=Math.min(T.width/N,T.height/I),a=N*B,u=I*B;c({left:(T.width-a)/2,top:(T.height-u)/2,w:a,h:u});const y=document.documentElement.clientWidth;let E=0,_=y;for(let R=f;R&&R!==document.documentElement;R=R.parentElement)if(getComputedStyle(R).overflowX!=="visible"){const G=R.getBoundingClientRect();E=Math.max(E,G.left),_=Math.min(_,G.right)}g({l:E+8-T.left,r:Math.min(_-8,y-64)-T.left}),s({w:T.width,h:T.height})};k();const A=new ResizeObserver(k);return A.observe(f),()=>A.disconnect()},[]),h.useLayoutEffect(()=>{if(!p)return;const f=l.current;f&&r(f.offsetHeight)},[p,d.w]);const S=$.find(f=>f.id===p)||null,j=S?P(S):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(w.div,{className:"ss-map-stage",ref:t,variants:he,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:o.left,top:o.top,width:o.w,height:o.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),$.map(f=>e.jsxs(w.button,{variants:ze,className:`ss-map-pin${f.flip?" flip":""}${p===f.id?" on":""}`+(p===f.id&&j?.covered?" hushed":""),style:{left:f.x+"%",top:f.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{b||n(f.id)},onMouseLeave:()=>{b||n(null)},onFocus:()=>n(f.id),onClick:()=>{const N=p===f.id&&b;x(!N),n(N?null:f.id)},"aria-label":f.name+", "+f.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:f.cat})]},f.id))]})]}),H()]});function P(f){if(!d.w||!o.w)return;const N=10,I=20,k=16,A=Math.min(d.w*.28,306),T=i||A*9/16+104,B=M=>({x:o.left+o.w*M.x/100,y:o.top+o.h*M.y/100}),a=B(f),u=$.filter(M=>M.id!==f.id).map(B),y=f.x<50,E=f.y<55,_=[[y,E],[y,!E],[!y,E],[!y,!E]];let R=null;for(const[M,G]of _){const pe=Math.min(N,m.l),me=Math.max(d.w-N,m.r),F=Math.max(pe,Math.min(M?a.x+I:a.x-I-A,me-A)),W=Math.max(N,Math.min(G?a.y+I:a.y-I-T,d.h-T-N));let U=10*u.filter(V=>V.x>F-k&&V.x<F+A+k&&V.y>W-k&&V.y<W+T+k).length;const Q=14+7.6*f.cat.length,ee=f.flip?a.x-10-Q:a.x+10,te=ee<F+A+4&&ee+Q>F-4&&a.y-11<W+T+4&&a.y+11>W-4;te&&U++;const se={left:F,top:W,hits:U,tag:te};if(!U){R=se;break}(!R||U<R.hits)&&(R=se)}return{style:{left:R.left,top:R.top,right:"auto",bottom:"auto"},covered:R.tag}}function H(){return e.jsx(X,{children:S&&e.jsxs(w.div,{ref:l,className:"ss-map-card",style:j?.style,variants:_e,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:S.src,alt:S.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:S.name}),e.jsx("p",{children:S.line})]})]},S.id)})}}function K({id:t,label:l,className:o,stagger:c,children:d}){const s=c?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Pe;return e.jsx(w.section,{className:`ss-slide ss-snap${o?" "+o:""}`,"data-slide":t,"data-label":l,variants:s,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:d})})}function We(t){const[l,o]=h.useState(v?1:0);return h.useEffect(()=>{if(v)return;const c=t.current;if(!c)return;const d=c.closest(".ss-home-scroll");let s=0;const m=()=>{s=0;const i=window.innerHeight||1,r=c.getBoundingClientRect(),p=(i-r.top)/Math.max(1,r.height*.75);o(p<0?0:p>1?1:p)},g=()=>{s||(s=requestAnimationFrame(m))};return(d||window).addEventListener("scroll",g,{passive:!0}),window.addEventListener("resize",g),m(),()=>{s&&cancelAnimationFrame(s),(d||window).removeEventListener("scroll",g),window.removeEventListener("resize",g)}},[t]),l}function Ge({text:t,p:l}){const o=t.split(" "),c=o.length;return e.jsx(e.Fragment,{children:o.map((d,s)=>{const m=s/c*.82,g=Math.min(1,Math.max(0,(l-m)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*g).toFixed(3)})`,transition:"color .12s linear"},children:[d,s<c-1?" ":""]},d+s)})})}function re({kicker:t,body:l,pair:o,children:c}){const d=e.jsx(q,{className:"ss-story-kicker",text:t,variant:ce,stagger:.055}),s=h.useRef(null),m=We(s),g=e.jsx(Ge,{text:l,p:m});return o?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:d}),e.jsx("div",{className:"ss-chapter-body",ref:s,children:g})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[d,e.jsx("div",{className:"ss-chapter-body",ref:s,children:g}),c]})}function Ue({scrollRef:t}){const[l,o]=h.useState([]),[c,d]=h.useState(0),s=h.useRef([]);h.useEffect(()=>{const i=t.current;if(!i)return;const r=Array.from(i.querySelectorAll("[data-slide]"));s.current=r,o(r.map(n=>({id:n.dataset.slide||"",label:n.dataset.label||""})));const p=new IntersectionObserver(n=>{for(const b of n)if(b.isIntersecting){const x=s.current.indexOf(b.target);x>=0&&d(x)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return r.forEach(n=>p.observe(n)),()=>p.disconnect()},[t]);const m=i=>{const r=t.current,p=s.current[i];!r||!p||r.scrollTo({top:r.scrollTop+p.getBoundingClientRect().top-r.getBoundingClientRect().top,behavior:v?"auto":"smooth"})};if(l.length<2)return null;const g=c>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${g?" on":""}`,"aria-hidden":!g,children:l.map((i,r)=>e.jsx("button",{type:"button",className:`ss-deck-tick${r===c?" on":""}`,onClick:()=>m(r),"aria-label":i.label,"aria-current":r===c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:i.label})},i.id))}),e.jsxs("div",{className:`ss-deck-count${g?" on":""}`,children:[e.jsx("b",{children:String(c+1).padStart(2,"0")})," / ",String(l.length).padStart(2,"0")]})]})}function le({index:t,orbit:l,radius:o,style:c,...d}){const s=D(l,n=>(t-n)*2*Math.PI/L.length),m=D(s,n=>Math.sin(n)*o/Math.sin(2*Math.PI/L.length)),g=D(s,n=>(Math.cos(n)-1)*220),i=D(s,n=>.9+.1*Math.cos(n)),r=D(s,n=>-Math.sin(n)*34),p=D(s,n=>Math.round((Math.cos(n)+1)*100)+1);return e.jsx(w.div,{...d,style:{...c,x:m,z:g,scale:i,rotateY:r,zIndex:p,backfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const l=O(),[o,c]=h.useState({width:window.innerWidth,height:window.innerHeight}),d=o.width>=1024;h.useEffect(()=>{const a=()=>{c({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]);const s=L.length,[m,g]=h.useState(0),i=(m%s+s)%s,r=fe(0),p=a=>{r.stop(),g(a),we(r,a,{duration:v?0:.62,ease:C})};h.useEffect(()=>()=>r.stop(),[r]);const n=a=>{p(a+Math.round((r.get()-a)/s)*s)},b=h.useRef(null),x=h.useRef(!1),S=a=>p(Math.round(r.get())+a),j=o.width<=640,P=d?380:Math.min(o.width*(j?.64:.7),j?290:330),H=Math.min(P*1.32,Math.max(j?230:290,o.height*(j?.42:.5))),f=P*(d?1.4:j?1.08:1.24),N={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},I=L[i]?.id,k=I==="professional-services",A=k?"#14110b":"var(--white)",T=k?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",B=N[I]||N["creative-projects"];return e.jsx(w.div,{...Z,className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:j?"max(580px, 100dvh)":"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(w.div,{"aria-hidden":"true",animate:{backgroundColor:B.base},transition:{duration:v?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(N).map(([a,u])=>e.jsx(w.div,{"aria-hidden":"true",animate:{opacity:a===I?1:0},transition:{duration:v?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:u.glow}},a)),e.jsx("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:e.jsx(w.h2,{initial:v?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:C},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:A,textShadow:T,transition:"color 0.7s ease"},children:"Work"})}),e.jsx("div",{className:"ss-work-carousel",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:"50%",height:H+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pinch-zoom",userSelect:"none"},onPointerDown:a=>{!a.isPrimary||a.button!==0||(b.current={id:a.pointerId,x:a.clientX,y:a.clientY,dragging:!1,orbitStart:r.get()},x.current=!1)},onPointerMove:a=>{const u=b.current;if(!u||u.id!==a.pointerId)return;const y=a.clientX-u.x,E=a.clientY-u.y;Math.hypot(y,E)>8&&(x.current=!0),!u.dragging&&Math.abs(y)>10&&Math.abs(y)>Math.abs(E)*1.25&&(u.dragging=!0,r.stop(),u.orbitStart=r.get(),a.currentTarget.setPointerCapture(a.pointerId)),u.dragging&&r.set(u.orbitStart-Math.max(-.65,Math.min(.65,y*.65/P)))},onPointerUp:a=>{const u=b.current;if(!u||u.id!==a.pointerId)return;const y=a.clientX-u.x,E=a.clientY-u.y;u.dragging&&Math.abs(y)>=Math.max(28,P*.12)&&Math.abs(y)>Math.abs(E)*1.25?p(Math.round(u.orbitStart)+(y<0?1:-1)):u.dragging&&p(Math.round(r.get())),b.current=null,a.currentTarget.hasPointerCapture(a.pointerId)&&a.currentTarget.releasePointerCapture(a.pointerId)},onPointerCancel:()=>{b.current=null,x.current=!0,p(Math.round(r.get()))},onLostPointerCapture:a=>{b.current?.id===a.pointerId&&(b.current=null,x.current=!0,p(Math.round(r.get())))},onClickCapture:a=>{x.current&&a.detail!==0&&(a.preventDefault(),a.stopPropagation())},onKeyDown:a=>{if(a.key==="ArrowLeft"||a.key==="ArrowRight"){a.preventDefault();const u=(i+(a.key==="ArrowRight"?1:-1)+s)%s,y=a.currentTarget;n(u),requestAnimationFrame(()=>y.querySelectorAll('[role="button"]')[u]?.focus({preventScroll:!0}))}},children:L.map((a,u)=>{const y=(u-i+s)%s;return a.id==="nabu"?e.jsxs(le,{index:u,orbit:r,radius:f,className:"ss-project-card ss-project-card-nabu","data-active":y===0,role:"button",tabIndex:0,"aria-label":`${y===0?"Open":"Select"} ${a.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),y===0?t(a):n(u))},onClick:()=>{x.current||(y===0?t(a):n(u))},...l,style:{position:"absolute",width:P,height:H,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:a.img,alt:a.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(P,H*.78)*25.5/1080}px, ${-Math.min(P,H*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:y===0?"drop-shadow(0 26px 55px rgba(0,0,0,.55))":"none",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:A,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:a.title})})]},a.id):e.jsxs(le,{index:u,orbit:r,radius:f,role:"button",tabIndex:0,"aria-label":`${y===0?"Open":"Select"} ${a.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),y===0?t(a):n(u))},className:"ss-card ss-project-card","data-active":y===0,onClick:()=>{x.current||(y===0?t(a):n(u))},...l,style:{position:"absolute",width:P,height:H,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:y===0?"0 40px 90px rgba(0,0,0,.6)":"0 20px 50px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:a.img,alt:a.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:a.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:j?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:a.title})})})]},a.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:j?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>S(-1),style:{color:A,width:44,height:44},children:"←"}),L.map((a,u)=>e.jsx("button",{type:"button","aria-label":`Show ${a.title}`,"aria-pressed":u===i,onClick:()=>n(u),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:u===i?26:8,height:8,borderRadius:980,background:u===i?"#38bdf8":k?"#777":"#aaa",transition:"width .3s ease"}})},a.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>S(1),style:{color:A,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=O(),l=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(w.div,{...Z,className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(w.h2,{initial:v?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:C},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(w.p,{initial:v?!1:{opacity:0},animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(w.div,{initial:v?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:C},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:l.map(o=>e.jsxs("a",{className:"ss-contact-entry",href:o.href,target:o.target,rel:o.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:o.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:o.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},o.label))})]})]},"contact")}function Ke({project:t,onClose:l,onMediaClick:o}){const c=O(),d=h.useRef(null);h.useEffect(()=>{const i=document.activeElement,r=d.current;r?.querySelector("button")?.focus({preventScroll:!0});const p=n=>{if(n.key!=="Tab"||!r)return;const b=Array.from(r.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(j=>j.getClientRects().length>0),x=b[0],S=b[b.length-1];n.shiftKey&&document.activeElement===x?(n.preventDefault(),S?.focus()):!n.shiftKey&&document.activeElement===S&&(n.preventDefault(),x?.focus())};return r?.addEventListener("keydown",p),()=>{r?.removeEventListener("keydown",p),i?.isConnected&&i.focus({preventScroll:!0})}},[]);const[s,m]=h.useState(window.innerWidth),g=s>=1024;return h.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),h.useEffect(()=>{const i=()=>{m(window.innerWidth)};return window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]),e.jsx(w.div,{ref:d,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:v?.001:.4},onClick:l,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(w.div,{initial:{opacity:0,scale:v?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:v?1:.96},transition:{duration:v?.001:.4,ease:C},onClick:i=>i.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:l,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const i=t.media.filter(n=>!n.hidden),r=s<=640?2:s<=1023?3:4,p=Array.from({length:r},()=>[]);return i.forEach((n,b)=>p[b%r].push(n)),p.map((n,b)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:n.map((x,S)=>e.jsx(Xe,{item:x,onClick:()=>o(x)},S))},b))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(i=>!i.hidden).map((i,r)=>e.jsx(qe,{item:i,onClick:()=>o(i)},r))}),!g&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse"})]})})}function Xe({item:t,onClick:l}){const o=O(),c=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:l,...o,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:c},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({item:t,onClick:l}){const o=O();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:l,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...o,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Je({item:t,onClose:l,onItemClick:o}){const c=O(),d=h.useRef(null);h.useEffect(()=>{const m=document.activeElement,g=d.current;g?.querySelector("button")?.focus({preventScroll:!0});const i=r=>{if(r.key!=="Tab"||!g)return;const p=Array.from(g.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(x=>x.getClientRects().length>0),n=p[0],b=p[p.length-1];r.shiftKey&&document.activeElement===n?(r.preventDefault(),b?.focus()):!r.shiftKey&&document.activeElement===b&&(r.preventDefault(),n?.focus())};return g?.addEventListener("keydown",i),()=>{g?.removeEventListener("keydown",i),m?.isConnected&&m.focus({preventScroll:!0})}},[]);const s=t;return e.jsx(w.div,{ref:d,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:v?.001:.25},onClick:l,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(w.div,{initial:{opacity:0,scale:v?1:.985},animate:{opacity:1,scale:1},exit:{opacity:0,scale:1},transition:{duration:v?.001:.25,ease:C},onClick:m=>m.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:l,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:s.removeBackground?"transparent":"inherit",position:"relative"},children:s.type==="video"?e.jsx("video",{src:s.src,poster:s.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},s.src):e.jsx("img",{src:s.src,alt:s.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:s.scale?`scale(${s.scale})`:"scale(1)"}},s.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((m,g)=>e.jsxs("button",{onClick:()=>{const i=L.flatMap(r=>r.media).find(r=>r.title===m);i&&o&&o(i)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...c,children:["View ",m," →"]},g))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...c,children:"Visit Website →"})]})]})})}be.createRoot(document.getElementById("root")).render(e.jsx(h.StrictMode,{children:e.jsx(Se,{})}));
