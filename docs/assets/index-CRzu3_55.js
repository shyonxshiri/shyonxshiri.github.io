...
`;function Se(){const t=r.useRef(null);return r.useEffect(()=>{const n=t.current;if(!n)return;const a=requestAnimationFrame(()=>n.classList.add("ss-cursor-ready"));let h=-1,l=-1;const o=d=>{n.style.left=d.clientX+"px",n.style.top=d.clientY+"px",h>=0&&(d.clientX!==h||d.clientY!==l)&&(n.style.opacity="1"),h=d.clientX,l=d.clientY},m=()=>{n.style.opacity="0"},g=d=>d.preventDefault();return window.addEventListener("mousemove",o),document.addEventListener("mouseleave",m),document.addEventListener("dragstart",g),()=>{cancelAnimationFrame(a),window.removeEventListener("mousemove",o),document.removeEventListener("mouseleave",m),document.removeEventListener("dragstart",g)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function H(){const t=r.useCallback(()=>document.body.classList.add("ss-hover"),[]),n=r.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:n}}const P=[.32,.72,0,1],I=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Ee({page:t,children:n}){const a=ce(),[h,l]=r.useState(t),[o,m]=r.useState(null),[g,d]=r.useState(!1),s=r.useRef(null);return r.useEffect(()=>{!o&&t!==h&&(d(!1),m(t))},[t,h,o]),r.useEffect(()=>{if(!o)return;let c=!1;const u=Array.from(s.current?.querySelectorAll("img")||[]);return Promise.all(u.filter(p=>p.loading!=="lazy").map(p=>p.decode().catch(()=>{}))).then(()=>{c||d(!0)}),()=>{c=!0}},[o]),e.jsx(e.Fragment,{children:[h,...o?[o]:[]].map(c=>{const u=c===o;return e.jsx(k.div,{"data-page":c,ref:u?s:void 0,"aria-hidden":o&&!u?!0:void 0,initial:{opacity:u?0:1},animate:{opacity:u&&!g?0:1},transition:{duration:a||!u?0:.38,ease:[.4,0,.2,1]},onAnimationComplete:p=>{u&&g&&typeof p=="object"&&"opacity"in p&&p.opacity===1&&(l(c),m(null))},style:{position:"absolute",inset:0,zIndex:u?2:1,isolation:"isolate",background:"#060606",pointerEvents:o?"none":"auto"},children:n(c)},c)})})}function je(){const[t,n]=r.useState("home"),[a,h]=r.useState("hero"),[l]=r.useState(he),o=r.useRef(!1),[m,g]=r.useState(null),[d,s]=r.useState(null),c=t==="about";r.useEffect(()=>{if(document.getElementById("ss-global"))return;const p=document.createElement("style");p.id="ss-global",p.innerHTML=ke,document.head.appendChild(p)},[]),r.useEffect(()=>{const p=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=p,document.body.style.backgroundColor=p},[t]);const u=r.useCallback((p,y="hero")=>{p!==t&&(o.current=!0,g(null),s(null),h(y),n(p))},[t]);return r.useEffect(()=>{const p=y=>{if(d){y.key==="Escape"&&s(null);return}if(m){y.key==="Escape"&&g(null);return}};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[d,m]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(Se,{}),e.jsx("nav",{className:`ss-site-header${c?" ss-site-header-light":""}`,"aria-label":"Main navigation",children:e.jsx("ul",{children:ve.map(p=>e.jsx("li",{children:e.jsx(Te,{label:p.charAt(0).toUpperCase()+p.slice(1),active:t===p,onClick:()=>u(p),onLight:c})},p))})}),e.jsx(Ee,{page:t,children:p=>e.jsxs(e.Fragment,{children:[p==="home"&&e.jsx(Ce,{onNavigate:u,intro:!o.current,initialSection:a}),p==="work"&&e.jsx(Ve,{onCardClick:g}),p==="about"&&e.jsx(xe,{realmSupported:l.ok,onViewOverview:()=>u("home","open")}),p==="contact"&&e.jsx(Ye,{})]})}),e.jsx(Q,{children:m&&e.jsx($e,{project:m,onClose:()=>g(null),onMediaClick:s})}),e.jsx(Q,{children:d&&e.jsx(Xe,{item:d,onClose:()=>s(null),onItemClick:s})})]})}function Te({label:t,active:n,onClick:a,onLight:h}){const l=H();return e.jsx("button",{onClick:a,"aria-current":n?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:n?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:h?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:n?1:.86,textShadow:h?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...l,children:t})}function he(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const n=t.__realmSupported();return{ok:!!n.ok,why:n.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const oe=["Shyon","Shiri"],Ae=P,Re={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Ne={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ae}}};function Ie({isMobile:t,intro:n}){return e.jsx(k.h1,{className:"ss-hero-name","aria-label":oe.join(" "),variants:Re,initial:n&&!I?"hidden":!1,animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:oe.map(a=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...a].map((h,l)=>e.jsx(k.span,{className:"ss-hero-ch",variants:Ne,children:h},a+l))},a))})}function Ce({onNavigate:t,intro:n,initialSection:a}){const[h,l]=r.useState(!1),[o,m]=r.useState(window.innerWidth<=640),[g]=r.useState(he),d=H(),s=r.useRef(null),[c,u]=r.useState(a==="open"),p=r.useRef(!1);r.useLayoutEffect(()=>{if(a!=="open")return;const v=s.current,x=v?.querySelector('[data-slide="open"]');!v||!x||(v.scrollTo({top:v.scrollTop+x.getBoundingClientRect().top-v.getBoundingClientRect().top,behavior:"instant"}),p.current=!0,x.focus({preventScroll:!0}))},[a]),r.useEffect(()=>{const v=()=>{m(window.innerWidth<=640)};return window.addEventListener("resize",v),()=>window.removeEventListener("resize",v)},[]);const y=r.useRef(null);r.useEffect(()=>()=>y.current?.(),[]);const S=v=>{y.current?.();const x=s.current;x&&v==="open"&&(x.dataset.locked="false",u(!0));const D=x?.querySelector(`[data-slide="${v}"]`);if(!x||!D)return;const b=x.scrollTop,j=Math.min(x.scrollHeight-x.clientHeight,b+D.getBoundingClientRect().top-x.getBoundingClientRect().top);if(I){x.scrollTo({top:j,behavior:"instant"});return}const R=j-b,B=Math.min(2600,1200+Math.abs(R)*.45)*.75,C=performance.now(),T=x.style.scrollSnapType,M=x.style.scrollBehavior;x.style.scrollSnapType="none",x.style.scrollBehavior="auto";let A=0;const N=()=>{cancelAnimationFrame(A),x.style.scrollSnapType=T,x.style.scrollBehavior=M,x.removeEventListener("wheel",N),x.removeEventListener("touchstart",N),x.removeEventListener("pointerdown",N),window.removeEventListener("keydown",N),y.current=null};y.current=N,x.addEventListener("wheel",N,{passive:!0}),x.addEventListener("touchstart",N,{passive:!0}),x.addEventListener("pointerdown",N,{passive:!0}),window.addEventListener("keydown",N);const _=i=>{const f=Math.min(1,(i-C)/B),w=(1-Math.cos(Math.PI*f))/2;x.scrollTop=b+R*w,f<1?A=requestAnimationFrame(_):N()};A=requestAnimationFrame(_)};return e.jsxs(k.div,{ref:s,className:"ss-home-page ss-home-scroll","data-locked":!c,onScroll:v=>{const x=v.currentTarget;c&&(x.scrollTop>4&&(p.current=!0),p.current&&x.scrollTop<=1&&(y.current?.(),p.current=!1,x.dataset.locked="true",u(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>l(!0),className:h?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:o?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ie,{isMobile:o,intro:n}),e.jsxs(k.div,{className:"ss-hero-summary",initial:I||!n?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:I||!n?0:.5,ease:P},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>S("open"),...d,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(J,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(k.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_mansion_portrait.jpg",alt:"My LEGO character facing the camera, with the mansion, upstairs balcony, and four cars behind him.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(K,{className:"ss-open-title",text:"My LEGO Portfolio",variant:me,stagger:.07}),e.jsx(K,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:ne,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(J,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(le,{pair:!0,kicker:"Navigation",body:"The coffee shop opens freelance projects, the cottage holds selected works, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it."})]})}),e.jsxs(J,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(le,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(De,{})]})]}),e.jsxs(J,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(k.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(k.dl,{className:"ss-figs",variants:pe,children:Oe.map(v=>e.jsxs(k.div,{className:"ss-fig",variants:Le,children:[e.jsxs("dd",{children:[v.n,e.jsx("i",{children:v.unit})]}),e.jsx("dt",{children:v.label})]},v.label))}),e.jsx(K,{className:"ss-open-line",text:g.ok?"Controls are displayed on entry.":"View My LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:ne,stagger:.018}),e.jsxs(k.div,{variants:ge,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[g.ok?e.jsxs("a",{href:"/lego.html",...d,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop Only"}),g.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:v=>{(v.key==="Enter"||v.key===" ")&&t("work")},...d,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:"Browse My Work"})]})]})]})]}),c&&e.jsx(Ue,{scrollRef:s})]},"home")}const F=P,Be={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},pe={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},me={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:F}}},ne={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:F}}},ge={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:F}}},_e={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:F}}},Me={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:F,staggerChildren:.13,delayChildren:.14}}},re={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:F}}};function K({text:t,variant:n,className:a,style:h}){const l=[];return t.split(`
`).forEach((o,m)=>{m>0&&l.push(e.jsx("br",{},"br"+m));const g=o.split(" ");g.forEach((d,s)=>l.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[d,s<g.length-1?" ":""]},m+"-"+s)))}),e.jsx(k.p,{className:a,style:h,variants:n,children:l})}const Pe={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:P}}},q=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh Editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and Texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure Assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render Preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function De(){const[t,n]=r.useState(0);return e.jsxs(k.div,{className:"ss-sheet",variants:pe,children:[e.jsx("div",{className:"ss-sheet-grid",children:q.map((a,h)=>e.jsxs(k.button,{className:`ss-cell${h===t?" on":""}`,variants:Me,onMouseEnter:()=>n(h),onFocus:()=>n(h),"aria-label":a.scene,children:[e.jsx(k.span,{className:"ss-cell-shot",variants:Pe,children:e.jsx("img",{src:a.src,alt:a.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:a.scene})]},a.src))}),e.jsxs(k.p,{className:"ss-sheet-cap",variants:_e,children:[e.jsx("b",{children:q[t].scene}),q[t].caption]})]})}const Oe=[{n:"15.9",unit:"M",label:"Triangles per Frame"},{n:"689",unit:"",label:"Draw Calls"},{n:"35",unit:"",label:"Models Loaded"},{n:"7",unit:"min",label:"Full Day Cycle"}],Le={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:P}}},X=[{id:"shop",name:"The Coffee Shop",cat:"Freelance Projects",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned freelance projects. Full-stack websites, brand and print work for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Works",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video, and campaign photography for the NABU streetwear brand."}],He={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:P}}},ze={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:P}}};function Fe(){const t=r.useRef(null),n=r.useRef(null),[a,h]=r.useState({left:0,top:0,w:0,h:0}),[l,o]=r.useState({w:0,h:0}),[m,g]=r.useState({l:0,r:0}),[d,s]=r.useState(0),[c,u]=r.useState(null),[p,y]=r.useState(!1);r.useEffect(()=>{const b=t.current;if(!b)return;const j=2400,R=1350,B=()=>{const T=b.getBoundingClientRect();if(!T.width||!T.height)return;const M=Math.min(T.width/j,T.height/R),A=j*M,N=R*M;h({left:(T.width-A)/2,top:(T.height-N)/2,w:A,h:N});const _=document.documentElement.clientWidth;let i=0,f=_;for(let w=b;w&&w!==document.documentElement;w=w.parentElement)if(getComputedStyle(w).overflowX!=="visible"){const z=w.getBoundingClientRect();i=Math.max(i,z.left),f=Math.min(f,z.right)}g({l:i+8-T.left,r:Math.min(f-8,_-64)-T.left}),o({w:T.width,h:T.height})};B();const C=new ResizeObserver(B);return C.observe(b),()=>C.disconnect()},[]),r.useLayoutEffect(()=>{if(!c)return;const b=n.current;b&&s(b.offsetHeight)},[c,l.w]);const S=X.find(b=>b.id===c)||null,v=S?x(S):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(k.div,{className:"ss-map-stage",ref:t,variants:ge,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:a.left,top:a.top,width:a.w,height:a.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),X.map(b=>e.jsxs(k.button,{variants:He,className:`ss-map-pin${b.flip?" flip":""}${c===b.id?" on":""}`+(c===b.id&&v?.covered?" hushed":""),style:{left:b.x+"%",top:b.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{p||u(b.id)},onMouseLeave:()=>{p||u(null)},onFocus:()=>u(b.id),onClick:()=>{const j=c===b.id&&p;y(!j),u(j?null:b.id)},"aria-label":b.name+", "+b.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:b.cat})]},b.id))]})]}),D()]});function x(b){if(!l.w||!a.w)return;const j=10,R=20,B=16,C=Math.min(l.w*.28,306),T=d||C*9/16+104,M=E=>({x:a.left+a.w*E.x/100,y:a.top+a.h*E.y/100}),A=M(b),N=X.filter(E=>E.id!==b.id).map(M),_=b.x<50,i=b.y<55,f=[[_,i],[_,!i],[!_,i],[!_,!i]];let w=null;for(const[E,z]of f){const O=Math.min(j,m.l),U=Math.max(l.w-j,m.r),W=Math.max(O,Math.min(E?A.x+R:A.x-R-C,U-C)),G=Math.max(j,Math.min(z?A.y+R:A.y-R-T,l.h-T-j));let V=10*N.filter(Y=>Y.x>W-B&&Y.x<W+C+B&&Y.y>G-B&&Y.y<G+T+B).length;const Z=14+7.6*b.cat.length,ee=b.flip?A.x-10-Z:A.x+10,te=ee<W+C+4&&ee+Z>W-4&&A.y-11<G+T+4&&A.y+11>G-4;te&&V++;const se={left:W,top:G,hits:V,tag:te};if(!V){w=se;break}(!w||V<w.hits)&&(w=se)}return{style:{left:w.left,top:w.top,right:"auto",bottom:"auto"},covered:w.tag}}function D(){return e.jsx(Q,{children:S&&e.jsxs(k.div,{ref:n,className:"ss-map-card",style:v?.style,variants:ze,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:S.src,alt:S.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:S.name}),e.jsx("p",{children:S.line})]})]},S.id)})}}function J({id:t,label:n,className:a,stagger:h,children:l}){const o=h?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Be;return e.jsx(k.section,{className:`ss-slide ss-snap${a?" "+a:""}`,"data-slide":t,"data-label":n,tabIndex:t==="open"?-1:void 0,variants:o,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:l})})}function We(t){const[n,a]=r.useState(I?1:0);return r.useEffect(()=>{if(I)return;const h=t.current;if(!h)return;const l=h.closest(".ss-home-scroll");let o=0;const m=()=>{o=0;const d=window.innerHeight||1,s=h.getBoundingClientRect(),c=(d-s.top)/Math.max(1,s.height*.75);a(c<0?0:c>1?1:c)},g=()=>{o||(o=requestAnimationFrame(m))};return(l||window).addEventListener("scroll",g,{passive:!0}),window.addEventListener("resize",g),m(),()=>{o&&cancelAnimationFrame(o),(l||window).removeEventListener("scroll",g),window.removeEventListener("resize",g)}},[t]),n}function Ge({text:t,p:n}){const a=t.split(" "),h=a.length;return e.jsx(e.Fragment,{children:a.map((l,o)=>{const m=o/h*.82,g=Math.min(1,Math.max(0,(n-m)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*g).toFixed(3)})`,transition:"color .12s linear"},children:[l,o<h-1?" ":""]},l+o)})})}function le({kicker:t,body:n,pair:a,children:h}){const l=e.jsx(K,{className:"ss-story-kicker",text:t,variant:me,stagger:.055}),o=r.useRef(null),m=We(o),g=e.jsx(Ge,{text:n,p:m});return a?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:l}),e.jsx("div",{className:"ss-chapter-body",ref:o,children:g})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[l,e.jsx("div",{className:"ss-chapter-body",ref:o,children:g}),h]})}function Ue({scrollRef:t}){const[n,a]=r.useState([]),[h,l]=r.useState(0),o=r.useRef([]);r.useEffect(()=>{const d=t.current;if(!d)return;const s=Array.from(d.querySelectorAll("[data-slide]"));o.current=s,a(s.map(u=>({id:u.dataset.slide||"",label:u.dataset.label||""})));const c=new IntersectionObserver(u=>{for(const p of u)if(p.isIntersecting){const y=o.current.indexOf(p.target);y>=0&&l(y)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return s.forEach(u=>c.observe(u)),()=>c.disconnect()},[t]);const m=d=>{const s=t.current,c=o.current[d];!s||!c||s.scrollTo({top:s.scrollTop+c.getBoundingClientRect().top-s.getBoundingClientRect().top,behavior:I?"auto":"smooth"})};if(n.length<2)return null;const g=h>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${g?" on":""}`,"aria-hidden":!g,children:n.map((d,s)=>e.jsx("button",{type:"button",className:`ss-deck-tick${s===h?" on":""}`,onClick:()=>m(s),"aria-label":d.label,"aria-current":s===h,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:d.label})},d.id))}),e.jsxs("div",{className:`ss-deck-count${g?" on":""}`,children:[e.jsx("b",{children:String(h+1).padStart(2,"0")})," / ",String(n.length).padStart(2,"0")]})]})}function de({index:t,orbit:n,radius:a,style:h,...l}){const o=ae(n,g=>{const d=(t-g)*2*Math.PI/L.length,s=Math.sin(d)*a/Math.sin(2*Math.PI/L.length),c=(Math.cos(d)-1)*220;return`translate3d(${s}px,0,${c}px) rotateY(${-Math.sin(d)*34}deg) scale(${.9+.1*Math.cos(d)})`}),m=ae(n,g=>Math.round((Math.cos((t-g)*2*Math.PI/L.length)+1)*100)+1);return e.jsx(k.div,{...l,draggable:!1,onDragStart:g=>g.preventDefault(),style:{...h,transform:o,zIndex:m,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const n=H(),[a,h]=r.useState({width:window.innerWidth,height:window.innerHeight}),l=a.width>=1024;r.useEffect(()=>{const i=()=>{h({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]);const o=L.length,[m,g]=r.useState(0),d=(m%o+o)%o,s=fe(0),[c,u]=r.useState(!1),p=i=>{s.stop(),u(!0),be(s,i,{duration:I?0:.72,ease:[.42,0,.22,1],onComplete:()=>{g(i),u(!1)}})};r.useEffect(()=>()=>s.stop(),[s]);const y=i=>{p(i+Math.round((s.get()-i)/o)*o)},S=r.useRef(null),v=r.useRef(!1),x=r.useRef(null);r.useEffect(()=>{const i=x.current;if(!i)return;let f=0,w=!1,E=0;const z=O=>{if(O.ctrlKey||Math.abs(O.deltaX)<=Math.abs(O.deltaY))return;O.preventDefault();const U=performance.now();U-E>180&&(f=0,w=!1),E=U,f+=O.deltaX*(O.deltaMode===1?16:O.deltaMode===2?i.clientWidth:1),!w&&Math.abs(f)>=32&&(w=!0,p(Math.round(s.get())+Math.sign(f)))};return i.addEventListener("wheel",z,{passive:!1}),()=>i.removeEventListener("wheel",z)},[s]);const D=i=>p(Math.round(s.get())+i),b=a.width<=640,j=l?380:Math.min(a.width*(b?.64:.7),b?290:330),R=Math.min(j*1.32,Math.max(b?230:290,a.height*(b?.42:.5))),B=j*(l?1.4:b?1.08:1.24),C={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},T=L[d]?.id,M=T==="professional-services",A=M?"#14110b":"var(--white)",N=M?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",_=C[T]||C["creative-projects"];return e.jsx(k.div,{className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(k.div,{"aria-hidden":"true",animate:{backgroundColor:_.base},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(C).map(([i,f])=>e.jsx(k.div,{"aria-hidden":"true",animate:{opacity:i===T?1:0},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:f.glow}},i)),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(k.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:A,textShadow:N,transition:"color 0.7s ease"},children:"Work"}),e.jsx("p",{id:"ss-work-hint",style:{marginTop:14,maxWidth:290,fontSize:14,lineHeight:1.5,color:A,opacity:.75,transition:"color .7s ease"},children:"Swipe or drag to browse. Select a project to view."})]}),e.jsx("div",{ref:x,className:"ss-work-carousel","aria-describedby":"ss-work-hint",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:b?`max(${230+R/2}px, 50%)`:"50%",height:R+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pan-y pinch-zoom",userSelect:"none"},onPointerDown:i=>{!i.isPrimary||i.button!==0||S.current||(S.current={id:i.pointerId,x:i.clientX,y:i.clientY,dragging:!1,orbitStart:s.get()},v.current=!1)},onPointerMove:i=>{const f=S.current;if(!f||f.id!==i.pointerId)return;const w=i.clientX-f.x,E=i.clientY-f.y;Math.hypot(w,E)>8&&(v.current=!0),!f.dragging&&Math.abs(w)>8&&Math.abs(w)>Math.abs(E)*1.15&&(f.dragging=!0,s.stop(),u(!0),f.orbitStart=s.get(),i.currentTarget.setPointerCapture(i.pointerId)),f.dragging&&s.set(f.orbitStart-Math.max(-.65,Math.min(.65,w*.65/j)))},onPointerUp:i=>{const f=S.current;if(!f||f.id!==i.pointerId)return;const w=i.clientX-f.x,E=i.clientY-f.y;f.dragging&&Math.abs(w)>=Math.max(22,j*.08)&&Math.abs(w)>Math.abs(E)*1.15?p(Math.round(f.orbitStart)+(w<0?1:-1)):f.dragging&&p(Math.round(s.get())),S.current=null,i.currentTarget.hasPointerCapture(i.pointerId)&&i.currentTarget.releasePointerCapture(i.pointerId)},onPointerCancel:()=>{S.current=null,v.current=!0,p(Math.round(s.get()))},onLostPointerCapture:i=>{S.current?.id===i.pointerId&&(S.current=null,v.current=!0,p(Math.round(s.get())))},onClickCapture:i=>{v.current&&i.detail!==0&&(i.preventDefault(),i.stopPropagation())},onKeyDown:i=>{if(i.key==="ArrowLeft"||i.key==="ArrowRight"){i.preventDefault();const f=(d+(i.key==="ArrowRight"?1:-1)+o)%o,w=i.currentTarget;y(f),requestAnimationFrame(()=>w.querySelectorAll('[role="button"]')[f]?.focus({preventScroll:!0}))}},children:L.map((i,f)=>{const w=(f-d+o)%o;return i.id==="nabu"?e.jsxs(de,{index:f,orbit:s,radius:B,className:"ss-project-card ss-project-card-nabu","data-active":w===0&&!c,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${i.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),w===0&&!c?t(i):y(f))},onClick:()=>{v.current||(w===0&&!c?t(i):y(f))},...n,style:{position:"absolute",width:j,height:R,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(j,R*.78)*25.5/1080}px, ${-Math.min(j,R*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:A,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:i.title})})]},i.id):e.jsxs(de,{index:f,orbit:s,radius:B,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${i.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),w===0&&!c?t(i):y(f))},className:"ss-card ss-project-card","data-active":w===0&&!c,onClick:()=>{v.current||(w===0&&!c?t(i):y(f))},...n,style:{position:"absolute",width:j,height:R,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:i.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:b?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:i.title})})})]},i.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:b?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>D(-1),style:{color:A,width:44,height:44},children:"←"}),L.map((i,f)=>e.jsx("button",{type:"button","aria-label":`Show ${i.title}`,"aria-pressed":f===d,onClick:()=>y(f),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:f===d?26:8,height:8,borderRadius:980,background:f===d?"#38bdf8":M?"#777":"#aaa",transition:"width .3s ease"}})},i.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>D(1),style:{color:A,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=H(),n=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Résumé",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(k.div,{className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(k.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in Touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(k.p,{initial:!1,animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance work, collaborations, and full-time roles."})]}),e.jsx(k.div,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:n.map(a=>e.jsxs("a",{className:"ss-contact-entry",href:a.href,target:a.target,rel:a.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:a.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:a.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},a.label))})]})]},"contact")}function $e({project:t,onClose:n,onMediaClick:a}){const h=H(),l=r.useRef(null);r.useEffect(()=>{const d=document.activeElement,s=l.current;s?.querySelector("button")?.focus({preventScroll:!0});const c=u=>{if(u.key!=="Tab"||!s)return;const p=Array.from(s.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(v=>v.getClientRects().length>0),y=p[0],S=p[p.length-1];u.shiftKey&&document.activeElement===y?(u.preventDefault(),S?.focus()):!u.shiftKey&&document.activeElement===S&&(u.preventDefault(),y?.focus())};return s?.addEventListener("keydown",c),()=>{s?.removeEventListener("keydown",c),d?.isConnected&&d.focus({preventScroll:!0})}},[]);const[o,m]=r.useState(window.innerWidth),g=o>=1024;return r.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),r.useEffect(()=>{const d=()=>{m(window.innerWidth)};return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),e.jsx(k.div,{ref:l,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.4},onClick:n,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(k.div,{initial:{opacity:0,scale:I?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:I?1:.96},transition:{duration:I?.001:.4,ease:P},onClick:d=>d.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:n,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...h,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const d=t.media.filter(u=>!u.hidden),s=o<=640?2:o<=1023?3:4,c=Array.from({length:s},()=>[]);return d.forEach((u,p)=>c[p%s].push(u)),c.map((u,p)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:u.map((y,S)=>e.jsx(Je,{item:y,onClick:()=>a(y)},S))},p))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(d=>!d.hidden).map((d,s)=>e.jsx(Ke,{item:d,onClick:()=>a(d)},s))}),!g&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse."})]})})}function Je({item:t,onClick:n}){const a=H(),h=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:n,...a,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:h},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Ke({item:t,onClick:n}){const a=H();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:n,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...a,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({pages:t,title:n,labels:a}){const h=r.useRef(null),[l,o]=r.useState(0),m=r.useRef(0),g=ce(),d=s=>{const c=h.current;c&&c.scrollTo({left:Math.max(0,Math.min(t.length-1,s))*c.clientWidth,behavior:g?"instant":"smooth"})};return r.useEffect(()=>{const s=h.current;if(!s)return;const c=new ResizeObserver(()=>s.scrollTo({left:m.current*s.clientWidth,behavior:"instant"}));return c.observe(s),()=>c.disconnect()},[]),e.jsxs("div",{className:"ss-booklet-reader",children:[e.jsx("div",{ref:h,className:"ss-booklet-track",tabIndex:0,role:"region","aria-label":`${n}, scroll through ${a?"pieces":"pages"}`,onScroll:s=>{m.current=Math.round(s.currentTarget.scrollLeft/s.currentTarget.clientWidth),o(m.current)},onKeyDown:s=>{(s.key==="ArrowRight"||s.key==="ArrowLeft")&&(s.preventDefault(),d(l+(s.key==="ArrowRight"?1:-1)))},children:t.map((s,c)=>e.jsx("figure",{className:"ss-booklet-page",children:e.jsx("img",{src:s,alt:a?.[c]?`${n}, ${a[c]}`:`${n}, page ${c+1} of ${t.length}`,loading:c?"lazy":"eager"})},s))}),e.jsxs("div",{className:"ss-booklet-controls",children:[e.jsx("button",{onClick:()=>d(l-1),disabled:l===0,"aria-label":a?"Previous piece":"Previous booklet page",children:"←"}),e.jsx("span",{"aria-live":"polite",children:a?`${a[l]} · ${l+1} of ${t.length}`:`Page ${l+1} of ${t.length}`}),e.jsx("button",{onClick:()=>d(l+1),disabled:l===t.length-1,"aria-label":a?"Next piece":"Next booklet page",children:"→"})]})]})}function Xe({item:t,onClose:n,onItemClick:a}){const h=H(),l=r.useRef(null);r.useEffect(()=>{const c=document.activeElement,u=l.current;u?.querySelector("button")?.focus({preventScroll:!0});const p=y=>{if(y.key!=="Tab"||!u)return;const S=Array.from(u.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(D=>D.getClientRects().length>0),v=S[0],x=S[S.length-1];y.shiftKey&&document.activeElement===v?(y.preventDefault(),x?.focus()):!y.shiftKey&&document.activeElement===x&&(y.preventDefault(),v?.focus())};return u?.addEventListener("keydown",p),()=>{u?.removeEventListener("keydown",p),c?.isConnected&&c.focus({preventScroll:!0})}},[]);const[o,m]=r.useState({src:t.src,index:0});r.useEffect(()=>{m({src:t.src,index:0})},[t.src]);const g=o.src===t.src?o.index:0,d=t.builds?.[g],s=d?{...t,...d}:t;return e.jsxs(k.div,{ref:l,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.25},onClick:n,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("button",{onClick:n,className:"ss-media-viewer-close","aria-label":"Close asset viewer",...h,children:e.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{d:"m6 6 12 12M18 6 6 18",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}),e.jsxs("div",{onClick:c=>c.stopPropagation(),className:"ss-media-viewer",children:[e.jsxs("div",{className:"ss-viewer-media",children:[e.jsx("div",{className:`ss-viewer-canvas${s.pages?" ss-booklet-media":""}`,style:{"--asset-ratio":s.aspectRatio||"4/3"},children:s.pages?e.jsx(qe,{pages:s.pages,title:s.title,labels:s.pageLabels},s.src):s.type==="video"?e.jsx("video",{src:s.src,poster:s.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},s.src):e.jsx("img",{src:s.src,alt:s.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:s.scale?`scale(${s.scale})`:"scale(1)"}},s.src)}),t.builds&&e.jsxs("div",{className:"ss-booklet-controls",role:"group","aria-label":`${t.title} build comparison`,children:[e.jsx("button",{"aria-label":"Show original build",disabled:g===0,onClick:()=>m({src:t.src,index:g-1}),...h,children:"←"}),e.jsxs("span",{"aria-live":"polite",children:[d?.label," · ",g+1," of ",t.builds.length]}),e.jsx("button",{"aria-label":"Show redesigned build",disabled:g===t.builds.length-1,onClick:()=>m({src:t.src,index:g+1}),...h,children:"→"})]})]}),e.jsxs("div",{className:"ss-viewer-info",children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((c,u)=>e.jsxs("button",{onClick:()=>{const p=L.flatMap(y=>y.media).find(y=>y.title===c);p&&a&&a(p)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...h,children:["View ",c," →"]},u))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...h,children:"Visit Website →"})]})]})]})}ye.createRoot(document.getElementById("root")).render(e.jsx(r.StrictMode,{children:e.jsx(je,{})}));
