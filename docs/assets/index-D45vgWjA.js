...
`;function Ee(){const t=d.useRef(null);return d.useEffect(()=>{const n=t.current;if(!n)return;const i=requestAnimationFrame(()=>n.classList.add("ss-cursor-ready"));let c=-1,l=-1;const a=r=>{n.style.left=r.clientX+"px",n.style.top=r.clientY+"px",c>=0&&(r.clientX!==c||r.clientY!==l)&&(n.style.opacity="1"),c=r.clientX,l=r.clientY},m=()=>{n.style.opacity="0"},g=r=>r.preventDefault();return window.addEventListener("mousemove",a),document.addEventListener("mouseleave",m),document.addEventListener("dragstart",g),()=>{cancelAnimationFrame(i),window.removeEventListener("mousemove",a),document.removeEventListener("mouseleave",m),document.removeEventListener("dragstart",g)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function H(){const t=d.useCallback(()=>document.body.classList.add("ss-hover"),[]),n=d.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:n}}const L=[.32,.72,0,1],I=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Se({page:t,children:n}){const i=ce(),[c,l]=d.useState(t),[a,m]=d.useState(null),[g,r]=d.useState(!1),s=d.useRef(null);return d.useEffect(()=>{!a&&t!==c&&(r(!1),m(t))},[t,c,a]),d.useEffect(()=>{if(!a)return;let h=!1;const f=Array.from(s.current?.querySelectorAll("img")||[]);return Promise.all(f.filter(p=>p.loading!=="lazy").map(p=>p.decode().catch(()=>{}))).then(()=>{h||r(!0)}),()=>{h=!0}},[a]),e.jsx(e.Fragment,{children:[c,...a?[a]:[]].map(h=>{const f=h===a;return e.jsx(v.div,{"data-page":h,ref:f?s:void 0,"aria-hidden":a&&!f?!0:void 0,initial:{opacity:f?0:1},animate:{opacity:f&&!g?0:1},transition:{duration:i||!f?0:.38,ease:[.4,0,.2,1]},onAnimationComplete:p=>{f&&g&&typeof p=="object"&&"opacity"in p&&p.opacity===1&&(l(h),m(null))},style:{position:"absolute",inset:0,zIndex:f?2:1,isolation:"isolate",background:"#060606",pointerEvents:a?"none":"auto"},children:n(h)},h)})})}function je(){const[t,n]=d.useState("home"),[i,c]=d.useState("hero"),[l]=d.useState(he),a=d.useRef(!1),[m,g]=d.useState(null),[r,s]=d.useState(null),h=t==="about";d.useEffect(()=>{if(document.getElementById("ss-global"))return;const p=document.createElement("style");p.id="ss-global",p.innerHTML=ke,document.head.appendChild(p)},[]),d.useEffect(()=>{const p=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=p,document.body.style.backgroundColor=p},[t]);const f=d.useCallback((p,k="hero")=>{p!==t&&(a.current=!0,g(null),s(null),c(k),n(p))},[t]);return d.useEffect(()=>{const p=k=>{if(r){k.key==="Escape"&&s(null);return}if(m){k.key==="Escape"&&g(null);return}};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[r,m]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(Ee,{}),e.jsx("nav",{className:`ss-site-header${h?" ss-site-header-light":""}`,"aria-label":"Main navigation",children:e.jsx("ul",{children:ve.map(p=>e.jsx("li",{children:e.jsx(Te,{label:p.charAt(0).toUpperCase()+p.slice(1),active:t===p,onClick:()=>f(p),onLight:h})},p))})}),e.jsx(Se,{page:t,children:p=>e.jsxs(e.Fragment,{children:[p==="home"&&e.jsx(Ce,{onNavigate:f,intro:!a.current,initialSection:i}),p==="work"&&e.jsx(Ve,{onCardClick:g}),p==="about"&&e.jsx(xe,{realmSupported:l.ok,onViewOverview:()=>f("home","open")}),p==="contact"&&e.jsx(Ye,{})]})}),e.jsx(Z,{children:m&&e.jsx($e,{project:m,onClose:()=>g(null),onMediaClick:s})}),e.jsx(Z,{children:r&&e.jsx(Xe,{item:r,onClose:()=>s(null),onItemClick:s})})]})}function Te({label:t,active:n,onClick:i,onLight:c}){const l=H();return e.jsx("button",{onClick:i,"aria-current":n?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:n?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:c?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:n?1:.86,textShadow:c?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...l,children:t})}function he(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const n=t.__realmSupported();return{ok:!!n.ok,why:n.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const oe=["Shyon","Shiri"],Ne=L,Ae={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Re={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ne}}};function Ie({isMobile:t,intro:n}){return e.jsx(v.h1,{className:"ss-hero-name","aria-label":oe.join(" "),variants:Ae,initial:n&&!I?"hidden":!1,animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:oe.map(i=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...i].map((c,l)=>e.jsx(v.span,{className:"ss-hero-ch",variants:Re,children:c},i+l))},i))})}function Ce({onNavigate:t,intro:n,initialSection:i}){const[c,l]=d.useState(!1),[a,m]=d.useState(window.innerWidth<=640),[g]=d.useState(he),r=H(),s=d.useRef(null),[h,f]=d.useState(i==="open"),p=d.useRef(!1);d.useLayoutEffect(()=>{if(i!=="open")return;const x=s.current,y=x?.querySelector('[data-slide="open"]');!x||!y||(x.scrollTo({top:x.scrollTop+y.getBoundingClientRect().top-x.getBoundingClientRect().top,behavior:"instant"}),p.current=!0,y.focus({preventScroll:!0}))},[i]),d.useEffect(()=>{const x=()=>{m(window.innerWidth<=640)};return window.addEventListener("resize",x),()=>window.removeEventListener("resize",x)},[]);const k=d.useRef(null);d.useEffect(()=>()=>k.current?.(),[]);const E=x=>{k.current?.();const y=s.current;y&&x==="open"&&(y.dataset.locked="false",f(!0));const z=y?.querySelector(`[data-slide="${x}"]`);if(!y||!z)return;const b=y.scrollTop,j=Math.min(y.scrollHeight-y.clientHeight,b+z.getBoundingClientRect().top-y.getBoundingClientRect().top);if(I){y.scrollTo({top:j,behavior:"instant"});return}const A=j-b,M=Math.min(2600,1200+Math.abs(A)*.45)*.75,C=performance.now(),T=y.style.scrollSnapType,B=y.style.scrollBehavior;y.style.scrollSnapType="none",y.style.scrollBehavior="auto";let N=0;const R=()=>{cancelAnimationFrame(N),y.style.scrollSnapType=T,y.style.scrollBehavior=B,y.removeEventListener("wheel",R),y.removeEventListener("touchstart",R),y.removeEventListener("pointerdown",R),window.removeEventListener("keydown",R),k.current=null};k.current=R,y.addEventListener("wheel",R,{passive:!0}),y.addEventListener("touchstart",R,{passive:!0}),y.addEventListener("pointerdown",R,{passive:!0}),window.addEventListener("keydown",R);const P=o=>{const u=Math.min(1,(o-C)/M),w=(1-Math.cos(Math.PI*u))/2;y.scrollTop=b+A*w,u<1?N=requestAnimationFrame(P):R()};N=requestAnimationFrame(P)};return e.jsxs(v.div,{ref:s,className:"ss-home-page ss-home-scroll","data-locked":!h,onScroll:x=>{const y=x.currentTarget;h&&(y.scrollTop>4&&(p.current=!0),p.current&&y.scrollTop<=1&&(k.current?.(),p.current=!1,y.dataset.locked="true",f(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>l(!0),className:c?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:a?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ie,{isMobile:a,intro:n}),e.jsxs(v.div,{className:"ss-hero-summary",initial:I||!n?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:I||!n?0:.5,ease:L},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>E("open"),...r,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(K,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(v.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_mansion_portrait.jpg",alt:"My LEGO character facing the camera, with the mansion, upstairs balcony, and four cars behind him.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(J,{className:"ss-open-title",text:"My LEGO Portfolio",variant:me,stagger:.07}),e.jsx(J,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:ne,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(K,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(le,{pair:!0,kicker:"Navigation",body:"The coffee shop opens client work, the cottage holds selected projects, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it."})]})}),e.jsxs(K,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(le,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(Oe,{})]})]}),e.jsxs(K,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(v.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(v.dl,{className:"ss-figs",variants:pe,children:De.map(x=>e.jsxs(v.div,{className:"ss-fig",variants:He,children:[e.jsxs("dd",{children:[x.n,e.jsx("i",{children:x.unit})]}),e.jsx("dt",{children:x.label})]},x.label))}),e.jsx(J,{className:"ss-open-line",text:g.ok?"Controls are displayed on entry.":"View My LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:ne,stagger:.018}),e.jsxs(v.div,{variants:ge,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[g.ok?e.jsxs("a",{href:"/lego.html",...r,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop Only"}),g.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:x=>{(x.key==="Enter"||x.key===" ")&&t("work")},...r,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:"Browse My Work"})]})]})]})]}),h&&e.jsx(Ue,{scrollRef:s})]},"home")}const F=L,Me={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},pe={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},me={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:F}}},ne={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:F}}},ge={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:F}}},Pe={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:F}}},Be={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:F,staggerChildren:.13,delayChildren:.14}}},re={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:F}}};function J({text:t,variant:n,className:i,style:c}){const l=[];return t.split(`
`).forEach((a,m)=>{m>0&&l.push(e.jsx("br",{},"br"+m));const g=a.split(" ");g.forEach((r,s)=>l.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[r,s<g.length-1?" ":""]},m+"-"+s)))}),e.jsx(v.p,{className:i,style:c,variants:n,children:l})}const Le={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:L}}},q=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh Editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and Texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure Assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render Preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function Oe(){const[t,n]=d.useState(0);return e.jsxs(v.div,{className:"ss-sheet",variants:pe,children:[e.jsx("div",{className:"ss-sheet-grid",children:q.map((i,c)=>e.jsxs(v.button,{className:`ss-cell${c===t?" on":""}`,variants:Be,onMouseEnter:()=>n(c),onFocus:()=>n(c),"aria-label":i.scene,children:[e.jsx(v.span,{className:"ss-cell-shot",variants:Le,children:e.jsx("img",{src:i.src,alt:i.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:i.scene})]},i.src))}),e.jsxs(v.p,{className:"ss-sheet-cap",variants:Pe,children:[e.jsx("b",{children:q[t].scene}),q[t].caption]})]})}const De=[{n:"15.9",unit:"M",label:"Triangles per Frame"},{n:"689",unit:"",label:"Draw Calls"},{n:"35",unit:"",label:"Models Loaded"},{n:"7",unit:"min",label:"Full Day Cycle"}],He={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:L}}},X=[{id:"shop",name:"The Coffee Shop",cat:"Client Work",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print work for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video, and campaign photography for the NABU streetwear brand."}],ze={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:L}}},_e={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:L}}};function Fe(){const t=d.useRef(null),n=d.useRef(null),[i,c]=d.useState({left:0,top:0,w:0,h:0}),[l,a]=d.useState({w:0,h:0}),[m,g]=d.useState({l:0,r:0}),[r,s]=d.useState(0),[h,f]=d.useState(null),[p,k]=d.useState(!1);d.useEffect(()=>{const b=t.current;if(!b)return;const j=2400,A=1350,M=()=>{const T=b.getBoundingClientRect();if(!T.width||!T.height)return;const B=Math.min(T.width/j,T.height/A),N=j*B,R=A*B;c({left:(T.width-N)/2,top:(T.height-R)/2,w:N,h:R});const P=document.documentElement.clientWidth;let o=0,u=P;for(let w=b;w&&w!==document.documentElement;w=w.parentElement)if(getComputedStyle(w).overflowX!=="visible"){const _=w.getBoundingClientRect();o=Math.max(o,_.left),u=Math.min(u,_.right)}g({l:o+8-T.left,r:Math.min(u-8,P-64)-T.left}),a({w:T.width,h:T.height})};M();const C=new ResizeObserver(M);return C.observe(b),()=>C.disconnect()},[]),d.useLayoutEffect(()=>{if(!h)return;const b=n.current;b&&s(b.offsetHeight)},[h,l.w]);const E=X.find(b=>b.id===h)||null,x=E?y(E):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(v.div,{className:"ss-map-stage",ref:t,variants:ge,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:i.left,top:i.top,width:i.w,height:i.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),X.map(b=>e.jsxs(v.button,{variants:ze,className:`ss-map-pin${b.flip?" flip":""}${h===b.id?" on":""}`+(h===b.id&&x?.covered?" hushed":""),style:{left:b.x+"%",top:b.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{p||f(b.id)},onMouseLeave:()=>{p||f(null)},onFocus:()=>f(b.id),onClick:()=>{const j=h===b.id&&p;k(!j),f(j?null:b.id)},"aria-label":b.name+", "+b.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:b.cat})]},b.id))]})]}),z()]});function y(b){if(!l.w||!i.w)return;const j=10,A=20,M=16,C=Math.min(l.w*.28,306),T=r||C*9/16+104,B=S=>({x:i.left+i.w*S.x/100,y:i.top+i.h*S.y/100}),N=B(b),R=X.filter(S=>S.id!==b.id).map(B),P=b.x<50,o=b.y<55,u=[[P,o],[P,!o],[!P,o],[!P,!o]];let w=null;for(const[S,_]of u){const O=Math.min(j,m.l),U=Math.max(l.w-j,m.r),W=Math.max(O,Math.min(S?N.x+A:N.x-A-C,U-C)),G=Math.max(j,Math.min(_?N.y+A:N.y-A-T,l.h-T-j));let V=10*R.filter(Y=>Y.x>W-M&&Y.x<W+C+M&&Y.y>G-M&&Y.y<G+T+M).length;const Q=14+7.6*b.cat.length,ee=b.flip?N.x-10-Q:N.x+10,te=ee<W+C+4&&ee+Q>W-4&&N.y-11<G+T+4&&N.y+11>G-4;te&&V++;const se={left:W,top:G,hits:V,tag:te};if(!V){w=se;break}(!w||V<w.hits)&&(w=se)}return{style:{left:w.left,top:w.top,right:"auto",bottom:"auto"},covered:w.tag}}function z(){return e.jsx(Z,{children:E&&e.jsxs(v.div,{ref:n,className:"ss-map-card",style:x?.style,variants:_e,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:E.src,alt:E.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:E.name}),e.jsx("p",{children:E.line})]})]},E.id)})}}function K({id:t,label:n,className:i,stagger:c,children:l}){const a=c?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Me;return e.jsx(v.section,{className:`ss-slide ss-snap${i?" "+i:""}`,"data-slide":t,"data-label":n,tabIndex:t==="open"?-1:void 0,variants:a,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:l})})}function We(t){const[n,i]=d.useState(I?1:0);return d.useEffect(()=>{if(I)return;const c=t.current;if(!c)return;const l=c.closest(".ss-home-scroll");let a=0;const m=()=>{a=0;const r=window.innerHeight||1,s=c.getBoundingClientRect(),h=(r-s.top)/Math.max(1,s.height*.75);i(h<0?0:h>1?1:h)},g=()=>{a||(a=requestAnimationFrame(m))};return(l||window).addEventListener("scroll",g,{passive:!0}),window.addEventListener("resize",g),m(),()=>{a&&cancelAnimationFrame(a),(l||window).removeEventListener("scroll",g),window.removeEventListener("resize",g)}},[t]),n}function Ge({text:t,p:n}){const i=t.split(" "),c=i.length;return e.jsx(e.Fragment,{children:i.map((l,a)=>{const m=a/c*.82,g=Math.min(1,Math.max(0,(n-m)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*g).toFixed(3)})`,transition:"color .12s linear"},children:[l,a<c-1?" ":""]},l+a)})})}function le({kicker:t,body:n,pair:i,children:c}){const l=e.jsx(J,{className:"ss-story-kicker",text:t,variant:me,stagger:.055}),a=d.useRef(null),m=We(a),g=e.jsx(Ge,{text:n,p:m});return i?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:l}),e.jsx("div",{className:"ss-chapter-body",ref:a,children:g})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[l,e.jsx("div",{className:"ss-chapter-body",ref:a,children:g}),c]})}function Ue({scrollRef:t}){const[n,i]=d.useState([]),[c,l]=d.useState(0),a=d.useRef([]);d.useEffect(()=>{const r=t.current;if(!r)return;const s=Array.from(r.querySelectorAll("[data-slide]"));a.current=s,i(s.map(f=>({id:f.dataset.slide||"",label:f.dataset.label||""})));const h=new IntersectionObserver(f=>{for(const p of f)if(p.isIntersecting){const k=a.current.indexOf(p.target);k>=0&&l(k)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return s.forEach(f=>h.observe(f)),()=>h.disconnect()},[t]);const m=r=>{const s=t.current,h=a.current[r];!s||!h||s.scrollTo({top:s.scrollTop+h.getBoundingClientRect().top-s.getBoundingClientRect().top,behavior:I?"auto":"smooth"})};if(n.length<2)return null;const g=c>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${g?" on":""}`,"aria-hidden":!g,children:n.map((r,s)=>e.jsx("button",{type:"button",className:`ss-deck-tick${s===c?" on":""}`,onClick:()=>m(s),"aria-label":r.label,"aria-current":s===c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:r.label})},r.id))}),e.jsxs("div",{className:`ss-deck-count${g?" on":""}`,children:[e.jsx("b",{children:String(c+1).padStart(2,"0")})," / ",String(n.length).padStart(2,"0")]})]})}function de({index:t,orbit:n,radius:i,style:c,...l}){const a=ae(n,g=>{const r=(t-g)*2*Math.PI/D.length,s=Math.sin(r)*i/Math.sin(2*Math.PI/D.length),h=(Math.cos(r)-1)*220;return`translate3d(${s}px,0,${h}px) rotateY(${-Math.sin(r)*34}deg) scale(${.9+.1*Math.cos(r)})`}),m=ae(n,g=>Math.round((Math.cos((t-g)*2*Math.PI/D.length)+1)*100)+1);return e.jsx(v.div,{...l,draggable:!1,onDragStart:g=>g.preventDefault(),style:{...c,transform:a,zIndex:m,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const n=H(),[i,c]=d.useState({width:window.innerWidth,height:window.innerHeight}),l=i.width>=1024;d.useEffect(()=>{const o=()=>{c({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[]);const a=D.length,[m,g]=d.useState(0),r=(m%a+a)%a,s=fe(0),[h,f]=d.useState(!1),p=o=>{s.stop(),f(!0),be(s,o,{duration:I?0:.72,ease:[.42,0,.22,1],onComplete:()=>{g(o),f(!1)}})};d.useEffect(()=>()=>s.stop(),[s]);const k=o=>{p(o+Math.round((s.get()-o)/a)*a)},E=d.useRef(null),x=d.useRef(!1),y=d.useRef(null);d.useEffect(()=>{const o=y.current;if(!o)return;let u=0,w=!1,S=0;const _=O=>{if(O.ctrlKey||Math.abs(O.deltaX)<=Math.abs(O.deltaY))return;O.preventDefault();const U=performance.now();U-S>180&&(u=0,w=!1),S=U,u+=O.deltaX*(O.deltaMode===1?16:O.deltaMode===2?o.clientWidth:1),!w&&Math.abs(u)>=32&&(w=!0,p(Math.round(s.get())+Math.sign(u)))};return o.addEventListener("wheel",_,{passive:!1}),()=>o.removeEventListener("wheel",_)},[s]);const z=o=>p(Math.round(s.get())+o),b=i.width<=640,j=l?380:Math.min(i.width*(b?.64:.7),b?290:330),A=Math.min(j*1.32,Math.max(b?230:290,i.height*(b?.42:.5))),M=j*(l?1.4:b?1.08:1.24),C={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},T=D[r]?.id,B=T==="professional-services",N=B?"#14110b":"var(--white)",R=B?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",P=C[T]||C["creative-projects"];return e.jsx(v.div,{className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(v.div,{"aria-hidden":"true",animate:{backgroundColor:P.base},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(C).map(([o,u])=>e.jsx(v.div,{"aria-hidden":"true",animate:{opacity:o===T?1:0},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:u.glow}},o)),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(v.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:L},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:N,textShadow:R,transition:"color 0.7s ease"},children:"Work"}),e.jsx("p",{id:"ss-work-hint",style:{marginTop:14,maxWidth:290,fontSize:14,lineHeight:1.5,color:N,opacity:.75,transition:"color .7s ease"},children:"Swipe or drag to browse. Select a project to view."})]}),e.jsx("div",{ref:y,className:"ss-work-carousel","aria-describedby":"ss-work-hint",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:b?`max(${230+A/2}px, 50%)`:"50%",height:A+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pan-y pinch-zoom",userSelect:"none"},onPointerDown:o=>{!o.isPrimary||o.button!==0||E.current||(E.current={id:o.pointerId,x:o.clientX,y:o.clientY,dragging:!1,orbitStart:s.get()},x.current=!1)},onPointerMove:o=>{const u=E.current;if(!u||u.id!==o.pointerId)return;const w=o.clientX-u.x,S=o.clientY-u.y;Math.hypot(w,S)>8&&(x.current=!0),!u.dragging&&Math.abs(w)>8&&Math.abs(w)>Math.abs(S)*1.15&&(u.dragging=!0,s.stop(),f(!0),u.orbitStart=s.get(),o.currentTarget.setPointerCapture(o.pointerId)),u.dragging&&s.set(u.orbitStart-Math.max(-.65,Math.min(.65,w*.65/j)))},onPointerUp:o=>{const u=E.current;if(!u||u.id!==o.pointerId)return;const w=o.clientX-u.x,S=o.clientY-u.y;u.dragging&&Math.abs(w)>=Math.max(22,j*.08)&&Math.abs(w)>Math.abs(S)*1.15?p(Math.round(u.orbitStart)+(w<0?1:-1)):u.dragging&&p(Math.round(s.get())),E.current=null,o.currentTarget.hasPointerCapture(o.pointerId)&&o.currentTarget.releasePointerCapture(o.pointerId)},onPointerCancel:()=>{E.current=null,x.current=!0,p(Math.round(s.get()))},onLostPointerCapture:o=>{E.current?.id===o.pointerId&&(E.current=null,x.current=!0,p(Math.round(s.get())))},onClickCapture:o=>{x.current&&o.detail!==0&&(o.preventDefault(),o.stopPropagation())},onKeyDown:o=>{if(o.key==="ArrowLeft"||o.key==="ArrowRight"){o.preventDefault();const u=(r+(o.key==="ArrowRight"?1:-1)+a)%a,w=o.currentTarget;k(u),requestAnimationFrame(()=>w.querySelectorAll('[role="button"]')[u]?.focus({preventScroll:!0}))}},children:D.map((o,u)=>{const w=(u-r+a)%a;return o.id==="nabu"?e.jsxs(de,{index:u,orbit:s,radius:M,className:"ss-project-card ss-project-card-nabu","data-active":w===0&&!h,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${o.title}`,onKeyDown:S=>{(S.key==="Enter"||S.key===" ")&&(S.preventDefault(),w===0&&!h?t(o):k(u))},onClick:()=>{x.current||(w===0&&!h?t(o):k(u))},...n,style:{position:"absolute",width:j,height:A,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:o.img,alt:o.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(j,A*.78)*25.5/1080}px, ${-Math.min(j,A*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:N,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:o.title})})]},o.id):e.jsxs(de,{index:u,orbit:s,radius:M,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${o.title}`,onKeyDown:S=>{(S.key==="Enter"||S.key===" ")&&(S.preventDefault(),w===0&&!h?t(o):k(u))},className:"ss-card ss-project-card","data-active":w===0&&!h,onClick:()=>{x.current||(w===0&&!h?t(o):k(u))},...n,style:{position:"absolute",width:j,height:A,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:o.img,alt:o.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:o.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:b?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:o.title})})})]},o.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:b?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>z(-1),style:{color:N,width:44,height:44},children:"←"}),D.map((o,u)=>e.jsx("button",{type:"button","aria-label":`Show ${o.title}`,"aria-pressed":u===r,onClick:()=>k(u),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:u===r?26:8,height:8,borderRadius:980,background:u===r?"#38bdf8":B?"#777":"#aaa",transition:"width .3s ease"}})},o.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>z(1),style:{color:N,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=H(),n=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Résumé",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(v.div,{className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(v.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:L},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in Touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(v.p,{initial:!1,animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance work, collaborations, and full-time roles."})]}),e.jsx(v.div,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:L},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:n.map(i=>e.jsxs("a",{className:"ss-contact-entry",href:i.href,target:i.target,rel:i.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:i.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},i.label))})]})]},"contact")}function $e({project:t,onClose:n,onMediaClick:i}){const c=H(),l=d.useRef(null);d.useEffect(()=>{const r=document.activeElement,s=l.current;s?.querySelector("button")?.focus({preventScroll:!0});const h=f=>{if(f.key!=="Tab"||!s)return;const p=Array.from(s.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(x=>x.getClientRects().length>0),k=p[0],E=p[p.length-1];f.shiftKey&&document.activeElement===k?(f.preventDefault(),E?.focus()):!f.shiftKey&&document.activeElement===E&&(f.preventDefault(),k?.focus())};return s?.addEventListener("keydown",h),()=>{s?.removeEventListener("keydown",h),r?.isConnected&&r.focus({preventScroll:!0})}},[]);const[a,m]=d.useState(window.innerWidth),g=a>=1024;return d.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),d.useEffect(()=>{const r=()=>{m(window.innerWidth)};return window.addEventListener("resize",r),()=>window.removeEventListener("resize",r)},[]),e.jsx(v.div,{ref:l,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.4},onClick:n,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(v.div,{initial:{opacity:0,scale:I?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:I?1:.96},transition:{duration:I?.001:.4,ease:L},onClick:r=>r.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:n,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const r=t.media.filter(f=>!f.hidden),s=a<=640?2:a<=1023?3:4,h=Array.from({length:s},()=>[]);return r.forEach((f,p)=>h[p%s].push(f)),h.map((f,p)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:f.map((k,E)=>e.jsx(Ke,{item:k,onClick:()=>i(k)},E))},p))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(r=>!r.hidden).map((r,s)=>e.jsx(Je,{item:r,onClick:()=>i(r)},s))}),!g&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse."})]})})}function Ke({item:t,onClick:n}){const i=H(),c=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:n,...i,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:c},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Je({item:t,onClick:n}){const i=H();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:n,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...i,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({pages:t,title:n,labels:i}){const c=d.useRef(null),[l,a]=d.useState(0),m=d.useRef(0),g=ce(),r=s=>{const h=c.current;h&&h.scrollTo({left:Math.max(0,Math.min(t.length-1,s))*h.clientWidth,behavior:g?"instant":"smooth"})};return d.useEffect(()=>{const s=c.current;if(!s)return;const h=new ResizeObserver(()=>s.scrollTo({left:m.current*s.clientWidth,behavior:"instant"}));return h.observe(s),()=>h.disconnect()},[]),e.jsxs("div",{className:"ss-booklet-reader",children:[e.jsx("div",{ref:c,className:"ss-booklet-track",tabIndex:0,role:"region","aria-label":`${n}, scroll through ${i?"pieces":"pages"}`,onScroll:s=>{m.current=Math.round(s.currentTarget.scrollLeft/s.currentTarget.clientWidth),a(m.current)},onKeyDown:s=>{(s.key==="ArrowRight"||s.key==="ArrowLeft")&&(s.preventDefault(),r(l+(s.key==="ArrowRight"?1:-1)))},children:t.map((s,h)=>e.jsx("figure",{className:"ss-booklet-page",children:e.jsx("img",{src:s,alt:i?.[h]?`${n}, ${i[h]}`:`${n}, page ${h+1} of ${t.length}`,loading:h?"lazy":"eager"})},s))}),e.jsxs("div",{className:"ss-booklet-controls",children:[e.jsx("button",{onClick:()=>r(l-1),disabled:l===0,"aria-label":i?"Previous piece":"Previous booklet page",children:"←"}),e.jsx("span",{"aria-live":"polite",children:i?`${i[l]} · ${l+1} of ${t.length}`:`Page ${l+1} of ${t.length}`}),e.jsx("button",{onClick:()=>r(l+1),disabled:l===t.length-1,"aria-label":i?"Next piece":"Next booklet page",children:"→"})]})]})}function Xe({item:t,onClose:n,onItemClick:i}){const c=H(),l=d.useRef(null);d.useEffect(()=>{const m=document.activeElement,g=l.current;g?.querySelector("button")?.focus({preventScroll:!0});const r=s=>{if(s.key!=="Tab"||!g)return;const h=Array.from(g.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(k=>k.getClientRects().length>0),f=h[0],p=h[h.length-1];s.shiftKey&&document.activeElement===f?(s.preventDefault(),p?.focus()):!s.shiftKey&&document.activeElement===p&&(s.preventDefault(),f?.focus())};return g?.addEventListener("keydown",r),()=>{g?.removeEventListener("keydown",r),m?.isConnected&&m.focus({preventScroll:!0})}},[]);const a=t;return e.jsxs(v.div,{ref:l,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.25},onClick:n,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("button",{onClick:n,className:"ss-media-viewer-close","aria-label":"Close asset viewer",...c,children:e.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{d:"m6 6 12 12M18 6 6 18",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}),e.jsxs("div",{onClick:m=>m.stopPropagation(),className:"ss-media-viewer",children:[e.jsx("div",{className:"ss-viewer-media",children:e.jsx("div",{className:`ss-viewer-canvas${a.pages?" ss-booklet-media":""}`,style:{"--asset-ratio":a.aspectRatio||"4/3"},children:a.pages?e.jsx(qe,{pages:a.pages,title:a.title,labels:a.pageLabels},a.src):a.type==="video"?e.jsx("video",{src:a.src,poster:a.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},a.src):e.jsx("img",{src:a.src,alt:a.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:a.scale?`scale(${a.scale})`:"scale(1)"}},a.src)})}),e.jsxs("div",{className:"ss-viewer-info",children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((m,g)=>e.jsxs("button",{onClick:()=>{const r=D.flatMap(s=>s.media).find(s=>s.title===m);r&&i&&i(r)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...c,children:["View ",m," →"]},g))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...c,children:"Visit Website →"})]})]})]})}ye.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(je,{})}));
