...
`;function oe(){const t=r.useRef(null);return r.useEffect(()=>{const i=n=>{t.current&&(t.current.style.left=n.clientX+"px",t.current.style.top=n.clientY+"px")};return window.addEventListener("mousemove",i),()=>window.removeEventListener("mousemove",i)},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function C(){const t=r.useCallback(()=>document.body.classList.add("ss-hover"),[]),i=r.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:i}}const W={initial:{opacity:0},animate:{opacity:1,transition:{duration:.6}},exit:{opacity:0,transition:{duration:.45}}};function ne(){const[t,i]=r.useState("home"),[n,l]=r.useState(null),[s,o]=r.useState(null),[c,m]=r.useState(window.innerWidth>=1024),[g,a]=r.useState(!0),u=A.indexOf(t),f=r.useRef(!1),S=C(),T=r.useRef(!1);r.useEffect(()=>{if(document.getElementById("ss-global"))return;const h=document.createElement("style");h.id="ss-global",h.innerHTML=ie,document.head.appendChild(h)},[]),r.useEffect(()=>{const h=()=>{m(window.innerWidth>=1024)};return window.addEventListener("resize",h),()=>window.removeEventListener("resize",h)},[]),r.useEffect(()=>{const h=t==="about"?"#ede8e0":"#060606";document.documentElement.style.backgroundColor=h,document.body.style.backgroundColor=h},[t]);const k=r.useRef(u);r.useEffect(()=>{k.current=u},[u]);const w=r.useRef(t);r.useEffect(()=>{w.current=t},[t]);const v=r.useRef(!1);r.useEffect(()=>{v.current=!!n||!!s},[n,s]);const I=r.useCallback(h=>{h!==t&&(l(null),o(null),i(h))},[t]);r.useEffect(()=>{const h=b=>{if(T.current||(T.current=!0,a(!1)),v.current||f.current||w.current==="home"||w.current==="work"&&window.innerWidth<1024)return;const d=b.target;if(d.closest(".ss-modal-grid")||d.closest(".ss-masonry")||d.closest(".ss-media-viewer")||Math.abs(b.deltaX)>Math.abs(b.deltaY)*.5)return;const y=b.deltaY>0?1:-1,E=Math.max(0,Math.min(A.length-1,k.current+y));E!==k.current&&(f.current=!0,i(A[E]),setTimeout(()=>{f.current=!1},1100))};return window.addEventListener("wheel",h,{passive:!0}),()=>window.removeEventListener("wheel",h)},[]);const R=r.useRef(0),j=r.useRef(0);return r.useEffect(()=>{const h=d=>{R.current=d.touches[0].clientY,j.current=d.touches[0].clientX},b=d=>{if(T.current||(T.current=!0,a(!1)),v.current||f.current||w.current==="home"||w.current==="work")return;const y=d.target;if(y.closest(".ss-rail")||y.closest(".ss-modal-grid")||y.closest(".ss-masonry"))return;const E=R.current-d.changedTouches[0].clientY,N=j.current-d.changedTouches[0].clientX;if(Math.abs(E)<120||Math.abs(E)<Math.abs(N)*3)return;const x=E>0?1:-1,B=Math.max(0,Math.min(A.length-1,k.current+x));B!==k.current&&(f.current=!0,i(A[B]),setTimeout(()=>{f.current=!1},1100))};return window.addEventListener("touchstart",h,{passive:!0}),window.addEventListener("touchend",b,{passive:!0}),()=>{window.removeEventListener("touchstart",h),window.removeEventListener("touchend",b)}},[]),r.useEffect(()=>{const h=b=>{if(s){b.key==="Escape"&&o(null);return}if(n){b.key==="Escape"&&l(null);return}t!=="home"&&((b.key==="ArrowDown"||b.key==="ArrowRight")&&i(A[Math.min(A.length-1,u+1)]),(b.key==="ArrowUp"||b.key==="ArrowLeft")&&i(A[Math.max(0,u-1)]))};return window.addEventListener("keydown",h),()=>window.removeEventListener("keydown",h)},[u,s,n]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx(oe,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",mixBlendMode:t==="about"&&c?"normal":"difference"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none"},children:A.map(h=>e.jsx("li",{children:e.jsx(re,{label:h.charAt(0).toUpperCase()+h.slice(1),active:t===h,onClick:()=>I(h),currentPage:t,wideAbout:t==="about"&&c})},h))})]}),e.jsx("div",{style:{position:"fixed",right:"max(32px, calc(32px + env(safe-area-inset-right)))",top:"50%",transform:"translateY(-50%)",zIndex:400,display:"flex",flexDirection:"column",gap:12,mixBlendMode:t==="about"&&c?"normal":"difference"},children:A.map(h=>e.jsx("button",{onClick:()=>I(h),className:"ss-tap","aria-label":h,style:{width:10,height:10,borderRadius:"50%",border:"1px solid rgba(245,242,237,0.4)",background:t===h?"var(--white)":"transparent",transform:t===h?"scale(1.5)":"scale(1)",transition:"all 0.4s ease",cursor:"none",position:"relative"},...S},h))}),e.jsxs(H,{mode:"wait",children:[t==="home"&&e.jsx(de,{onNavigate:I},"home"),t==="work"&&e.jsx(ve,{onCardClick:l,onNavigate:i},"work"),t==="about"&&e.jsx(ke,{},"about"),t==="contact"&&e.jsx(je,{},"contact")]}),e.jsx(H,{children:n&&e.jsx(Ee,{project:n,onClose:()=>l(null),onMediaClick:o})}),e.jsx(H,{children:s&&e.jsx(Ne,{item:s,onClose:()=>o(null),onItemClick:o})})]})}function re({label:t,active:i,onClick:n,currentPage:l,wideAbout:s}){const o=C(),c=l==="about";return e.jsxs("button",{onClick:n,className:"ss-tap",style:{fontFamily:"'Space Mono', monospace",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:s?"#000000":"var(--white)",background:"none",border:"none",cursor:"none",opacity:c||i?1:.55,transition:"opacity 0.3s ease, color 0.3s ease",position:"relative"},...o,children:[t,e.jsx("span",{style:{position:"absolute",bottom:-4,left:0,height:1,background:"var(--sky)",width:i?"100%":0,transition:"width 0.4s cubic-bezier(0.16,1,0.3,1)",display:"none"}})]})}function le(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const i=t.__realmSupported();return{ok:!!i.ok,why:i.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}function de({onNavigate:t}){const[i,n]=r.useState(!1),[l,s]=r.useState(window.innerWidth<=640),[o]=r.useState(le),c=C(),m=r.useRef(null);r.useEffect(()=>{const a=()=>{s(window.innerWidth<=640)};return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]);const g=()=>{const a=m.current;a&&a.scrollTo({top:a.clientHeight,behavior:"smooth"})};return e.jsxs(p.div,{...W,ref:m,className:"ss-home-page ss-home-scroll",style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",alt:"",onLoad:()=>n(!0),className:i?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{style:{position:"absolute",bottom:l?"14vh":"24vh",left:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsxs(p.h1,{initial:{opacity:0,y:40},animate:{opacity:1,y:0},transition:{duration:.9,delay:.35,ease:[.16,1,.3,1]},style:{fontSize:l?"clamp(48px,7vw,72px)":"clamp(72px,10vw,160px)",lineHeight:.99,letterSpacing:"-0.02em",fontWeight:700,color:"var(--white)"},children:["Shyon",e.jsx("br",{}),"Shiri"]}),e.jsxs(p.p,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.8,delay:.58,ease:[.16,1,.3,1]},style:{marginTop:16,maxWidth:460,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:["Click"," ",e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:a=>{(a.key==="Enter"||a.key===" ")&&t("work")},...c,style:{color:"#38bdf8",textDecoration:"underline",textUnderlineOffset:"3px",textDecorationThickness:"1.5px",fontWeight:600,cursor:"none"},children:"here"})," ","to browse my site, or scroll down for the interactive 3D environment built into it."]})]}),e.jsx(p.button,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:1.15},className:"ss-story-cue",onClick:g,...c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-cue-arrow",children:"▼"})})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(P,{id:"open",label:"My Lego Realm",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(p.img,{className:"ss-open-img",variants:$,src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the ruins, the coffee shop, the run down cottage across the river, and the modern house with a car on its driveway.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(M,{className:"ss-open-title",text:"My Lego Realm",variant:V,stagger:.07}),e.jsx(M,{className:"ss-open-line",text:"An interactive real time 3D environment, built brick by brick in Blender. Walk the town and step inside any building to see the work it holds.",variant:Y,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(P,{id:"map",label:"The town",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(U,{pair:!0,kicker:"What it is",body:"A small town built on a LEGO inspired baseplate. Each structure holds a different branch of the work, and walking into one is how you open it."}),e.jsx(ye,{}),e.jsx("div",{className:"ss-map-hint",children:"Pick a structure to see what it holds"})]})}),e.jsx(P,{id:"why",label:"Why I made it",stagger:.2,children:e.jsxs("div",{className:"ss-quiet",children:[e.jsx(U,{pair:!0,kicker:`Why I
made it`,body:"The environment is a work sample in its own right. Building it took the same disciplines the rest of the portfolio presents, hard surface modeling and UV work in Blender, real time rendering and collision in the browser, and the front end engineering that ties the two together. It also goes back to where my work started, stop motion films built from LEGO, and to the technologies I have taken on since."}),e.jsx(pe,{scene:"The player figure",src:"/assets/story/story_figure_front.jpg",caption:"A younger me by design. Assembled from separate parts rather than one mesh: each was modeled and textured on its own, then measured into place and bound to the rig at load time."})]})}),e.jsxs(P,{id:"shop",label:"How I made it",stagger:.18,children:[e.jsx(U,{pair:!0,kicker:`How I
made it`,body:"Every structure was assembled from individual bricks in Blender. Most are my own builds, with some free assets worked in and modified to fit. Each model is exported as glTF, Draco compressed, and loaded by a custom Three.js engine that runs directly in the browser. The world uses the exact LEGO stud pitch as its grid, collision is rasterized per brick rather than per bounding box, stair climbing runs on a walkable heightmap, and the lighting completes a full day cycle every seven minutes."}),e.jsx(me,{})]})]}),e.jsxs(P,{id:"close",label:"Try it",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(p.img,{className:"ss-open-img",variants:$,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(p.dl,{className:"ss-figs",variants:K,children:ge.map(a=>e.jsxs(p.div,{className:"ss-fig",variants:ue,children:[e.jsxs("dd",{children:[a.n,e.jsx("i",{children:a.unit})]}),e.jsx("dt",{children:a.label})]},a.label))}),e.jsx(M,{className:"ss-open-title ss-close-title",text:o.ok?"Walk it yourself":"The finished build",variant:V,stagger:.07}),e.jsx(M,{className:"ss-open-line",text:o.ok?"The full version runs on this site, with the day cycle and all four portals active.":"The full version runs on this site on a desktop or laptop, with the day cycle and all four portals active.",variant:Y,stagger:.018}),e.jsxs(p.div,{variants:J,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[o.ok?e.jsxs("a",{href:"/lego.html",...c,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"Enter My Lego Realm"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"'Cormorant Garamond', Georgia, serif"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),o.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:a=>{(a.key==="Enter"||a.key===" ")&&t("work")},...c,className:"ss-tap",style:{fontFamily:"'Space Mono', monospace",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:o.ok?"or browse the work":"Browse the work"})]})]})]})]}),e.jsx(xe,{scrollRef:m})]},"home")}const z=[.16,1,.3,1],ce={hidden:{},show:{transition:{staggerChildren:.14,delayChildren:.06}}},K={hidden:{},show:{transition:{staggerChildren:.11,delayChildren:.04}}},V={hidden:{opacity:0,y:"0.55em",rotateX:-68,transformPerspective:700},show:{opacity:1,y:"0em",rotateX:0,transition:{duration:.66,ease:z}}},Y={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.5,ease:z}}},J={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:z}}},he={hidden:{opacity:0,clipPath:"inset(0% 100% 0% 0%)"},show:{opacity:1,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.62,ease:z}}},Q={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:z}}},Z={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:z,staggerChildren:.13,delayChildren:.14}}},$={hidden:{opacity:0,scale:1.09},show:{opacity:1,scale:1,transition:{duration:1.9,ease:z}}};function M({text:t,variant:i,stagger:n=.03,className:l,style:s}){const o=[];return t.split(`
`).forEach((c,m)=>{m>0&&o.push(e.jsx("br",{},"br"+m));const g=c.split(" ");g.forEach((a,u)=>o.push(e.jsxs(p.span,{className:"ss-w",variants:i,style:{display:"inline-block",willChange:"transform"},children:[a,u<g.length-1?" ":""]},m+"-"+u)))}),e.jsx(p.p,{className:l,style:s,variants:{hidden:{},show:{transition:{staggerChildren:n}}},children:o})}const D=t=>i=>Math.min(1,Math.floor(i*t)/(t-1)),ee={hidden:{clipPath:"inset(100% 0% 0% 0%)"},show:{clipPath:"inset(0% 0% 0% 0%)",transition:{duration:1.05,ease:D(6)}}};function pe({scene:t,src:i,caption:n}){return e.jsxs(p.figure,{className:"ss-plate",variants:Z,children:[e.jsx(p.span,{className:"ss-plate-label",variants:he,children:t}),e.jsx(p.div,{className:"ss-plate-shot",variants:ee,children:e.jsx("img",{src:i,alt:t,loading:"lazy",decoding:"async"})}),e.jsx(p.figcaption,{variants:Q,children:n})]})}const G=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop part way up: walls built to the halfway course, the roof and awning not yet placed, the umbrella pole still bare. Every piece is a separate modeled brick that snaps to the same stud grid the engine uses."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"The ruins in Edit Mode, built up to the doorway arch with the upper storey still to come. The highlighted course is the one going on next."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull prop in the UV Editing workspace. On the left the mesh is unwrapped flat over its painted texture, on the right the same texture is shown mapped onto the model. Every printed detail in the world is applied this way."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The modern house with the ground floor closed and the upper storey just started. The node graph under the viewport defines the tinted window glass: fully metallic, zero roughness, reduced alpha."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"The run down cottage with its walls finished and the roof not yet on, in a rendered viewport under a warm sun. Renders like this were used to check color and lighting before export."}];function me(){const[t,i]=r.useState(0);return e.jsxs(p.div,{className:"ss-sheet",variants:K,children:[e.jsx("div",{className:"ss-sheet-grid",children:G.map((n,l)=>e.jsxs(p.button,{className:`ss-cell${l===t?" on":""}`,variants:Z,onMouseEnter:()=>i(l),onFocus:()=>i(l),"aria-label":n.scene,children:[e.jsx(p.span,{className:"ss-cell-shot",variants:ee,children:e.jsx("img",{src:n.src,alt:n.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:n.scene})]},n.src))}),e.jsxs(p.p,{className:"ss-sheet-cap",variants:Q,children:[e.jsx("b",{children:G[t].scene}),G[t].caption]})]})}const ge=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],ue={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.5,ease:D(4)}}},q=[{id:"shop",name:"The coffee shop",cat:"Professional Services",x:15,y:25.5,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"The shop at dusk, its terrace laid out under the umbrella. The interior is the way into the professional work."},{id:"cottage",name:"The run down cottage",cat:"Personal Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"The cottage stands across the river, and the bridge beside it is the only crossing in the world."},{id:"house",name:"The modern house",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"The house after dark. Its lampposts run off the day cycle and brighten as the sun goes down."},{id:"ruins",name:"The ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"A crystal on the ruins balcony, built with an emissive material and a point light of its own."}],fe={hidden:{opacity:0,scale:0},show:{opacity:1,scale:1,transition:{duration:.5,ease:D(4)}}},be={hidden:{opacity:0,clipPath:"inset(100% 0% 0% 0%)"},show:{opacity:1,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.5,ease:D(5)}}};function ye(){const t=r.useRef(null),[i,n]=r.useState({left:0,top:0,w:0,h:0}),[l,s]=r.useState(null),[o,c]=r.useState(!1);r.useEffect(()=>{const a=t.current;if(!a)return;const u=2400,f=1350,S=()=>{const k=a.getBoundingClientRect();if(!k.width||!k.height)return;const w=Math.min(k.width/u,k.height/f),v=u*w,I=f*w;n({left:(k.width-v)/2,top:(k.height-I)/2,w:v,h:I})};S();const T=new ResizeObserver(S);return T.observe(a),()=>T.disconnect()},[]);const m=q.find(a=>a.id===l)||null;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(p.div,{className:"ss-map-stage",ref:t,variants:J,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:i.left,top:i.top,width:i.w,height:i.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the coffee shop, the run down cottage, the modern house and the ruins.",decoding:"async"}),q.map(a=>e.jsxs(p.button,{variants:fe,className:`ss-map-pin${a.flip?" flip":""}${l===a.id?" on":""}`,style:{left:a.x+"%",top:a.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{o||s(a.id)},onMouseLeave:()=>{o||s(null)},onFocus:()=>s(a.id),onClick:()=>{const u=l===a.id&&o;c(!u),s(u?null:a.id)},"aria-label":a.name+", "+a.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:a.cat})]},a.id))]})]}),g()]});function g(){return e.jsx(H,{children:m&&e.jsxs(p.div,{className:"ss-map-card",variants:be,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:m.src,alt:m.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-cat",children:m.cat}),e.jsx("span",{className:"ss-map-card-name",children:m.name}),e.jsx("p",{children:m.line})]})]},m.id)})}}function P({id:t,label:i,className:n,stagger:l,children:s}){const o=l?{hidden:{},show:{transition:{staggerChildren:l,delayChildren:.06}}}:ce;return e.jsx(p.section,{className:`ss-slide ss-snap${n?" "+n:""}`,"data-slide":t,"data-label":i,variants:o,initial:"hidden",whileInView:"show",viewport:{amount:.35},children:e.jsx("div",{className:"ss-slide-inner",children:s})})}function U({kicker:t,body:i,pair:n,children:l}){const s=e.jsx(M,{className:"ss-story-kicker",text:t,variant:V,stagger:.055}),o=e.jsx(M,{text:i,variant:Y,stagger:.016});return n?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:s}),e.jsx("div",{className:"ss-chapter-body",children:o})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[s,e.jsx("div",{className:"ss-chapter-body",children:o}),l]})}function xe({scrollRef:t}){const[i,n]=r.useState([]),[l,s]=r.useState(0),o=r.useRef([]);r.useEffect(()=>{const g=t.current;if(!g)return;const a=Array.from(g.querySelectorAll("[data-slide]"));o.current=a,n(a.map(f=>({id:f.dataset.slide||"",label:f.dataset.label||""})));const u=new IntersectionObserver(f=>{for(const S of f)if(S.isIntersecting){const T=o.current.indexOf(S.target);T>=0&&s(T)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return a.forEach(f=>u.observe(f)),()=>u.disconnect()},[t]);const c=g=>{const a=t.current,u=o.current[g];!a||!u||a.scrollTo({top:a.scrollTop+u.getBoundingClientRect().top-a.getBoundingClientRect().top,behavior:"smooth"})};if(i.length<2)return null;const m=l>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${m?" on":""}`,"aria-hidden":!m,children:i.map((g,a)=>e.jsx("button",{type:"button",className:`ss-deck-tick${a===l?" on":""}`,onClick:()=>c(a),"aria-label":g.label,"aria-current":a===l,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:g.label})},g.id))}),e.jsxs("div",{className:`ss-deck-count${m?" on":""}`,children:[e.jsx("b",{children:String(l+1).padStart(2,"0")})," / ",String(i.length).padStart(2,"0")]})]})}function we({base:t,emit:i}){const n=r.useRef(null),l=r.useRef({base:t,emit:i});return r.useEffect(()=>{l.current={base:t,emit:i}},[t,i]),r.useEffect(()=>{const s=n.current;if(!s)return;const o=s.getContext("2d");if(!o)return;const c=Math.min(window.devicePixelRatio||1,2);let m=0,g=0,a=0,u=performance.now();const f=()=>{m=s.clientWidth,g=s.clientHeight,s.width=Math.max(1,Math.floor(m*c)),s.height=Math.max(1,Math.floor(g*c)),o.setTransform(c,0,0,c,0,0)};f(),window.addEventListener("resize",f);const S=Array.from({length:12},()=>({x:Math.random(),y:Math.random(),r:110+Math.random()*280,vx:(Math.random()-.5)*.024,vy:(Math.random()-.5)*.024,ph:Math.random()*Math.PI*2,sp:.07+Math.random()*.12,a:.14+Math.random()*.12})),T=R=>{const j=R.replace("#",""),h=parseInt(j.length===3?j.split("").map(b=>b+b).join(""):j,16);return{r:h>>16&255,g:h>>8&255,b:h&255}},k=R=>{const j=R.split(",").map(Number);return{r:j[0],g:j[1],b:j[2]}},w=T(t),v=k(i),I=R=>{const j=Math.min(.05,(R-u)/1e3);u=R;const h=T(l.current.base),b=k(l.current.emit),d=Math.min(1,j*1.3);w.r+=(h.r-w.r)*d,w.g+=(h.g-w.g)*d,w.b+=(h.b-w.b)*d,v.r+=(b.r-v.r)*d,v.g+=(b.g-v.g)*d,v.b+=(b.b-v.b)*d,o.fillStyle=`rgb(${w.r|0},${w.g|0},${w.b|0})`,o.fillRect(0,0,m,g);const y=v.r|0,E=v.g|0,N=v.b|0;for(const x of S){x.x+=x.vx*j,x.y+=x.vy*j,x.ph+=x.sp*j,x.x<-.2&&(x.x=1.2),x.x>1.2&&(x.x=-.2),x.y<-.2&&(x.y=1.2),x.y>1.2&&(x.y=-.2);const B=(x.x+Math.sin(x.ph)*.02)*m,O=(x.y+Math.cos(x.ph*.8)*.02)*g,F=o.createRadialGradient(B,O,0,B,O,x.r);F.addColorStop(0,`rgba(${y},${E},${N},${x.a})`),F.addColorStop(1,`rgba(${y},${E},${N},0)`),o.fillStyle=F,o.beginPath(),o.arc(B,O,x.r,0,Math.PI*2),o.fill()}a=requestAnimationFrame(I)};return a=requestAnimationFrame(I),()=>{cancelAnimationFrame(a),window.removeEventListener("resize",f)}},[]),e.jsx("canvas",{ref:n,"aria-hidden":!0,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block",zIndex:0}})}function ve({onCardClick:t,onNavigate:i}){const n=C(),[l,s]=r.useState(window.innerWidth>=1024);r.useEffect(()=>{const d=()=>{s(window.innerWidth>=1024)};return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]);const[o,c]=r.useState(0),m=_.length,g=r.useRef(0),a=r.useRef(!1);r.useEffect(()=>{const d=setTimeout(()=>c(y=>(y+1)%m),3e4);return()=>clearTimeout(d)},[o,m]);const u=d=>c(y=>(y+d+m)%m),f=window.innerWidth<=640,S=l?420:Math.min(window.innerWidth*.74,360),T=Math.min(S*1.32,window.innerHeight*.6),k=S*(l?.98:.62),w={"creative-projects":{base:"#030b05",emit:"46,224,120"},"professional-services":{base:"#ffffff",emit:"150,152,158"},nabu:{base:"#0d1015",emit:"84,168,255"}},v=_[o]?.id,I=v==="professional-services",R=I?"#14110b":"var(--white)",j=R,h=I?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",b=w[v]||w["creative-projects"];return e.jsxs(p.div,{...W,style:{position:"absolute",inset:0,overflow:"hidden",background:"#0c0d0f"},children:[e.jsx(we,{base:b.base,emit:b.emit}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,pointerEvents:"none",opacity:.03,backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='wn'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23wn)'/%3E%3C/svg%3E")`,backgroundSize:"180px"}}),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"44px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(p.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8,delay:.1,ease:[.16,1,.3,1]},style:{fontSize:"clamp(38px,5vw,84px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:R,textShadow:h,transition:"color 0.7s ease"},children:"Work"}),l&&e.jsxs(p.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.35,ease:[.16,1,.3,1]},style:{marginTop:10,maxWidth:640},children:[e.jsx("p",{style:{fontSize:15,lineHeight:1.45,color:j,textShadow:h,transition:"color 0.7s ease"},children:"Commissioned client work, plus personal and academic projects across every medium."}),e.jsx("a",{onClick:()=>i("contact"),...n,className:"ss-work-cta",style:{display:"inline-block",marginTop:8,fontSize:14,fontWeight:600,color:R,textShadow:h,cursor:"none",transition:"color 0.7s ease"},children:"Available for work. Let's talk →"})]})]}),e.jsx("div",{style:{position:"absolute",left:0,right:0,top:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",perspective:1800,touchAction:"pan-y"},onPointerDown:d=>{g.current=d.clientX,a.current=!1},onPointerMove:d=>{Math.abs(d.clientX-g.current)>8&&(a.current=!0)},onPointerUp:d=>{const y=d.clientX-g.current;y<-48?u(1):y>48&&u(-1)},children:_.map((d,y)=>{const E=(y-o+m)%m,N=E===0?{x:0,scale:1,rotateY:0,opacity:1,z:3}:E===1?{x:k,scale:.82,rotateY:-14,opacity:1,z:2}:{x:-k,scale:.82,rotateY:14,opacity:1,z:2};return d.id==="nabu"?e.jsxs(p.div,{animate:{x:N.x,scale:N.scale,rotateY:N.rotateY,opacity:N.opacity},transition:{duration:.6,ease:[.16,1,.3,1]},onClick:()=>{a.current||(E===0?t(d):c(y))},...n,style:{position:"absolute",width:S,height:T,zIndex:N.z,cursor:"none",transformStyle:"preserve-3d",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:d.img,alt:d.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",display:"block",pointerEvents:"none",filter:E===0?"drop-shadow(0 26px 55px rgba(0,0,0,.55))":"none",transition:"filter .5s ease"}}),e.jsxs("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:R,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:d.title}),e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginTop:7},children:d.tag})]})]},d.id):e.jsxs(p.div,{className:"ss-card",animate:{x:N.x,scale:N.scale,rotateY:N.rotateY,opacity:N.opacity},transition:{duration:.6,ease:[.16,1,.3,1]},onClick:()=>{a.current||(E===0?t(d):c(y))},...n,style:{position:"absolute",width:S,height:T,zIndex:N.z,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:E===0?"0 40px 90px rgba(0,0,0,.6)":"0 20px 50px rgba(0,0,0,.5)",transformStyle:"preserve-3d"},children:[e.jsx("img",{src:d.img,alt:d.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:d.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"24px 22px",pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginBottom:6},children:d.tag}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:d.title}),E===0&&e.jsx("span",{style:{fontSize:13,color:"var(--white)",whiteSpace:"nowrap",fontWeight:500},children:"View →"})]})]})]},d.id)})}),e.jsx("div",{style:{position:"absolute",bottom:f?22:30,left:0,right:0,display:"flex",justifyContent:"center",gap:9,zIndex:20},children:_.map((d,y)=>e.jsx("div",{onClick:()=>c(y),...n,style:{width:y===o?26:8,height:8,borderRadius:980,background:y===o?"#38bdf8":I?"rgba(20,17,11,.3)":"rgba(245,242,237,.28)",cursor:"none",transition:"all .45s cubic-bezier(.16,1,.3,1)"}},y))})]},"work")}function ke(){const[t,i]=r.useState(!1),[n,l]=r.useState(window.innerWidth<=640);return r.useEffect(()=>{const s=()=>{l(window.innerWidth<=640)};return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),e.jsx(p.div,{...W,style:{position:"absolute",inset:0,background:"var(--cream)",overflow:"hidden"},className:"ss-about-page",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",height:"100%",width:"100%"},children:[e.jsxs("div",{className:"ss-about-text-column",style:{display:"flex",flexDirection:"column",justifyContent:"center",padding:window.innerWidth<=640?"60px 3vw 60px 3vw":"80px 60px 80px 8vw",overflow:"hidden"},children:[e.jsx(p.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.7,delay:.1,ease:[.16,1,.3,1]},className:"ss-about-subtitle",style:{fontFamily:"'Space Mono', monospace",fontSize:12,letterSpacing:4,textTransform:"uppercase",color:"var(--accent)",marginBottom:16},children:"Designer & Maker"}),e.jsx(p.h2,{initial:{opacity:0,x:-30},animate:{opacity:1,x:0},transition:{duration:.8,delay:.2,ease:[.16,1,.3,1]},style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(96px,12vw,180px)",letterSpacing:4,lineHeight:.92,color:"#060606",marginBottom:16},children:"About"}),e.jsx(p.div,{initial:{width:0},animate:{width:80},transition:{duration:1,delay:.5,ease:[.16,1,.3,1]},style:{height:1,background:"#060606",margin:"16px 0"}}),e.jsxs(p.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.55,ease:[.16,1,.3,1]},children:[e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:20,fontWeight:300,lineHeight:1.75,color:"#3a3a3a",maxWidth:480},children:"I'm a graphic designer and developer working across 3D design, motion graphics, UI/UX, fabrication, cinematography, and code. Covering several disciplines lets me take a project from concept to delivery without handing it off."}),e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:20,fontWeight:300,lineHeight:1.75,color:"#3a3a3a",maxWidth:480,marginTop:20},children:"That range started in childhood with LEGO builds and stop motion films, and it became a working habit: learn the tools each project requires and use them properly. I hold finished work to a high standard of craft and detail."})]})]}),e.jsxs(p.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.9,delay:.1},style:{position:"relative",overflow:"hidden",background:"#1a1a1a"},children:[e.jsx("img",{src:"/assets/Shyon_About.png",alt:"Shyon Shiri",onLoad:()=>i(!0),className:t?"ss-about-photo ss-about-photo-active":"ss-about-photo",style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 10%",filter:"grayscale(20%) contrast(1.05)"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to right, rgba(237,232,224,.2) 0%, transparent 30%), linear-gradient(to bottom, rgba(6,6,6,.35) 0%, transparent 30%, transparent 60%, rgba(6,6,6,.18) 100%)"}})]})]})},"about")}function je(){const t=C(),i=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(p.div,{...W,style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}}),e.jsxs("div",{style:{position:"relative",zIndex:10,padding:window.innerWidth<=640?"0 18px":"0 9vw",width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsxs("div",{children:[e.jsx(p.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.7,delay:.2,ease:[.16,1,.3,1]},className:"ss-contact-subtitle",style:{fontFamily:"'Space Mono', monospace",fontSize:11,letterSpacing:5,textTransform:"uppercase",color:"var(--sky)",marginBottom:20},children:"Available for projects"}),e.jsxs(p.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.9,delay:.35,ease:[.16,1,.3,1]},className:"ss-contact-heading",style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(64px,9vw,128px)",letterSpacing:5,lineHeight:.86,color:"var(--white)"},children:["Let's Work",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})]}),e.jsx(p.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:.5},className:"ss-contact-description",style:{fontFamily:"'Cormorant Garamond', serif",fontStyle:"italic",fontWeight:300,fontSize:"clamp(18px,2vw,22px)",color:"var(--mid)",maxWidth:280,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(p.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.65,ease:[.16,1,.3,1]},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:i.map((n,l)=>e.jsxs("a",{href:n.href,target:n.target,rel:n.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},onMouseEnter:s=>{s.currentTarget.style.background="rgba(56,189,248,.07)",s.currentTarget.style.paddingLeft="24px"},onMouseLeave:s=>{s.currentTarget.style.background="transparent",s.currentTarget.style.paddingLeft="8px"},...t,children:[e.jsx("span",{style:{fontFamily:"'Space Mono', monospace",fontSize:window.innerWidth<=640?10:12,letterSpacing:2,color:"var(--sky)",width:34,flexShrink:0},children:String(l+1).padStart(2,"0")}),e.jsx("span",{style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:window.innerWidth<=640?"clamp(18px,3vw,28px)":"clamp(28px,4vw,40px)",letterSpacing:2,color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:n.label}),e.jsx("span",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:window.innerWidth<=640?14:20,color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:n.value}),e.jsx("span",{style:{fontFamily:"'Space Mono', monospace",fontSize:18,color:"var(--sky)",flexShrink:0},children:"→"})]},n.label))})]})]},"contact")}function Ee({project:t,onClose:i,onMediaClick:n}){const l=C(),[s,o]=r.useState(window.innerWidth>=1024);return r.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),r.useEffect(()=>{const c=()=>{o(window.innerWidth>=1024)};return window.addEventListener("resize",c),()=>window.removeEventListener("resize",c)},[]),e.jsx(p.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.4},onClick:i,style:{position:"fixed",inset:0,zIndex:2e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(p.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.96},transition:{duration:.4,ease:[.16,1,.3,1]},onClick:c=>c.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:i,className:"ss-modal-close",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...l,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:16,color:"var(--sky)",marginTop:8},children:t.id==="creative-projects"?"A selection of projects that demonstrate my range across various creative disciplines and mediums.":t.id==="professional-services"?"Client-focused work including UI/UX, web development, branding and marketing assets.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":"testing"})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const c=t.media.filter(a=>!a.hidden),m=window.innerWidth<=640?2:window.innerWidth<=1023?3:4,g=Array.from({length:m},()=>[]);return c.forEach((a,u)=>g[u%m].push(a)),g.map((a,u)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:a.map((f,S)=>e.jsx(Se,{item:f,onClick:()=>n(f)},S))},u))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, 220px)",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(c=>!c.hidden).map((c,m)=>e.jsx(Te,{item:c,onClick:()=>n(c)},m))}),!s&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"↻ Swipe to explore"})]})})}function Se({item:t,onClick:i}){const n=C(),l=t.aspectRatio||"4/3";return e.jsxs("div",{className:"ss-scell",onClick:i,...n,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:l},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,color:"var(--mid)",marginTop:4},children:t.year})]})]})}function Te({item:t,onClick:i}){const n=C();return e.jsxs("div",{className:"ss-tile",onClick:i,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...n,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,color:"var(--sky)",letterSpacing:1,marginTop:2},children:t.year})]})]})}function Ne({item:t,onClose:i,onItemClick:n}){const l=C(),s=t;return e.jsx(p.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.35},onClick:i,style:{position:"fixed",inset:0,zIndex:3e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(p.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.96},transition:{duration:.35,ease:[.16,1,.3,1]},onClick:o=>o.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:i,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...l,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:s.removeBackground?"transparent":"inherit",position:"relative"},children:s.type==="video"?e.jsx("video",{src:s.src,poster:s.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},s.src):e.jsx("img",{src:s.src,alt:s.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:s.scale?`scale(${s.scale})`:"scale(1)"}},s.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:t.year}),t.desc&&e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:18,lineHeight:1.7,color:"rgba(245,242,237,.75)",fontWeight:300,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((o,c)=>e.jsxs("button",{onClick:()=>{const m=_.flatMap(g=>g.media).find(g=>g.title===o);m&&n&&n(m)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...l,children:["View ",o," →"]},c))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...l,children:"Visit Website →"})]})]})})}ae.createRoot(document.getElementById("root")).render(e.jsx(r.StrictMode,{children:e.jsx(ne,{})}));
