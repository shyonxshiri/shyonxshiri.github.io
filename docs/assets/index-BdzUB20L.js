import{r as ue,a as l,j as e,A as Q,u as ce,m as k,b as fe,c as ae,d as be}from"./vendor-DeZ2j9FL.js";(function(){const r=document.createElement("link").relList;if(r&&r.supports&&r.supports("modulepreload"))return;for(const h of document.querySelectorAll('link[rel="modulepreload"]'))m(h);new MutationObserver(h=>{for(const a of h)if(a.type==="childList")for(const u of a.addedNodes)u.tagName==="LINK"&&u.rel==="modulepreload"&&m(u)}).observe(document,{childList:!0,subtree:!0});function i(h){const a={};return h.integrity&&(a.integrity=h.integrity),h.referrerPolicy&&(a.referrerPolicy=h.referrerPolicy),h.crossOrigin==="use-credentials"?a.credentials="include":h.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function m(h){if(h.ep)return;h.ep=!0;const a=i(h);fetch(h.href,a)}})();var Y={},ie;function we(){if(ie)return Y;ie=1;var t=ue();return Y.createRoot=t.createRoot,Y.hydrateRoot=t.hydrateRoot,Y}var ye=we();function xe({realmSupported:t,onViewOverview:r}){const i=l.useRef(null),[m,h]=l.useState(!1),a=()=>{const u=i.current;u&&(h(!0),u.focus(),u.play().catch(()=>u.focus()))};return l.useEffect(()=>{const u=i.current;if(!u)return;const g=new IntersectionObserver(([s])=>{s.isIntersecting||u.pause()}),d=()=>{document.hidden&&u.pause()};return g.observe(u),document.addEventListener("visibilitychange",d),()=>{g.disconnect(),document.removeEventListener("visibilitychange",d)}},[]),e.jsxs("section",{className:"ss-about-view","aria-labelledby":"ss-bio-heading",children:[e.jsxs("div",{className:"ss-about-hero",children:[e.jsx("figure",{className:"ss-about-photo",children:e.jsx("img",{src:"/assets/Shyon_Studio_3298.jpg",srcSet:"/assets/Shyon_Studio_1000.jpg 662w, /assets/Shyon_Studio_1800.jpg 1192w, /assets/Shyon_Studio_3298.jpg 2184w",sizes:"(max-width: 640px) 100vw, (max-width: 900px) max(48vw, 464px), max(50vw, 47.7vh, 477px)",width:"2184",height:"3298",alt:"Shyon Shiri seated in a black jacket against a studio backdrop",decoding:"async"})}),e.jsxs("div",{className:"ss-about-intro",children:[e.jsx("h2",{id:"ss-bio-heading",children:"About Me."}),e.jsx("p",{className:"ss-about-lead",children:"I am a Graphic Designer and Developer."}),e.jsx("p",{children:"Based in the Bay Area, I work across visual communication, front-end development, 3D modeling, and physical fabrication. I work with both the design and technical requirements of a project, including typography, layout, prototyping, and production."}),e.jsxs("p",{className:"ss-about-education",children:["BA in Graphic Design",e.jsx("br",{}),"San Jose State University, 2025"]})]})]}),e.jsxs("section",{className:"ss-about-film","aria-labelledby":"ss-film-heading",children:[e.jsx("header",{className:"ss-about-film-heading",children:e.jsxs("h3",{id:"ss-film-heading",children:[e.jsx("span",{children:"My First"})," ",e.jsx("span",{children:"Creative Outlet"})]})}),e.jsxs("div",{className:"ss-about-film-stage",children:[e.jsx("div",{className:"ss-about-film-meta",children:e.jsx("time",{dateTime:"2013-10-15",children:"October 15, 2013"})}),e.jsxs("figure",{className:"ss-about-film-player",children:[e.jsxs("video",{ref:i,controls:m,tabIndex:m?0:-1,playsInline:!0,preload:"none",width:"1920",height:"1080",poster:"/assets/my-first-lego-movie.jpg","aria-labelledby":"ss-film-heading",children:[e.jsx("source",{src:"/assets/my-first-lego-movie.mp4",type:"video/mp4"}),e.jsx("a",{href:"/assets/my-first-lego-movie.mp4",children:"Watch My First LEGO Film"})]}),!m&&e.jsxs("button",{className:"ss-about-film-play",type:"button",onClick:a,"aria-label":"Play LEGO stop-motion film",children:[e.jsx("svg",{viewBox:"0 0 24 24",width:"20",height:"20","aria-hidden":"true",children:e.jsx("path",{d:"M8 5v14l11-7z",fill:"currentColor"})}),e.jsx("span",{children:"Play Film"})]})]})]}),e.jsxs("div",{className:"ss-about-film-note",children:[e.jsx("p",{children:"This LEGO stop-motion film was the starting point for the work I do today. It sparked my interest in design and technology and encouraged me to explore other creative disciplines. The interactive LEGO portfolio on this site builds on that foundation, bringing together the skills I’ve developed since."}),t?e.jsx("a",{className:"ss-about-film-link",href:"/lego.html",children:"View My LEGO Portfolio"}):e.jsx("button",{className:"ss-about-film-link",type:"button",onClick:r,children:"View My LEGO Portfolio"})]})]})]})}const O=[{id:"creative-projects",title:"Selected Works",tag:"Design, 3D & Craft",img:"/assets/3D_Models_Cover_Pic.jpg",size:"tall",objectPosition:"50% 37%",media:[{type:"image",src:"/assets/resume-design/business-card-mockup.jpg",title:"Résumé Design",credit:"SJSU · DSGD 83 · Digital Applications: Basics",year:2022,aspectRatio:"2092/1392",desc:"A unique résumé and coordinating business card designed from scratch, with a consistent visual identity across both pieces. A Photoshop mockup presents the cards in a realistic setting.",pages:["/assets/resume-design/resume.png","/assets/resume-design/business-card-front.png","/assets/resume-design/business-card-back.png","/assets/resume-design/business-card-mockup.jpg"],pageLabels:["Résumé","Business Card, Front","Business Card, Back","Business Card Mockup"]},{type:"image",src:"/assets/procrastination-booklet/page-01.png",title:"Procrastination Booklet",credit:"SJSU · DSGD 83 · Digital Applications: Basics",year:2022,aspectRatio:"1786/2200",desc:"A final project for my 2022 DSGD course at SJSU. I drew and developed the entire booklet from scratch in Adobe Illustrator, combining original illustrations, typography, and page layouts.",pages:Array.from({length:10},(t,r)=>`/assets/procrastination-booklet/page-${String(r+1).padStart(2,"0")}.png`)},{type:"image",src:"/assets/Beta_Theta_Pi_Rush.svg",title:"Rush Event Illustration",credit:"Independent project · Beta Theta Pi",year:2023,desc:"An illustration drawn from scratch for a Beta Theta Pi rush event in 2023, using the Lyrical Lemonade logo as a visual reference.",aspectRatio:"364/556"},{type:"image",src:"/assets/Cow_Abduction_1.jpg",title:"Cow Abduction",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A Blender scene of a cow suspended beneath a flying saucer, created as an opening exercise to demonstrate my existing 3D skills. The project established a baseline in modeling, composition, and lighting for the studies that followed.",aspectRatio:"1/1",pages:["/assets/Cow_Abduction_1.jpg","/assets/Cow_Abduction_2.jpg","/assets/Cow_Abduction_3.jpg"],pageLabels:["Three-Quarter View","Overhead View","Front View"],relatedItems:["Venom Character Sculpt","The Broken NPC"]},{type:"video",src:"/assets/Broken_NPC.MP4",poster:"/assets/Broken_NPC.jpg",title:"The Broken NPC",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A final Blender animation depicting in-game rendering errors from GTA San Andreas. The project brings together the modeling foundations demonstrated in Cow Abduction, the detailed sculpting developed through Venom, and the camera animation and rendering explored in BMW Street Render.",aspectRatio:"16/9",relatedItems:["Cow Abduction","Venom Character Sculpt","BMW Street Render"]},{type:"video",src:"/assets/Blender_Case_Video.mp4",poster:"/assets/Blender_Case.jpg",title:"Apple Accessory Concepts",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"Concept designs for Apple accessory cases, modeled and rendered in Blender.",aspectRatio:"16/9",relatedItems:["AirPods Max, In Blender","Phone and AirPods, In Blender","Custom AirPods Case","Custom Phone Case"]},{type:"image",src:"/assets/AirPods_Max_In_Blender.jpg",title:"AirPods Max, In Blender",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A photo I took of the AirPods Max accessory concept in Blender after designing it. The viewport shows the sculptural shell fitted around the ear cup.",aspectRatio:"3/4",hidden:!0,relatedItems:["Apple Accessory Concepts","Phone and AirPods, In Blender"]},{type:"image",src:"/assets/Apple_Accessories_In_Blender.jpg",title:"Phone and AirPods, In Blender",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A classroom photo I took of the phone and AirPods accessory concepts in Blender after designing them. It documents the digital models in my workspace.",aspectRatio:"3/4",hidden:!0,relatedItems:["Apple Accessory Concepts","AirPods Max, In Blender"]},{type:"video",src:"/assets/Masking_And_Color_Grading.mp4",poster:"/assets/Masking_And_Color_Grading.jpg",title:"Masking and Color Grading Study",credit:"SJSU · ART 105 · Advanced Digital Video",year:2024,desc:"A compositing study combining three separate performances into one scene through masking and color grading in Adobe Premiere Pro and After Effects.",aspectRatio:"16/9"},{type:"video",src:"/assets/Shiri_Video_Game.mp4",poster:"/assets/Shiri_VIdeo_Game.jpg",title:"Video Game Demo",credit:"SJSU · ART 105 · Advanced Digital Video",year:2024,desc:"A mock retro driving game, animated and cut together in Adobe After Effects from pixel art frames of a neon city at night.",aspectRatio:"16/9"},{type:"image",src:"/assets/Venom.webp",title:"Venom Character Sculpt",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A sculpt of Venom’s head, modeled and rendered in Blender to develop greater detail and precision. Building on the opening Cow Abduction exercise, the project focused on more intricate forms, surface materials, and lighting.",aspectRatio:"16/9",relatedItems:["Cow Abduction","BMW Street Render","The Broken NPC"]},{type:"image",src:"/assets/My_Case.jpg",title:"Custom Phone Case",credit:"Started at SJSU · Independently developed",year:2025,desc:"An accessory design developed beyond its original coursework into a finished 3D-printed case. An open lattice wraps around the camera and side buttons.",aspectRatio:"5/6",relatedItems:["Apple Accessory Concepts"]},{type:"image",src:"/assets/Airpod_Case.JPG",title:"Custom AirPods Case",credit:"Started at SJSU · Independently developed",year:2026,desc:"An accessory design developed beyond its original coursework into a finished 3D-printed sleeve. An open lattice wraps an AirPods Pro case, leaving the status light and hinge accessible.",aspectRatio:"4/5",relatedItems:["Apple Accessory Concepts"]},{type:"image",src:"/assets/New_Radar_Sensor_front.jpg",title:"Ultrasonic Sensor, Front View",year:2024,desc:"Front of the ultrasonic sensor enclosure. Paired ultrasonic transducers, a 16x2 character LCD, and a recessed speaker cone, all set into a 3D-printed shell.",aspectRatio:"4/3",hidden:!0,relatedItems:["Ultrasonic Sensor, Back View","Ultrasonic Sensor and RGB Controller","HMI Sensor System"]},{type:"image",src:"/assets/New_Radar_Sensor_Back.jpg",title:"Ultrasonic Sensor, Back View",year:2024,desc:"Back of the ultrasonic sensor enclosure, showing the access panel, wiring routing, and the power and control cutouts.",aspectRatio:"4/3",hidden:!0,relatedItems:["Ultrasonic Sensor, Front View","Ultrasonic Sensor and RGB Controller","HMI Sensor System"]},{type:"image",src:"/assets/New_LED_Box_Front.jpg",title:"RGB Box, Front View",year:2024,desc:"Front of the RGB controller. A faceted 3D-printed shell with the addressable LED strip seated in a chamfered channel.",aspectRatio:"4/3",hidden:!0,relatedItems:["RGB Box, Back View","Ultrasonic Sensor and RGB Controller","RGB Controller"]},{type:"image",src:"/assets/New_LED_Box_Back.jpg",title:"RGB Box, Back View",year:2024,desc:"Back of the RGB controller, with the potentiometer, mode button, and toggle switch mounted through the top panel.",aspectRatio:"4/3",hidden:!0,relatedItems:["RGB Box, Front View","Ultrasonic Sensor and RGB Controller","RGB Controller"]},{type:"image",src:"/assets/Programming_Cover_Pic.jpg",title:"Ultrasonic Sensor and RGB Controller",year:2024,desc:"Both enclosures side by side. Each was modeled around its own board, display, and controls, then 3D printed and finished by hand.",aspectRatio:"4/3",hidden:!0,relatedItems:["HMI Sensor System","RGB Controller"]},{type:"image",src:"/assets/Max_Pic.JPG",title:"Studio Portrait",credit:"SJSU · PHOT 125 · Advanced Photographic Media",year:2024,desc:"Caught mid-laugh on a gelled teal backdrop, with the background light hot behind the head so the subject separates from it.",aspectRatio:"2/3"},{type:"image",src:"/assets/Photography_1.jpg",title:"Studio Photography",credit:"SJSU · PHOT 121 · Introduction to Studio Lighting",year:2022,desc:"A hand-drawn wordmark set over a cropped apparel shot, chains and acid-washed corduroy, framed close so the type sits on the garment rather than beside it.",aspectRatio:"1/1"},{type:"video",src:"/assets/New_Radar_Sensor.mp4",poster:"/assets/New_Radar_Sensor_front.jpg",title:"HMI Sensor System",credit:"SJSU · ART 106 · The Human Machine Interface",year:2024,desc:"An ultrasonic sensing device with an LCD, speaker, and 3D-printed enclosure that translates sensor readings into visual and audio feedback.",aspectRatio:"4/3",builds:[{src:"/assets/HMI_Sensor_Original_Build.mp4",poster:"/assets/HMI_Sensor_Original_Build.jpg",label:"Original Build",aspectRatio:"16/9"},{src:"/assets/New_Radar_Sensor.mp4",poster:"/assets/New_Radar_Sensor_front.jpg",label:"Redesigned Build",aspectRatio:"4/3"}],relatedItems:["HMI Sensor System, Tools and Components","HMI Sensor System, Speaker Development","Ultrasonic Sensor, Front View","Ultrasonic Sensor, Back View","Ultrasonic Sensor and RGB Controller"]},{type:"video",src:"/assets/New_LED_Box.mp4",poster:"/assets/New_LED_Box_Front.jpg",title:"RGB Controller",credit:"SJSU · ART 106 · The Human Machine Interface",year:2024,desc:"An LED controller with physical controls and a 3D-printed enclosure, designed around the electronics inside.",aspectRatio:"4/3",builds:[{src:"/assets/RGB_Controller_Original_Build.mp4",poster:"/assets/RGB_Controller_Original_Build.jpg",label:"Original Build",aspectRatio:"16/9"},{src:"/assets/New_LED_Box.mp4",poster:"/assets/New_LED_Box_Front.jpg",label:"Redesigned Build",aspectRatio:"4/3"}],relatedItems:["RGB Controller, Early Development","RGB Box, Front View","RGB Box, Back View","Ultrasonic Sensor and RGB Controller"]},{type:"image",src:"/assets/Radar_Tools_And_Components.jpg",title:"HMI Sensor System, Tools and Components",credit:"SJSU · ART 106 · The Human Machine Interface",year:2024,desc:"Tools and electronic components used during development of the ultrasonic distance sensor system, including breadboards, soldering equipment, a multimeter, and wiring supplies.",aspectRatio:"3024/2266",hidden:!0,relatedItems:["HMI Sensor System","HMI Sensor System, Speaker Development"]},{type:"video",src:"/assets/Radar_Speaker_Development.mp4",poster:"/assets/Radar_Speaker_Development.jpg",title:"HMI Sensor System, Speaker Development",credit:"SJSU · ART 106 · The Human Machine Interface",year:2024,desc:"An early speaker prototype for the ultrasonic distance sensor system, shown with its breadboard circuit before integration into the finished enclosure. Enable sound to hear the demonstration.",aspectRatio:"9/16",hidden:!0,relatedItems:["HMI Sensor System"]},{type:"image",src:"/assets/RGB_Controller_Development.jpg",title:"RGB Controller, Early Development",credit:"SJSU · ART 106 · The Human Machine Interface",year:2024,desc:"An early stage of the RGB controller project, showing the microcontroller and LED on a breadboard alongside wiring, components, and assembly tools.",aspectRatio:"3/4",hidden:!0,relatedItems:["RGB Controller"]},{type:"image",src:"/assets/Glass_Project_3127.jpg",title:"DNA-Inspired Kinetic Sculpture",credit:"SJSU · ART 141 · Topics in Advanced Glass",year:2023,desc:"A DNA-inspired sculpture combining liquid-metal forms designed in Blender and 3D printed with a connecting wire framework. The printed forms create a tubular path for a separately printed ball, with the structure designed to guide its movement through the piece.",aspectRatio:"3/4"},{type:"image",src:"/assets/Glass_Project_3130.jpg",title:"Wire-Framed Glass Vase",credit:"SJSU · ART 141 · Topics in Advanced Glass",year:2023,desc:"A glass vase shaped through heating and glassblowing within a handmade wire frame. The frame served as a boundary for the expanding glass, guiding the form of the vessel.",aspectRatio:"3/4",scale:1.15},{type:"image",src:"/assets/Shyon_Sculpture.jpg",title:"Product, Not Consumer",credit:"SJSU · ART 68 · Beginning Sculpture",year:2024,desc:"Hand-fabricated steel sculpture referencing consumer tech culture, welded, ground, sanded, and finished.",aspectRatio:"5/4",relatedItems:["Before Assembly"]},{type:"image",src:"/assets/Product_Not_Consumer_Before.jpg",title:"Before Assembly",credit:"SJSU · ART 68 · Beginning Sculpture",year:2024,desc:"Steel components laid out before welding and sculpting the finished piece.",aspectRatio:"3/4",hidden:!0,relatedItems:["Product, Not Consumer"]},{type:"image",src:"/assets/Adverstisement_Project.jpg",title:"Advertisement Project",credit:"SJSU · PHOT 125 · Advanced Photographic Media",year:2024,desc:"A spec print advertisement for a fictional shaver brand. The rotary shaver is lit as the hero and its shadow runs back to the bloodied cartridge razor it replaces.",aspectRatio:"16/9"},{type:"video",src:"/assets/BMW_Street_Render.mp4",poster:"/assets/BMW_Street_Render.jpg",playbackRate:.75,title:"BMW Street Render",credit:"SJSU · ART 102 · 3D Modeling and Printing",year:2024,desc:"A detailed BMW M3 street scene combining modeling with camera animation, shot composition, and rendering. I built the car and the entire environment from scratch, extending the focus on detail into an animated scene.",aspectRatio:"16/9",relatedItems:["Venom Character Sculpt","The Broken NPC"]},{type:"image",src:"/assets/Dark_Lane_Demo_Tapes_Homage.jpg",title:"Dark Lane Demo Tapes Homage",credit:"Independent Project",year:2023,desc:"A personal Photoshop tribute to Drake’s Dark Lane Demo Tapes mixtape cover, reimagined in LEGO form. The image recreates the cover’s hooded portrait and dark atmosphere.",aspectRatio:"1179/1182",pages:["/assets/Dark_Lane_Demo_Tapes_Homage.jpg","/assets/Dark_Lane_Demo_Tapes_Original.jpg"],pageLabels:["LEGO Homage","Side-by-Side Comparison"],comparisonCredit:"Original cover: Drake, Dark Lane Demo Tapes. LEGO homage: Shyon Shiri."},{type:"image",src:"/assets/Photoshop_Experiment_1.jpg",title:"First Photoshop Renditions",credit:"SJSU · ART 74 · Introduction to Digital Media",year:2020,desc:"My first Photoshop experiments, combining photographs through layering, repetition, color shifts, and distortion. The two compositions explore fragmented landscapes and altered cityscapes.",aspectRatio:"7/5",pages:["/assets/Photoshop_Experiment_1.jpg","/assets/Photoshop_Experiment_2.jpg"],pageLabels:["Landscape Collage","Cityscape Study"]},{type:"image",src:"/assets/early-portfolio/home.jpg",title:"Early Portfolio Website",credit:"SJSU · ART 101 · Digital Media Art",year:2022,desc:"An early personal portfolio built in Google Sites to present creative coding, 3D, and music projects while learning GitHub.",aspectRatio:"2732/2048",pages:["/assets/early-portfolio/home.jpg","/assets/early-portfolio/creative-coding.jpg","/assets/early-portfolio/coding-study-1.jpg","/assets/early-portfolio/coding-study-2.jpg"],pageLabels:["Homepage","Creative Coding","Coding Study 1","Coding Study 2"]}]},{id:"professional-services",title:"Freelance Projects",tag:"Web & Design",img:"/assets/Everly_Cover_Image-1280.webp",size:"wide",media:[{type:"image",src:"/assets/Mina_Website.webp",title:"minasech.net",year:2025,desc:"Website design and React development, with a responsive interface.",link:"https://minasech.net",wide:!0,aspectRatio:"16/9"},{type:"image",src:"/assets/Everly_Cover_Image.webp",title:"Everly Care Home",year:2026,desc:"Brand identity, responsive website design, development, and deployment for a senior care community.",link:"https://everlycarehome.com",wide:!0,aspectRatio:"16/9"},{type:"image",src:"/assets/RealEstate_Luning_Flyer.jpg",title:"Luning Drive Listing",year:2022,desc:"Property marketing flyer designed for Real Estate Experts, pairing a hero listing photo with clean typographic hierarchy, a status badge, and agent branding.",aspectRatio:"3/4"},{type:"image",src:"/assets/RealEstate_Colleen_Flyer.jpg",title:"Colleen Drive Listing",year:2022,desc:"A dual-agent listing flyer combining property details, brand elements, and paired agent headshots in a balanced square format.",aspectRatio:"1/1"},{type:"image",src:"/assets/RealEstate_MorningStar_Flyer.webp",title:"Morning Star Drive Listing",year:2022,desc:"A listing announcement co-branded with Compass, combining pricing, property specifications, and sales highlights.",aspectRatio:"4/5"},{type:"image",src:"/assets/RealEstate_MoskowiteCorner_Concept.jpg",title:"Moskowite Corner Redevelopment",year:2026,desc:"An AI-generated concept visualization for a real estate redevelopment study at Moskowite Corner, CA. It shows a closed gas station lot rebuilt as a fuel and retail stop, modeled from aerial references for a developer evaluating the property.",aspectRatio:"5/3",relatedItems:["Moskowite Corner, Existing Site"]},{type:"image",src:"/assets/RealEstate_MoskowiteCorner_Before.webp",title:"Moskowite Corner, Existing Site",year:2026,desc:"The existing site before redevelopment. A closed 1.26-acre gas station lot with parking and an office building.",aspectRatio:"16/9",hidden:!0,relatedItems:["Moskowite Corner Redevelopment"]}]},{id:"nabu",title:"NABU",tag:"Streetwear Brand",img:"/assets/New_NABU_Cover_Card.webp",size:"tall",media:[{type:"video",src:"/assets/Nabu_Poster_Banner.mp4",poster:"/assets/Nabu_Poster_Banner.jpg",title:"Brand Film",year:2023,desc:"Promotional video for NABU clothing, animated in Adobe After Effects.",wide:!0},{type:"video",src:"/assets/NABU_PUFFER_AD.mp4",poster:"/assets/NABU_Puffer_AD.jpg",title:"Puffer Collection Teaser",year:2025,desc:"A teaser edited in 2025 for the 2026 puffer jacket collection.",relatedItems:["Puffer Jacket, Front","Puffer Jacket, Back"]},{type:"video",src:"/assets/NABU_SALE_AD.mp4",poster:"/assets/NABU_SALE_AD.jpg",title:"Summer 2025",year:2025,desc:"Promotional video for the summer drop, camp-collar shirts and rug-pattern shorts, shot as a flat lay on white."},{type:"image",src:"/assets/Stevie_Pic.JPG",title:"Spring 2023",year:2022,desc:"Shot in 2022 for the 2023 spring collection. Two looks on a white cyclorama, the graphic tees worn over the Persian rug trousers, with the raw fringed seams left showing down the leg."},{type:"image",src:"/assets/NABU_Puffer_Front.jpg",title:"Puffer Jacket, Front",year:2025,desc:"Studio still from the puffer collection shoot. Woven bandana panelling across the body, sleeves, and hood, shot on a white cyclorama.",aspectRatio:"9/16",hidden:!0,relatedItems:["Puffer Jacket, Back","Puffer Collection Teaser"]},{type:"image",src:"/assets/NABU_Puffer_Back.jpg",title:"Puffer Jacket, Back",year:2025,desc:"Back of the same puffer, showing how the bandana medallion is centered and mirrored across the shoulders and hem.",aspectRatio:"2/3",hidden:!0,relatedItems:["Puffer Jacket, Front","Puffer Collection Teaser"]},{type:"image",src:"/assets/Digital_Media_Cover.jpg",title:"Persian Rug Pants Relaunch",year:2024,desc:"Promotional campaign for the 2024 rerelease of NABU's Persian rug pants.",aspectRatio:"3/4"}]}],ve=["home","work","about","contact"],ke=`
  :root {
    --black: #060606;
    --white: #f5f2ed;
    --cream: #ede8e0;
...
`;function Se(){const t=l.useRef(null);return l.useEffect(()=>{const r=t.current;if(!r)return;const i=requestAnimationFrame(()=>r.classList.add("ss-cursor-ready"));let m=-1,h=-1;const a=d=>{r.style.left=d.clientX+"px",r.style.top=d.clientY+"px",m>=0&&(d.clientX!==m||d.clientY!==h)&&(r.style.opacity="1"),m=d.clientX,h=d.clientY},u=()=>{r.style.opacity="0"},g=d=>d.preventDefault();return window.addEventListener("mousemove",a),document.addEventListener("mouseleave",u),document.addEventListener("dragstart",g),()=>{cancelAnimationFrame(i),window.removeEventListener("mousemove",a),document.removeEventListener("mouseleave",u),document.removeEventListener("dragstart",g)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function H(){const t=l.useCallback(()=>document.body.classList.add("ss-hover"),[]),r=l.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:r}}const P=[.32,.72,0,1],I=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Ee({page:t,children:r}){const i=ce(),[m,h]=l.useState(t),[a,u]=l.useState(null),[g,d]=l.useState(!1),s=l.useRef(null);return l.useEffect(()=>{!a&&t!==m&&(d(!1),u(t))},[t,m,a]),l.useEffect(()=>{if(!a)return;let n=!1;const p=Array.from(s.current?.querySelectorAll("img")||[]);return Promise.all(p.filter(c=>c.loading!=="lazy").map(c=>c.decode().catch(()=>{}))).then(()=>{n||d(!0)}),()=>{n=!0}},[a]),e.jsx(e.Fragment,{children:[m,...a?[a]:[]].map(n=>{const p=n===a;return e.jsx(k.div,{"data-page":n,ref:p?s:void 0,"aria-hidden":a&&!p?!0:void 0,initial:{opacity:p?0:1},animate:{opacity:p&&!g?0:1},transition:{duration:i||!p?0:.38,ease:[.4,0,.2,1]},onAnimationComplete:c=>{p&&g&&typeof c=="object"&&"opacity"in c&&c.opacity===1&&(h(n),u(null))},style:{position:"absolute",inset:0,zIndex:p?2:1,isolation:"isolate",background:"#060606",pointerEvents:a?"none":"auto"},children:r(n)},n)})})}function je(){const[t,r]=l.useState("home"),[i,m]=l.useState("hero"),[h]=l.useState(he),a=l.useRef(!1),[u,g]=l.useState(null),[d,s]=l.useState(null),n=t==="about";l.useEffect(()=>{if(document.getElementById("ss-global"))return;const c=document.createElement("style");c.id="ss-global",c.innerHTML=ke,document.head.appendChild(c)},[]),l.useEffect(()=>{const c=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=c,document.body.style.backgroundColor=c},[t]);const p=l.useCallback((c,y="hero")=>{c!==t&&(a.current=!0,g(null),s(null),m(y),r(c))},[t]);return l.useEffect(()=>{const c=y=>{if(d){y.key==="Escape"&&s(null);return}if(u){y.key==="Escape"&&g(null);return}};return window.addEventListener("keydown",c),()=>window.removeEventListener("keydown",c)},[d,u]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(Se,{}),e.jsx("nav",{className:`ss-site-header${n?" ss-site-header-light":""}`,"aria-label":"Main navigation",children:e.jsx("ul",{children:ve.map(c=>e.jsx("li",{children:e.jsx(Te,{label:c.charAt(0).toUpperCase()+c.slice(1),active:t===c,onClick:()=>p(c),onLight:n})},c))})}),e.jsx(Ee,{page:t,children:c=>e.jsxs(e.Fragment,{children:[c==="home"&&e.jsx(Ce,{onNavigate:p,intro:!a.current,initialSection:i}),c==="work"&&e.jsx(Ve,{onCardClick:g}),c==="about"&&e.jsx(xe,{realmSupported:h.ok,onViewOverview:()=>p("home","open")}),c==="contact"&&e.jsx(Je,{})]})}),e.jsx(Q,{children:u&&e.jsx(Ye,{project:u,onClose:()=>g(null),onMediaClick:s})}),e.jsx(Q,{children:d&&e.jsx(Xe,{item:d,onClose:()=>s(null),onItemClick:s})})]})}function Te({label:t,active:r,onClick:i,onLight:m}){const h=H();return e.jsx("button",{onClick:i,"aria-current":r?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:r?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:m?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:r?1:.86,textShadow:m?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...h,children:t})}function he(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const r=t.__realmSupported();return{ok:!!r.ok,why:r.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const oe=["Shyon","Shiri"],Ae=P,Re={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Ne={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ae}}};function Ie({isMobile:t,intro:r}){return e.jsx(k.h1,{className:"ss-hero-name","aria-label":oe.join(" "),variants:Re,initial:r&&!I?"hidden":!1,animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:oe.map(i=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...i].map((m,h)=>e.jsx(k.span,{className:"ss-hero-ch",variants:Ne,children:m},i+h))},i))})}function Ce({onNavigate:t,intro:r,initialSection:i}){const[m,h]=l.useState(!1),[a,u]=l.useState(window.innerWidth<=640),[g]=l.useState(he),d=H(),s=l.useRef(null),[n,p]=l.useState(i==="open"),c=l.useRef(!1);l.useLayoutEffect(()=>{if(i!=="open")return;const v=s.current,x=v?.querySelector('[data-slide="open"]');!v||!x||(v.scrollTo({top:v.scrollTop+x.getBoundingClientRect().top-v.getBoundingClientRect().top,behavior:"instant"}),c.current=!0,x.focus({preventScroll:!0}))},[i]),l.useEffect(()=>{const v=()=>{u(window.innerWidth<=640)};return window.addEventListener("resize",v),()=>window.removeEventListener("resize",v)},[]);const y=l.useRef(null);l.useEffect(()=>()=>y.current?.(),[]);const S=v=>{y.current?.();const x=s.current;x&&v==="open"&&(x.dataset.locked="false",p(!0));const D=x?.querySelector(`[data-slide="${v}"]`);if(!x||!D)return;const b=x.scrollTop,j=Math.min(x.scrollHeight-x.clientHeight,b+D.getBoundingClientRect().top-x.getBoundingClientRect().top);if(I){x.scrollTo({top:j,behavior:"instant"});return}const R=j-b,_=Math.min(2600,1200+Math.abs(R)*.45)*.75,C=performance.now(),T=x.style.scrollSnapType,M=x.style.scrollBehavior;x.style.scrollSnapType="none",x.style.scrollBehavior="auto";let A=0;const N=()=>{cancelAnimationFrame(A),x.style.scrollSnapType=T,x.style.scrollBehavior=M,x.removeEventListener("wheel",N),x.removeEventListener("touchstart",N),x.removeEventListener("pointerdown",N),window.removeEventListener("keydown",N),y.current=null};y.current=N,x.addEventListener("wheel",N,{passive:!0}),x.addEventListener("touchstart",N,{passive:!0}),x.addEventListener("pointerdown",N,{passive:!0}),window.addEventListener("keydown",N);const B=o=>{const f=Math.min(1,(o-C)/_),w=(1-Math.cos(Math.PI*f))/2;x.scrollTop=b+R*w,f<1?A=requestAnimationFrame(B):N()};A=requestAnimationFrame(B)};return e.jsxs(k.div,{ref:s,className:"ss-home-page ss-home-scroll","data-locked":!n,onScroll:v=>{const x=v.currentTarget;n&&(x.scrollTop>4&&(c.current=!0),c.current&&x.scrollTop<=1&&(y.current?.(),c.current=!1,x.dataset.locked="true",p(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>h(!0),className:m?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:a?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ie,{isMobile:a,intro:r}),e.jsxs(k.div,{className:"ss-hero-summary",initial:I||!r?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:I||!r?0:.5,ease:P},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>S("open"),...d,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs($,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(k.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_mansion_portrait.jpg",alt:"My LEGO character facing the camera, with the mansion, upstairs balcony, and four cars behind him.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(K,{className:"ss-open-title",text:"My LEGO Portfolio",variant:me,stagger:.07}),e.jsx(K,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:ne,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx($,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(le,{pair:!0,kicker:"Navigation",body:"The coffee shop opens freelance projects, the cottage holds selected works, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it."})]})}),e.jsxs($,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(le,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(De,{})]})]}),e.jsxs($,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(k.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(k.dl,{className:"ss-figs",variants:pe,children:Le.map(v=>e.jsxs(k.div,{className:"ss-fig",variants:Oe,children:[e.jsxs("dd",{children:[v.n,e.jsx("i",{children:v.unit})]}),e.jsx("dt",{children:v.label})]},v.label))}),e.jsx(K,{className:"ss-open-line",text:g.ok?"Controls are displayed on entry.":"View My LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:ne,stagger:.018}),e.jsxs(k.div,{variants:ge,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[g.ok?e.jsxs("a",{href:"/lego.html",...d,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop Only"}),g.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:v=>{(v.key==="Enter"||v.key===" ")&&t("work")},...d,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:"Browse My Work"})]})]})]})]}),n&&e.jsx(Ue,{scrollRef:s})]},"home")}const F=P,_e={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},pe={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},me={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:F}}},ne={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:F}}},ge={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:F}}},Be={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:F}}},Me={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:F,staggerChildren:.13,delayChildren:.14}}},re={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:F}}};function K({text:t,variant:r,className:i,style:m}){const h=[];return t.split(`
`).forEach((a,u)=>{u>0&&h.push(e.jsx("br",{},"br"+u));const g=a.split(" ");g.forEach((d,s)=>h.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[d,s<g.length-1?" ":""]},u+"-"+s)))}),e.jsx(k.p,{className:i,style:m,variants:r,children:h})}const Pe={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:P}}},q=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh Editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and Texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure Assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render Preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function De(){const[t,r]=l.useState(0);return e.jsxs(k.div,{className:"ss-sheet",variants:pe,children:[e.jsx("div",{className:"ss-sheet-grid",children:q.map((i,m)=>e.jsxs(k.button,{className:`ss-cell${m===t?" on":""}`,variants:Me,onMouseEnter:()=>r(m),onFocus:()=>r(m),"aria-label":i.scene,children:[e.jsx(k.span,{className:"ss-cell-shot",variants:Pe,children:e.jsx("img",{src:i.src,alt:i.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:i.scene})]},i.src))}),e.jsxs(k.p,{className:"ss-sheet-cap",variants:Be,children:[e.jsx("b",{children:q[t].scene}),q[t].caption]})]})}const Le=[{n:"15.9",unit:"M",label:"Triangles per Frame"},{n:"689",unit:"",label:"Draw Calls"},{n:"35",unit:"",label:"Models Loaded"},{n:"7",unit:"min",label:"Full Day Cycle"}],Oe={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:P}}},X=[{id:"shop",name:"The Coffee Shop",cat:"Freelance Projects",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned freelance projects. Full-stack websites, brand and print work for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Works",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video, and campaign photography for the NABU streetwear brand."}],He={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:P}}},ze={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:P}}};function Fe(){const t=l.useRef(null),r=l.useRef(null),[i,m]=l.useState({left:0,top:0,w:0,h:0}),[h,a]=l.useState({w:0,h:0}),[u,g]=l.useState({l:0,r:0}),[d,s]=l.useState(0),[n,p]=l.useState(null),[c,y]=l.useState(!1);l.useEffect(()=>{const b=t.current;if(!b)return;const j=2400,R=1350,_=()=>{const T=b.getBoundingClientRect();if(!T.width||!T.height)return;const M=Math.min(T.width/j,T.height/R),A=j*M,N=R*M;m({left:(T.width-A)/2,top:(T.height-N)/2,w:A,h:N});const B=document.documentElement.clientWidth;let o=0,f=B;for(let w=b;w&&w!==document.documentElement;w=w.parentElement)if(getComputedStyle(w).overflowX!=="visible"){const z=w.getBoundingClientRect();o=Math.max(o,z.left),f=Math.min(f,z.right)}g({l:o+8-T.left,r:Math.min(f-8,B-64)-T.left}),a({w:T.width,h:T.height})};_();const C=new ResizeObserver(_);return C.observe(b),()=>C.disconnect()},[]),l.useLayoutEffect(()=>{if(!n)return;const b=r.current;b&&s(b.offsetHeight)},[n,h.w]);const S=X.find(b=>b.id===n)||null,v=S?x(S):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(k.div,{className:"ss-map-stage",ref:t,variants:ge,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:i.left,top:i.top,width:i.w,height:i.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),X.map(b=>e.jsxs(k.button,{variants:He,className:`ss-map-pin${b.flip?" flip":""}${n===b.id?" on":""}`+(n===b.id&&v?.covered?" hushed":""),style:{left:b.x+"%",top:b.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{c||p(b.id)},onMouseLeave:()=>{c||p(null)},onFocus:()=>p(b.id),onClick:()=>{const j=n===b.id&&c;y(!j),p(j?null:b.id)},"aria-label":b.name+", "+b.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:b.cat})]},b.id))]})]}),D()]});function x(b){if(!h.w||!i.w)return;const j=10,R=20,_=16,C=Math.min(h.w*.28,306),T=d||C*9/16+104,M=E=>({x:i.left+i.w*E.x/100,y:i.top+i.h*E.y/100}),A=M(b),N=X.filter(E=>E.id!==b.id).map(M),B=b.x<50,o=b.y<55,f=[[B,o],[B,!o],[!B,o],[!B,!o]];let w=null;for(const[E,z]of f){const L=Math.min(j,u.l),U=Math.max(h.w-j,u.r),W=Math.max(L,Math.min(E?A.x+R:A.x-R-C,U-C)),G=Math.max(j,Math.min(z?A.y+R:A.y-R-T,h.h-T-j));let V=10*N.filter(J=>J.x>W-_&&J.x<W+C+_&&J.y>G-_&&J.y<G+T+_).length;const Z=14+7.6*b.cat.length,ee=b.flip?A.x-10-Z:A.x+10,te=ee<W+C+4&&ee+Z>W-4&&A.y-11<G+T+4&&A.y+11>G-4;te&&V++;const se={left:W,top:G,hits:V,tag:te};if(!V){w=se;break}(!w||V<w.hits)&&(w=se)}return{style:{left:w.left,top:w.top,right:"auto",bottom:"auto"},covered:w.tag}}function D(){return e.jsx(Q,{children:S&&e.jsxs(k.div,{ref:r,className:"ss-map-card",style:v?.style,variants:ze,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:S.src,alt:S.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:S.name}),e.jsx("p",{children:S.line})]})]},S.id)})}}function $({id:t,label:r,className:i,stagger:m,children:h}){const a=m?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:_e;return e.jsx(k.section,{className:`ss-slide ss-snap${i?" "+i:""}`,"data-slide":t,"data-label":r,tabIndex:t==="open"?-1:void 0,variants:a,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:h})})}function We(t){const[r,i]=l.useState(I?1:0);return l.useEffect(()=>{if(I)return;const m=t.current;if(!m)return;const h=m.closest(".ss-home-scroll");let a=0;const u=()=>{a=0;const d=window.innerHeight||1,s=m.getBoundingClientRect(),n=(d-s.top)/Math.max(1,s.height*.75);i(n<0?0:n>1?1:n)},g=()=>{a||(a=requestAnimationFrame(u))};return(h||window).addEventListener("scroll",g,{passive:!0}),window.addEventListener("resize",g),u(),()=>{a&&cancelAnimationFrame(a),(h||window).removeEventListener("scroll",g),window.removeEventListener("resize",g)}},[t]),r}function Ge({text:t,p:r}){const i=t.split(" "),m=i.length;return e.jsx(e.Fragment,{children:i.map((h,a)=>{const u=a/m*.82,g=Math.min(1,Math.max(0,(r-u)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*g).toFixed(3)})`,transition:"color .12s linear"},children:[h,a<m-1?" ":""]},h+a)})})}function le({kicker:t,body:r,pair:i,children:m}){const h=e.jsx(K,{className:"ss-story-kicker",text:t,variant:me,stagger:.055}),a=l.useRef(null),u=We(a),g=e.jsx(Ge,{text:r,p:u});return i?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:h}),e.jsx("div",{className:"ss-chapter-body",ref:a,children:g})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[h,e.jsx("div",{className:"ss-chapter-body",ref:a,children:g}),m]})}function Ue({scrollRef:t}){const[r,i]=l.useState([]),[m,h]=l.useState(0),a=l.useRef([]);l.useEffect(()=>{const d=t.current;if(!d)return;const s=Array.from(d.querySelectorAll("[data-slide]"));a.current=s,i(s.map(p=>({id:p.dataset.slide||"",label:p.dataset.label||""})));const n=new IntersectionObserver(p=>{for(const c of p)if(c.isIntersecting){const y=a.current.indexOf(c.target);y>=0&&h(y)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return s.forEach(p=>n.observe(p)),()=>n.disconnect()},[t]);const u=d=>{const s=t.current,n=a.current[d];!s||!n||s.scrollTo({top:s.scrollTop+n.getBoundingClientRect().top-s.getBoundingClientRect().top,behavior:I?"auto":"smooth"})};if(r.length<2)return null;const g=m>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${g?" on":""}`,"aria-hidden":!g,children:r.map((d,s)=>e.jsx("button",{type:"button",className:`ss-deck-tick${s===m?" on":""}`,onClick:()=>u(s),"aria-label":d.label,"aria-current":s===m,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:d.label})},d.id))}),e.jsxs("div",{className:`ss-deck-count${g?" on":""}`,children:[e.jsx("b",{children:String(m+1).padStart(2,"0")})," / ",String(r.length).padStart(2,"0")]})]})}function de({index:t,orbit:r,radius:i,style:m,...h}){const a=ae(r,g=>{const d=(t-g)*2*Math.PI/O.length,s=Math.sin(d)*i/Math.sin(2*Math.PI/O.length),n=(Math.cos(d)-1)*220;return`translate3d(${s}px,0,${n}px) rotateY(${-Math.sin(d)*34}deg) scale(${.9+.1*Math.cos(d)})`}),u=ae(r,g=>Math.round((Math.cos((t-g)*2*Math.PI/O.length)+1)*100)+1);return e.jsx(k.div,{...h,draggable:!1,onDragStart:g=>g.preventDefault(),style:{...m,transform:a,zIndex:u,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const r=H(),[i,m]=l.useState({width:window.innerWidth,height:window.innerHeight}),h=i.width>=1024;l.useEffect(()=>{const o=()=>{m({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[]);const a=O.length,[u,g]=l.useState(0),d=(u%a+a)%a,s=fe(0),[n,p]=l.useState(!1),c=o=>{s.stop(),p(!0),be(s,o,{duration:I?0:.72,ease:[.42,0,.22,1],onComplete:()=>{g(o),p(!1)}})};l.useEffect(()=>()=>s.stop(),[s]);const y=o=>{c(o+Math.round((s.get()-o)/a)*a)},S=l.useRef(null),v=l.useRef(!1),x=l.useRef(null);l.useEffect(()=>{const o=x.current;if(!o)return;let f=0,w=!1,E=0;const z=L=>{if(L.ctrlKey||Math.abs(L.deltaX)<=Math.abs(L.deltaY))return;L.preventDefault();const U=performance.now();U-E>180&&(f=0,w=!1),E=U,f+=L.deltaX*(L.deltaMode===1?16:L.deltaMode===2?o.clientWidth:1),!w&&Math.abs(f)>=32&&(w=!0,c(Math.round(s.get())+Math.sign(f)))};return o.addEventListener("wheel",z,{passive:!1}),()=>o.removeEventListener("wheel",z)},[s]);const D=o=>c(Math.round(s.get())+o),b=i.width<=640,j=h?380:Math.min(i.width*(b?.64:.7),b?290:330),R=Math.min(j*1.32,Math.max(b?230:290,i.height*(b?.42:.5))),_=j*(h?1.4:b?1.08:1.24),C={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},T=O[d]?.id,M=T==="professional-services",A=M?"#14110b":"var(--white)",N=M?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",B=C[T]||C["creative-projects"];return e.jsx(k.div,{className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(k.div,{"aria-hidden":"true",animate:{backgroundColor:B.base},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(C).map(([o,f])=>e.jsx(k.div,{"aria-hidden":"true",animate:{opacity:o===T?1:0},transition:{duration:I?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:f.glow}},o)),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(k.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:A,textShadow:N,transition:"color 0.7s ease"},children:"Work"}),e.jsx("p",{id:"ss-work-hint",style:{marginTop:14,maxWidth:290,fontSize:14,lineHeight:1.5,color:A,opacity:.75,transition:"color .7s ease"},children:"Swipe or drag to browse. Select a project to view."})]}),e.jsx("div",{ref:x,className:"ss-work-carousel","aria-describedby":"ss-work-hint",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:b?`max(${230+R/2}px, 50%)`:"50%",height:R+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pan-y pinch-zoom",userSelect:"none"},onPointerDown:o=>{!o.isPrimary||o.button!==0||S.current||(S.current={id:o.pointerId,x:o.clientX,y:o.clientY,dragging:!1,orbitStart:s.get()},v.current=!1)},onPointerMove:o=>{const f=S.current;if(!f||f.id!==o.pointerId)return;const w=o.clientX-f.x,E=o.clientY-f.y;Math.hypot(w,E)>8&&(v.current=!0),!f.dragging&&Math.abs(w)>8&&Math.abs(w)>Math.abs(E)*1.15&&(f.dragging=!0,s.stop(),p(!0),f.orbitStart=s.get(),o.currentTarget.setPointerCapture(o.pointerId)),f.dragging&&s.set(f.orbitStart-Math.max(-.65,Math.min(.65,w*.65/j)))},onPointerUp:o=>{const f=S.current;if(!f||f.id!==o.pointerId)return;const w=o.clientX-f.x,E=o.clientY-f.y;f.dragging&&Math.abs(w)>=Math.max(22,j*.08)&&Math.abs(w)>Math.abs(E)*1.15?c(Math.round(f.orbitStart)+(w<0?1:-1)):f.dragging&&c(Math.round(s.get())),S.current=null,o.currentTarget.hasPointerCapture(o.pointerId)&&o.currentTarget.releasePointerCapture(o.pointerId)},onPointerCancel:()=>{S.current=null,v.current=!0,c(Math.round(s.get()))},onLostPointerCapture:o=>{S.current?.id===o.pointerId&&(S.current=null,v.current=!0,c(Math.round(s.get())))},onClickCapture:o=>{v.current&&o.detail!==0&&(o.preventDefault(),o.stopPropagation())},onKeyDown:o=>{if(o.key==="ArrowLeft"||o.key==="ArrowRight"){o.preventDefault();const f=(d+(o.key==="ArrowRight"?1:-1)+a)%a,w=o.currentTarget;y(f),requestAnimationFrame(()=>w.querySelectorAll('[role="button"]')[f]?.focus({preventScroll:!0}))}},children:O.map((o,f)=>{const w=(f-d+a)%a;return o.id==="nabu"?e.jsxs(de,{index:f,orbit:s,radius:_,className:"ss-project-card ss-project-card-nabu","data-active":w===0&&!n,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${o.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),w===0&&!n?t(o):y(f))},onClick:()=>{v.current||(w===0&&!n?t(o):y(f))},...r,style:{position:"absolute",width:j,height:R,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:o.img,alt:o.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(j,R*.78)*25.5/1080}px, ${-Math.min(j,R*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:A,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:o.title})})]},o.id):e.jsxs(de,{index:f,orbit:s,radius:_,role:"button",tabIndex:0,"aria-label":`${w===0?"Open":"Select"} ${o.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),w===0&&!n?t(o):y(f))},className:"ss-card ss-project-card","data-active":w===0&&!n,onClick:()=>{v.current||(w===0&&!n?t(o):y(f))},...r,style:{position:"absolute",width:j,height:R,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:o.img,alt:o.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:o.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:b?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:o.title})})})]},o.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:b?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>D(-1),style:{color:A,width:44,height:44},children:"←"}),O.map((o,f)=>e.jsx("button",{type:"button","aria-label":`Show ${o.title}`,"aria-pressed":f===d,onClick:()=>y(f),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:f===d?26:8,height:8,borderRadius:980,background:f===d?"#38bdf8":M?"#777":"#aaa",transition:"width .3s ease"}})},o.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>D(1),style:{color:A,width:44,height:44},children:"→"})]})]})},"work")}function Je(){const t=H(),r=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Résumé",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(k.div,{className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(k.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in Touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(k.p,{initial:!1,animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance work, collaborations, and full-time roles."})]}),e.jsx(k.div,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:r.map(i=>e.jsxs("a",{className:"ss-contact-entry",href:i.href,target:i.target,rel:i.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:i.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:i.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},i.label))})]})]},"contact")}function Ye({project:t,onClose:r,onMediaClick:i}){const m=H(),h=l.useRef(null);l.useEffect(()=>{const d=document.activeElement,s=h.current;s?.querySelector("button")?.focus({preventScroll:!0});const n=p=>{if(p.key!=="Tab"||!s)return;const c=Array.from(s.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(v=>v.getClientRects().length>0),y=c[0],S=c[c.length-1];p.shiftKey&&document.activeElement===y?(p.preventDefault(),S?.focus()):!p.shiftKey&&document.activeElement===S&&(p.preventDefault(),y?.focus())};return s?.addEventListener("keydown",n),()=>{s?.removeEventListener("keydown",n),d?.isConnected&&d.focus({preventScroll:!0})}},[]);const[a,u]=l.useState(window.innerWidth),g=a>=1024;return l.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),l.useEffect(()=>{const d=()=>{u(window.innerWidth)};return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]),e.jsx(k.div,{ref:h,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.4},onClick:r,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(k.div,{initial:{opacity:0,scale:I?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:I?1:.96},transition:{duration:I?.001:.4,ease:P},onClick:d=>d.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:r,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...m,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const d=t.media.filter(p=>!p.hidden),s=a<=640?2:a<=1023?3:4,n=Array.from({length:s},()=>[]);return d.forEach((p,c)=>n[c%s].push(p)),n.map((p,c)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:p.map((y,S)=>e.jsx($e,{item:y,onClick:()=>i(y)},S))},c))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(d=>!d.hidden).map((d,s)=>e.jsx(Ke,{item:d,onClick:()=>i(d)},s))}),!g&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse."})]})})}function $e({item:t,onClick:r}){const i=H(),m=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:r,...i,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:m},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Ke({item:t,onClick:r}){const i=H();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:r,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...i,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({pages:t,title:r,labels:i,comparisonCredit:m}){const h=l.useRef(null),[a,u]=l.useState(0),g=l.useRef(0),d=ce(),s=n=>{const p=h.current;p&&p.scrollTo({left:Math.max(0,Math.min(t.length-1,n))*p.clientWidth,behavior:d?"instant":"smooth"})};return l.useEffect(()=>{const n=h.current;if(!n)return;const p=new ResizeObserver(()=>n.scrollTo({left:g.current*n.clientWidth,behavior:"instant"}));return p.observe(n),()=>p.disconnect()},[]),e.jsxs("div",{className:"ss-booklet-reader",children:[e.jsx("div",{ref:h,className:"ss-booklet-track",tabIndex:0,role:"region","aria-label":`${r}, scroll through ${i?"pieces":"pages"}`,onScroll:n=>{g.current=Math.round(n.currentTarget.scrollLeft/n.currentTarget.clientWidth),u(g.current)},onKeyDown:n=>{(n.key==="ArrowRight"||n.key==="ArrowLeft")&&(n.preventDefault(),s(a+(n.key==="ArrowRight"?1:-1)))},children:t.map((n,p)=>e.jsx("figure",{className:"ss-booklet-page",children:m&&p===1?e.jsxs("div",{className:"ss-art-comparison",children:[e.jsx("div",{className:"ss-art-comparison-pair",children:[{src:n,label:"Original Cover"},{src:t[0],label:"LEGO Homage"}].map(c=>e.jsxs("div",{className:"ss-art-comparison-item",children:[e.jsx("div",{className:"ss-art-comparison-image",children:e.jsx("img",{src:c.src,alt:`${r}, ${c.label}`,loading:"lazy"})}),e.jsx("p",{children:c.label})]},c.label))}),e.jsx("p",{className:"ss-art-comparison-credit",children:m})]}):e.jsx("img",{src:n,alt:i?.[p]?`${r}, ${i[p]}`:`${r}, page ${p+1} of ${t.length}`,loading:p?"lazy":"eager"})},n))}),e.jsxs("div",{className:"ss-booklet-controls",children:[e.jsx("button",{onClick:()=>s(a-1),disabled:a===0,"aria-label":i?"Previous piece":"Previous booklet page",children:"←"}),e.jsx("span",{"aria-live":"polite",children:i?`${i[a]} · ${a+1} of ${t.length}`:`Page ${a+1} of ${t.length}`}),e.jsx("button",{onClick:()=>s(a+1),disabled:a===t.length-1,"aria-label":i?"Next piece":"Next booklet page",children:"→"})]})]})}function Xe({item:t,onClose:r,onItemClick:i}){const m=H(),h=l.useRef(null);l.useEffect(()=>{const n=document.activeElement,p=h.current;p?.querySelector("button")?.focus({preventScroll:!0});const c=y=>{if(y.key!=="Tab"||!p)return;const S=Array.from(p.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(D=>D.getClientRects().length>0),v=S[0],x=S[S.length-1];y.shiftKey&&document.activeElement===v?(y.preventDefault(),x?.focus()):!y.shiftKey&&document.activeElement===x&&(y.preventDefault(),v?.focus())};return p?.addEventListener("keydown",c),()=>{p?.removeEventListener("keydown",c),n?.isConnected&&n.focus({preventScroll:!0})}},[]);const[a,u]=l.useState({src:t.src,index:0});l.useEffect(()=>{u({src:t.src,index:0})},[t.src]);const g=a.src===t.src?a.index:0,d=t.builds?.[g],s=d?{...t,...d}:t;return e.jsxs(k.div,{ref:h,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:I?.001:.25},onClick:r,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("button",{onClick:r,className:"ss-media-viewer-close","aria-label":"Close asset viewer",...m,children:e.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{d:"m6 6 12 12M18 6 6 18",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}),e.jsxs("div",{onClick:n=>n.stopPropagation(),className:"ss-media-viewer",children:[e.jsxs("div",{className:"ss-viewer-media",children:[e.jsx("div",{className:`ss-viewer-canvas${s.pages?" ss-booklet-media":""}`,style:{"--asset-ratio":s.aspectRatio||"4/3"},children:s.pages?e.jsx(qe,{pages:s.pages,title:s.title,labels:s.pageLabels,comparisonCredit:s.comparisonCredit},s.src):s.type==="video"?e.jsx("video",{src:s.src,poster:s.poster,onLoadedMetadata:n=>{n.currentTarget.defaultPlaybackRate=s.playbackRate??1,n.currentTarget.playbackRate=s.playbackRate??1},controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},s.src):e.jsx("img",{src:s.src,alt:s.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:s.scale?`scale(${s.scale})`:"scale(1)"}},s.src)}),t.builds&&e.jsxs("div",{className:"ss-booklet-controls",role:"group","aria-label":`${t.title} build comparison`,children:[e.jsx("button",{"aria-label":"Show original build",disabled:g===0,onClick:()=>u({src:t.src,index:g-1}),...m,children:"←"}),e.jsxs("span",{"aria-live":"polite",children:[d?.label," · ",g+1," of ",t.builds.length]}),e.jsx("button",{"aria-label":"Show redesigned build",disabled:g===t.builds.length-1,onClick:()=>u({src:t.src,index:g+1}),...m,children:"→"})]})]}),e.jsxs("div",{className:"ss-viewer-info",children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((n,p)=>e.jsxs("button",{onClick:()=>{const c=O.flatMap(y=>y.media).find(y=>y.title===n);c&&i&&i(c)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...m,children:["View ",n," →"]},p))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...m,children:"Visit Website →"})]})]})]})}ye.createRoot(document.getElementById("root")).render(e.jsx(l.StrictMode,{children:e.jsx(je,{})}));
