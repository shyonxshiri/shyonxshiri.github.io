...
`;function ke(){const t=d.useRef(null);return d.useEffect(()=>{const n=t.current;if(!n)return;const o=requestAnimationFrame(()=>n.classList.add("ss-cursor-ready"));let c=-1,r=-1;const a=l=>{n.style.left=l.clientX+"px",n.style.top=l.clientY+"px",c>=0&&(l.clientX!==c||l.clientY!==r)&&(n.style.opacity="1"),c=l.clientX,r=l.clientY},h=()=>{n.style.opacity="0"},m=l=>l.preventDefault();return window.addEventListener("mousemove",a),document.addEventListener("mouseleave",h),document.addEventListener("dragstart",m),()=>{cancelAnimationFrame(o),window.removeEventListener("mousemove",a),document.removeEventListener("mouseleave",h),document.removeEventListener("dragstart",m)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function O(){const t=d.useCallback(()=>document.body.classList.add("ss-hover"),[]),n=d.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:n}}const D=[.32,.72,0,1],N=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Ee({page:t,children:n}){const o=ge(),[c,r]=d.useState(t),[a,h]=d.useState(null),[m,l]=d.useState(!1),s=d.useRef(null);return d.useEffect(()=>{!a&&t!==c&&(l(!1),h(t))},[t,c,a]),d.useEffect(()=>{if(!a)return;let p=!1;const u=Array.from(s.current?.querySelectorAll("img")||[]);return Promise.all(u.filter(y=>y.loading!=="lazy").map(y=>y.decode().catch(()=>{}))).then(()=>{p||l(!0)}),()=>{p=!0}},[a]),e.jsx(e.Fragment,{children:[c,...a?[a]:[]].map(p=>{const u=p===a;return e.jsx(x.div,{"data-page":p,ref:u?s:void 0,"aria-hidden":a&&!u?!0:void 0,initial:{opacity:u?0:1},animate:{opacity:u&&!m?0:1},transition:{duration:o||!u?0:.38,ease:[.4,0,.2,1]},onAnimationComplete:y=>{u&&m&&typeof y=="object"&&"opacity"in y&&y.opacity===1&&(r(p),h(null))},style:{position:"absolute",inset:0,zIndex:u?2:1,isolation:"isolate",background:"#060606",pointerEvents:a?"none":"auto"},children:n(p)},p)})})}function Se(){const[t,n]=d.useState("home"),o=d.useRef(!1),[c,r]=d.useState(null),[a,h]=d.useState(null),m=t==="about";d.useEffect(()=>{if(document.getElementById("ss-global"))return;const s=document.createElement("style");s.id="ss-global",s.innerHTML=ve,document.head.appendChild(s)},[]),d.useEffect(()=>{const s=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=s,document.body.style.backgroundColor=s},[t]);const l=d.useCallback(s=>{s!==t&&(o.current=!0,r(null),h(null),n(s))},[t]);return d.useEffect(()=>{const s=p=>{if(a){p.key==="Escape"&&h(null);return}if(c){p.key==="Escape"&&r(null);return}};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[a,c]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(ke,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:xe.map(s=>e.jsx("li",{children:e.jsx(Te,{label:s.charAt(0).toUpperCase()+s.slice(1),active:t===s,onClick:()=>l(s),onLight:m})},s))})]}),e.jsx(Ee,{page:t,children:s=>e.jsxs(e.Fragment,{children:[s==="home"&&e.jsx(Ce,{onNavigate:l,intro:!o.current}),s==="work"&&e.jsx(Ve,{onCardClick:r}),s==="about"&&e.jsx(be,{}),s==="contact"&&e.jsx(Ye,{})]})}),e.jsx(X,{children:c&&e.jsx(Je,{project:c,onClose:()=>r(null),onMediaClick:h})}),e.jsx(X,{children:a&&e.jsx(Xe,{item:a,onClose:()=>h(null),onItemClick:h})})]})}function Te({label:t,active:n,onClick:o,onLight:c}){const r=O();return e.jsx("button",{onClick:o,"aria-current":n?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:n?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:c?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:n?1:.86,textShadow:c?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...r,children:t})}function je(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const n=t.__realmSupported();return{ok:!!n.ok,why:n.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const ae=["Shyon","Shiri"],Ne=D,Ae={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Re={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ne}}};function Ie({isMobile:t,intro:n}){return e.jsx(x.h1,{className:"ss-hero-name","aria-label":ae.join(" "),variants:Ae,initial:n&&!N?"hidden":!1,animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:ae.map(o=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...o].map((c,r)=>e.jsx(x.span,{className:"ss-hero-ch",variants:Re,children:c},o+r))},o))})}function Ce({onNavigate:t,intro:n}){const[o,c]=d.useState(!1),[r,a]=d.useState(window.innerWidth<=640),[h]=d.useState(je),m=O(),l=d.useRef(null),[s,p]=d.useState(!1),u=d.useRef(!1);d.useEffect(()=>{const b=()=>{a(window.innerWidth<=640)};return window.addEventListener("resize",b),()=>window.removeEventListener("resize",b)},[]);const y=d.useRef(null);d.useEffect(()=>()=>y.current?.(),[]);const S=b=>{y.current?.();const w=l.current;w&&b==="open"&&(w.dataset.locked="false",p(!0));const M=w?.querySelector(`[data-slide="${b}"]`);if(!w||!M)return;const A=w.scrollTop,f=Math.min(w.scrollHeight-w.clientHeight,A+M.getBoundingClientRect().top-w.getBoundingClientRect().top);if(N){w.scrollTo({top:f,behavior:"instant"});return}const j=f-A,B=Math.min(2600,1200+Math.abs(j)*.45)*.75,C=performance.now(),R=w.style.scrollSnapType,T=w.style.scrollBehavior;w.style.scrollSnapType="none",w.style.scrollBehavior="auto";let I=0;const E=()=>{cancelAnimationFrame(I),w.style.scrollSnapType=R,w.style.scrollBehavior=T,w.removeEventListener("wheel",E),w.removeEventListener("touchstart",E),w.removeEventListener("pointerdown",E),window.removeEventListener("keydown",E),y.current=null};y.current=E,w.addEventListener("wheel",E,{passive:!0}),w.addEventListener("touchstart",E,{passive:!0}),w.addEventListener("pointerdown",E,{passive:!0}),window.addEventListener("keydown",E);const P=i=>{const g=Math.min(1,(i-C)/B),v=(1-Math.cos(Math.PI*g))/2;w.scrollTop=A+j*v,g<1?I=requestAnimationFrame(P):E()};I=requestAnimationFrame(P)};return e.jsxs(x.div,{ref:l,className:"ss-home-page ss-home-scroll","data-locked":!s,onScroll:b=>{const w=b.currentTarget;s&&(w.scrollTop>4&&(u.current=!0),u.current&&w.scrollTop<=1&&(y.current?.(),u.current=!1,w.dataset.locked="true",p(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>c(!0),className:o?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:r?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ie,{isMobile:r,intro:n}),e.jsxs(x.div,{className:"ss-hero-summary",initial:N||!n?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:N||!n?0:.5,ease:D},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>S("open"),...m,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(Y,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(x.img,{className:"ss-open-img",variants:oe,src:"/assets/story/story_mansion_portrait.jpg",alt:"My LEGO character facing the camera, with the mansion, upstairs balcony, and four cars behind him.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(J,{className:"ss-open-title",text:"My LEGO Portfolio",variant:de,stagger:.07}),e.jsx(J,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:ie,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(Y,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(ne,{pair:!0,kicker:"Navigation",body:"The coffee shop opens client work, the cottage holds selected projects, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it"})]})}),e.jsxs(Y,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(ne,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(Oe,{})]})]}),e.jsxs(Y,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(x.img,{className:"ss-open-img",variants:oe,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(x.dl,{className:"ss-figs",variants:le,children:Me.map(b=>e.jsxs(x.div,{className:"ss-fig",variants:Le,children:[e.jsxs("dd",{children:[b.n,e.jsx("i",{children:b.unit})]}),e.jsx("dt",{children:b.label})]},b.label))}),e.jsx(J,{className:"ss-open-line",text:h.ok?"Controls are displayed on entry.":"View my LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:ie,stagger:.018}),e.jsxs(x.div,{variants:ce,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[h.ok?e.jsxs("a",{href:"/lego.html",...m,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),h.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:b=>{(b.key==="Enter"||b.key===" ")&&t("work")},...m,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:h.ok?"or browse the work":"Browse the work"})]})]})]})]}),s&&e.jsx(Ue,{scrollRef:l})]},"home")}const _=D,Be={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},le={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},de={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:_}}},ie={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:_}}},ce={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:_}}},De={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:_}}},Pe={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:_,staggerChildren:.13,delayChildren:.14}}},oe={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:_}}};function J({text:t,variant:n,className:o,style:c}){const r=[];return t.split(`
`).forEach((a,h)=>{h>0&&r.push(e.jsx("br",{},"br"+h));const m=a.split(" ");m.forEach((l,s)=>r.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[l,s<m.length-1?" ":""]},h+"-"+s)))}),e.jsx(x.p,{className:o,style:c,variants:n,children:r})}const He={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:D}}},K=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function Oe(){const[t,n]=d.useState(0);return e.jsxs(x.div,{className:"ss-sheet",variants:le,children:[e.jsx("div",{className:"ss-sheet-grid",children:K.map((o,c)=>e.jsxs(x.button,{className:`ss-cell${c===t?" on":""}`,variants:Pe,onMouseEnter:()=>n(c),onFocus:()=>n(c),"aria-label":o.scene,children:[e.jsx(x.span,{className:"ss-cell-shot",variants:He,children:e.jsx("img",{src:o.src,alt:o.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:o.scene})]},o.src))}),e.jsxs(x.p,{className:"ss-sheet-cap",variants:De,children:[e.jsx("b",{children:K[t].scene}),K[t].caption]})]})}const Me=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],Le={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:D}}},q=[{id:"shop",name:"The Coffee Shop",cat:"Client Work",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU streetwear brand."}],_e={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:D}}},ze={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:D}}};function Fe(){const t=d.useRef(null),n=d.useRef(null),[o,c]=d.useState({left:0,top:0,w:0,h:0}),[r,a]=d.useState({w:0,h:0}),[h,m]=d.useState({l:0,r:0}),[l,s]=d.useState(0),[p,u]=d.useState(null),[y,S]=d.useState(!1);d.useEffect(()=>{const f=t.current;if(!f)return;const j=2400,B=1350,C=()=>{const T=f.getBoundingClientRect();if(!T.width||!T.height)return;const I=Math.min(T.width/j,T.height/B),E=j*I,P=B*I;c({left:(T.width-E)/2,top:(T.height-P)/2,w:E,h:P});const i=document.documentElement.clientWidth;let g=0,v=i;for(let k=f;k&&k!==document.documentElement;k=k.parentElement)if(getComputedStyle(k).overflowX!=="visible"){const W=k.getBoundingClientRect();g=Math.max(g,W.left),v=Math.min(v,W.right)}m({l:g+8-T.left,r:Math.min(v-8,i-64)-T.left}),a({w:T.width,h:T.height})};C();const R=new ResizeObserver(C);return R.observe(f),()=>R.disconnect()},[]),d.useLayoutEffect(()=>{if(!p)return;const f=n.current;f&&s(f.offsetHeight)},[p,r.w]);const b=q.find(f=>f.id===p)||null,w=b?M(b):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(x.div,{className:"ss-map-stage",ref:t,variants:ce,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:o.left,top:o.top,width:o.w,height:o.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),q.map(f=>e.jsxs(x.button,{variants:_e,className:`ss-map-pin${f.flip?" flip":""}${p===f.id?" on":""}`+(p===f.id&&w?.covered?" hushed":""),style:{left:f.x+"%",top:f.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{y||u(f.id)},onMouseLeave:()=>{y||u(null)},onFocus:()=>u(f.id),onClick:()=>{const j=p===f.id&&y;S(!j),u(j?null:f.id)},"aria-label":f.name+", "+f.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:f.cat})]},f.id))]})]}),A()]});function M(f){if(!r.w||!o.w)return;const j=10,B=20,C=16,R=Math.min(r.w*.28,306),T=l||R*9/16+104,I=L=>({x:o.left+o.w*L.x/100,y:o.top+o.h*L.y/100}),E=I(f),P=q.filter(L=>L.id!==f.id).map(I),i=f.x<50,g=f.y<55,v=[[i,g],[i,!g],[!i,g],[!i,!g]];let k=null;for(const[L,W]of v){const he=Math.min(j,h.l),pe=Math.max(r.w-j,h.r),z=Math.max(he,Math.min(L?E.x+B:E.x-B-R,pe-R)),F=Math.max(j,Math.min(W?E.y+B:E.y-B-T,r.h-T-j));let G=10*P.filter(U=>U.x>z-C&&U.x<z+R+C&&U.y>F-C&&U.y<F+T+C).length;const $=14+7.6*f.cat.length,Z=f.flip?E.x-10-$:E.x+10,Q=Z<z+R+4&&Z+$>z-4&&E.y-11<F+T+4&&E.y+11>F-4;Q&&G++;const ee={left:z,top:F,hits:G,tag:Q};if(!G){k=ee;break}(!k||G<k.hits)&&(k=ee)}return{style:{left:k.left,top:k.top,right:"auto",bottom:"auto"},covered:k.tag}}function A(){return e.jsx(X,{children:b&&e.jsxs(x.div,{ref:n,className:"ss-map-card",style:w?.style,variants:ze,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:b.src,alt:b.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:b.name}),e.jsx("p",{children:b.line})]})]},b.id)})}}function Y({id:t,label:n,className:o,stagger:c,children:r}){const a=c?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Be;return e.jsx(x.section,{className:`ss-slide ss-snap${o?" "+o:""}`,"data-slide":t,"data-label":n,variants:a,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:r})})}function We(t){const[n,o]=d.useState(N?1:0);return d.useEffect(()=>{if(N)return;const c=t.current;if(!c)return;const r=c.closest(".ss-home-scroll");let a=0;const h=()=>{a=0;const l=window.innerHeight||1,s=c.getBoundingClientRect(),p=(l-s.top)/Math.max(1,s.height*.75);o(p<0?0:p>1?1:p)},m=()=>{a||(a=requestAnimationFrame(h))};return(r||window).addEventListener("scroll",m,{passive:!0}),window.addEventListener("resize",m),h(),()=>{a&&cancelAnimationFrame(a),(r||window).removeEventListener("scroll",m),window.removeEventListener("resize",m)}},[t]),n}function Ge({text:t,p:n}){const o=t.split(" "),c=o.length;return e.jsx(e.Fragment,{children:o.map((r,a)=>{const h=a/c*.82,m=Math.min(1,Math.max(0,(n-h)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*m).toFixed(3)})`,transition:"color .12s linear"},children:[r,a<c-1?" ":""]},r+a)})})}function ne({kicker:t,body:n,pair:o,children:c}){const r=e.jsx(J,{className:"ss-story-kicker",text:t,variant:de,stagger:.055}),a=d.useRef(null),h=We(a),m=e.jsx(Ge,{text:n,p:h});return o?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:r}),e.jsx("div",{className:"ss-chapter-body",ref:a,children:m})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[r,e.jsx("div",{className:"ss-chapter-body",ref:a,children:m}),c]})}function Ue({scrollRef:t}){const[n,o]=d.useState([]),[c,r]=d.useState(0),a=d.useRef([]);d.useEffect(()=>{const l=t.current;if(!l)return;const s=Array.from(l.querySelectorAll("[data-slide]"));a.current=s,o(s.map(u=>({id:u.dataset.slide||"",label:u.dataset.label||""})));const p=new IntersectionObserver(u=>{for(const y of u)if(y.isIntersecting){const S=a.current.indexOf(y.target);S>=0&&r(S)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return s.forEach(u=>p.observe(u)),()=>p.disconnect()},[t]);const h=l=>{const s=t.current,p=a.current[l];!s||!p||s.scrollTo({top:s.scrollTop+p.getBoundingClientRect().top-s.getBoundingClientRect().top,behavior:N?"auto":"smooth"})};if(n.length<2)return null;const m=c>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${m?" on":""}`,"aria-hidden":!m,children:n.map((l,s)=>e.jsx("button",{type:"button",className:`ss-deck-tick${s===c?" on":""}`,onClick:()=>h(s),"aria-label":l.label,"aria-current":s===c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:l.label})},l.id))}),e.jsxs("div",{className:`ss-deck-count${m?" on":""}`,children:[e.jsx("b",{children:String(c+1).padStart(2,"0")})," / ",String(n.length).padStart(2,"0")]})]})}function re({index:t,orbit:n,radius:o,style:c,...r}){const a=te(n,m=>{const l=(t-m)*2*Math.PI/H.length,s=Math.sin(l)*o/Math.sin(2*Math.PI/H.length),p=(Math.cos(l)-1)*220;return`translate3d(${s}px,0,${p}px) rotateY(${-Math.sin(l)*34}deg) scale(${.9+.1*Math.cos(l)})`}),h=te(n,m=>Math.round((Math.cos((t-m)*2*Math.PI/H.length)+1)*100)+1);return e.jsx(x.div,{...r,draggable:!1,onDragStart:m=>m.preventDefault(),style:{...c,transform:a,zIndex:h,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const n=O(),[o,c]=d.useState({width:window.innerWidth,height:window.innerHeight}),r=o.width>=1024;d.useEffect(()=>{const i=()=>{c({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]);const a=H.length,[h,m]=d.useState(0),l=(h%a+a)%a,s=ue(0),[p,u]=d.useState(!1),y=i=>{s.stop(),u(!0),fe(s,i,{duration:N?0:.72,ease:[.42,0,.22,1],onComplete:()=>{m(i),u(!1)}})};d.useEffect(()=>()=>s.stop(),[s]);const S=i=>{y(i+Math.round((s.get()-i)/a)*a)},b=d.useRef(null),w=d.useRef(!1),M=i=>y(Math.round(s.get())+i),A=o.width<=640,f=r?380:Math.min(o.width*(A?.64:.7),A?290:330),j=Math.min(f*1.32,Math.max(A?230:290,o.height*(A?.42:.5))),B=f*(r?1.4:A?1.08:1.24),C={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},R=H[l]?.id,T=R==="professional-services",I=T?"#14110b":"var(--white)",E=T?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",P=C[R]||C["creative-projects"];return e.jsx(x.div,{className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:A?"max(580px, 100dvh)":"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(x.div,{"aria-hidden":"true",animate:{backgroundColor:P.base},transition:{duration:N?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(C).map(([i,g])=>e.jsx(x.div,{"aria-hidden":"true",animate:{opacity:i===R?1:0},transition:{duration:N?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:g.glow}},i)),e.jsx("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:e.jsx(x.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:D},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:I,textShadow:E,transition:"color 0.7s ease"},children:"Work"})}),e.jsx("div",{className:"ss-work-carousel",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:"50%",height:j+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pinch-zoom",userSelect:"none"},onPointerDown:i=>{!i.isPrimary||i.button!==0||(b.current={id:i.pointerId,x:i.clientX,y:i.clientY,dragging:!1,orbitStart:s.get()},w.current=!1)},onPointerMove:i=>{const g=b.current;if(!g||g.id!==i.pointerId)return;const v=i.clientX-g.x,k=i.clientY-g.y;Math.hypot(v,k)>8&&(w.current=!0),!g.dragging&&Math.abs(v)>10&&Math.abs(v)>Math.abs(k)*1.25&&(g.dragging=!0,s.stop(),u(!0),g.orbitStart=s.get(),i.currentTarget.setPointerCapture(i.pointerId)),g.dragging&&s.set(g.orbitStart-Math.max(-.65,Math.min(.65,v*.65/f)))},onPointerUp:i=>{const g=b.current;if(!g||g.id!==i.pointerId)return;const v=i.clientX-g.x,k=i.clientY-g.y;g.dragging&&Math.abs(v)>=Math.max(28,f*.12)&&Math.abs(v)>Math.abs(k)*1.25?y(Math.round(g.orbitStart)+(v<0?1:-1)):g.dragging&&y(Math.round(s.get())),b.current=null,i.currentTarget.hasPointerCapture(i.pointerId)&&i.currentTarget.releasePointerCapture(i.pointerId)},onPointerCancel:()=>{b.current=null,w.current=!0,y(Math.round(s.get()))},onLostPointerCapture:i=>{b.current?.id===i.pointerId&&(b.current=null,w.current=!0,y(Math.round(s.get())))},onClickCapture:i=>{w.current&&i.detail!==0&&(i.preventDefault(),i.stopPropagation())},onKeyDown:i=>{if(i.key==="ArrowLeft"||i.key==="ArrowRight"){i.preventDefault();const g=(l+(i.key==="ArrowRight"?1:-1)+a)%a,v=i.currentTarget;S(g),requestAnimationFrame(()=>v.querySelectorAll('[role="button"]')[g]?.focus({preventScroll:!0}))}},children:H.map((i,g)=>{const v=(g-l+a)%a;return i.id==="nabu"?e.jsxs(re,{index:g,orbit:s,radius:B,className:"ss-project-card ss-project-card-nabu","data-active":v===0&&!p,role:"button",tabIndex:0,"aria-label":`${v===0?"Open":"Select"} ${i.title}`,onKeyDown:k=>{(k.key==="Enter"||k.key===" ")&&(k.preventDefault(),v===0&&!p?t(i):S(g))},onClick:()=>{w.current||(v===0&&!p?t(i):S(g))},...n,style:{position:"absolute",width:f,height:j,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(f,j*.78)*25.5/1080}px, ${-Math.min(f,j*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:I,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:i.title})})]},i.id):e.jsxs(re,{index:g,orbit:s,radius:B,role:"button",tabIndex:0,"aria-label":`${v===0?"Open":"Select"} ${i.title}`,onKeyDown:k=>{(k.key==="Enter"||k.key===" ")&&(k.preventDefault(),v===0&&!p?t(i):S(g))},className:"ss-card ss-project-card","data-active":v===0&&!p,onClick:()=>{w.current||(v===0&&!p?t(i):S(g))},...n,style:{position:"absolute",width:f,height:j,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:i.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:A?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:i.title})})})]},i.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:A?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>M(-1),style:{color:I,width:44,height:44},children:"←"}),H.map((i,g)=>e.jsx("button",{type:"button","aria-label":`Show ${i.title}`,"aria-pressed":g===l,onClick:()=>S(g),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:g===l?26:8,height:8,borderRadius:980,background:g===l?"#38bdf8":T?"#777":"#aaa",transition:"width .3s ease"}})},i.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>M(1),style:{color:I,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=O(),n=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(x.div,{className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(x.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:D},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(x.p,{initial:!1,animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(x.div,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:D},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:n.map(o=>e.jsxs("a",{className:"ss-contact-entry",href:o.href,target:o.target,rel:o.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:o.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:o.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},o.label))})]})]},"contact")}function Je({project:t,onClose:n,onMediaClick:o}){const c=O(),r=d.useRef(null);d.useEffect(()=>{const l=document.activeElement,s=r.current;s?.querySelector("button")?.focus({preventScroll:!0});const p=u=>{if(u.key!=="Tab"||!s)return;const y=Array.from(s.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(w=>w.getClientRects().length>0),S=y[0],b=y[y.length-1];u.shiftKey&&document.activeElement===S?(u.preventDefault(),b?.focus()):!u.shiftKey&&document.activeElement===b&&(u.preventDefault(),S?.focus())};return s?.addEventListener("keydown",p),()=>{s?.removeEventListener("keydown",p),l?.isConnected&&l.focus({preventScroll:!0})}},[]);const[a,h]=d.useState(window.innerWidth),m=a>=1024;return d.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),d.useEffect(()=>{const l=()=>{h(window.innerWidth)};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),e.jsx(x.div,{ref:r,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:N?.001:.4},onClick:n,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(x.div,{initial:{opacity:0,scale:N?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:N?1:.96},transition:{duration:N?.001:.4,ease:D},onClick:l=>l.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:n,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const l=t.media.filter(u=>!u.hidden),s=a<=640?2:a<=1023?3:4,p=Array.from({length:s},()=>[]);return l.forEach((u,y)=>p[y%s].push(u)),p.map((u,y)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:u.map((S,b)=>e.jsx(Ke,{item:S,onClick:()=>o(S)},b))},y))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(l=>!l.hidden).map((l,s)=>e.jsx(qe,{item:l,onClick:()=>o(l)},s))}),!m&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse"})]})})}function Ke({item:t,onClick:n}){const o=O(),c=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:n,...o,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:c},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function qe({item:t,onClick:n}){const o=O();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:n,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...o,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Xe({item:t,onClose:n,onItemClick:o}){const c=O(),r=d.useRef(null);d.useEffect(()=>{const h=document.activeElement,m=r.current;m?.querySelector("button")?.focus({preventScroll:!0});const l=s=>{if(s.key!=="Tab"||!m)return;const p=Array.from(m.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(S=>S.getClientRects().length>0),u=p[0],y=p[p.length-1];s.shiftKey&&document.activeElement===u?(s.preventDefault(),y?.focus()):!s.shiftKey&&document.activeElement===y&&(s.preventDefault(),u?.focus())};return m?.addEventListener("keydown",l),()=>{m?.removeEventListener("keydown",l),h?.isConnected&&h.focus({preventScroll:!0})}},[]);const a=t;return e.jsx(x.div,{ref:r,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:N?.001:.25},onClick:n,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(x.div,{initial:{opacity:0,scale:N?1:.985},animate:{opacity:1,scale:1},exit:{opacity:0,scale:1},transition:{duration:N?.001:.25,ease:D},onClick:h=>h.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:n,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:a.removeBackground?"transparent":"inherit",position:"relative"},children:a.type==="video"?e.jsx("video",{src:a.src,poster:a.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},a.src):e.jsx("img",{src:a.src,alt:a.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:a.scale?`scale(${a.scale})`:"scale(1)"}},a.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((h,m)=>e.jsxs("button",{onClick:()=>{const l=H.flatMap(s=>s.media).find(s=>s.title===h);l&&o&&o(l)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...c,children:["View ",h," →"]},m))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...c,children:"Visit Website →"})]})]})})}ye.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Se,{})}));
