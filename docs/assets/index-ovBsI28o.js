...
`;function le(){const t=l.useRef(null);return l.useEffect(()=>{const i=n=>{t.current&&(t.current.style.left=n.clientX+"px",t.current.style.top=n.clientY+"px")};return window.addEventListener("mousemove",i),()=>window.removeEventListener("mousemove",i)},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function C(){const t=l.useCallback(()=>document.body.classList.add("ss-hover"),[]),i=l.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:i}}const x=[.32,.72,0,1],B=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,M=B?{initial:{opacity:0},animate:{opacity:1,transition:{duration:.001}},exit:{opacity:0,transition:{duration:.001}}}:{initial:{opacity:0,scale:1.012},animate:{opacity:1,scale:1,transition:{duration:.62,ease:x,opacity:{duration:.42,ease:"linear"}}},exit:{opacity:0,transition:{duration:.42,ease:"linear"}}};function de(){const[t,i]=l.useState("home"),[n,r]=l.useState(null),[s,a]=l.useState(null),[d,c]=l.useState(window.innerWidth>=1024),m=I.indexOf(t),o=t==="about",u=l.useRef(!1),b=C();l.useEffect(()=>{if(document.getElementById("ss-global"))return;const p=document.createElement("style");p.id="ss-global",p.innerHTML=re,document.head.appendChild(p)},[]),l.useEffect(()=>{const p=()=>{c(window.innerWidth>=1024)};return window.addEventListener("resize",p),()=>window.removeEventListener("resize",p)},[]),l.useEffect(()=>{const p=t==="about"?"#ede8e0":"#060606";document.documentElement.style.backgroundColor=p,document.body.style.backgroundColor=p},[t]);const T=l.useRef(m);l.useEffect(()=>{T.current=m},[m]);const j=l.useRef(t);l.useEffect(()=>{j.current=t},[t]);const S=l.useRef(!1);l.useEffect(()=>{S.current=!!n||!!s},[n,s]);const k=l.useCallback(p=>{p!==t&&(r(null),a(null),i(p))},[t]);l.useEffect(()=>{const p=f=>{if(S.current||u.current||j.current==="home"||j.current==="work"&&window.innerWidth<1024)return;const v=f.target;if(v.closest(".ss-modal-grid")||v.closest(".ss-media-viewer")||Math.abs(f.deltaX)>Math.abs(f.deltaY)*.5)return;const g=f.deltaY>0?1:-1,w=Math.max(0,Math.min(I.length-1,T.current+g));w!==T.current&&(u.current=!0,i(I[w]),setTimeout(()=>{u.current=!1},1100))};return window.addEventListener("wheel",p,{passive:!0}),()=>window.removeEventListener("wheel",p)},[]);const E=l.useRef(0),A=l.useRef(0);return l.useEffect(()=>{const p=v=>{E.current=v.touches[0].clientY,A.current=v.touches[0].clientX},f=v=>{if(S.current||u.current||j.current==="home"||j.current==="work"||v.target.closest(".ss-modal-grid"))return;const w=E.current-v.changedTouches[0].clientY,R=A.current-v.changedTouches[0].clientX;if(Math.abs(w)<120||Math.abs(w)<Math.abs(R)*3)return;const N=w>0?1:-1,H=Math.max(0,Math.min(I.length-1,T.current+N));H!==T.current&&(u.current=!0,i(I[H]),setTimeout(()=>{u.current=!1},1100))};return window.addEventListener("touchstart",p,{passive:!0}),window.addEventListener("touchend",f,{passive:!0}),()=>{window.removeEventListener("touchstart",p),window.removeEventListener("touchend",f)}},[]),l.useEffect(()=>{const p=f=>{if(s){f.key==="Escape"&&a(null);return}if(n){f.key==="Escape"&&r(null);return}t!=="home"&&((f.key==="ArrowDown"||f.key==="ArrowRight")&&i(I[Math.min(I.length-1,m+1)]),(f.key==="ArrowUp"||f.key==="ArrowLeft")&&i(I[Math.max(0,m-1)]))};return window.addEventListener("keydown",p),()=>window.removeEventListener("keydown",p)},[m,s,n]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx(le,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:I.map(p=>e.jsx("li",{children:e.jsx(he,{label:p.charAt(0).toUpperCase()+p.slice(1),active:t===p,onClick:()=>k(p),onLight:o})},p))})]}),e.jsx("div",{style:{position:"fixed",right:"max(32px, calc(32px + env(safe-area-inset-right)))",top:"50%",transform:"translateY(-50%)",zIndex:400,display:"flex",flexDirection:"column",gap:12},children:I.map(p=>e.jsx("button",{onClick:()=>k(p),className:"ss-tap","aria-label":p,style:{width:10,height:10,borderRadius:"50%",border:`1px solid ${o?"rgba(20,17,11,.42)":"rgba(245,242,237,.4)"}`,background:t===p?o?"#14110b":"var(--white)":"transparent",transform:t===p?"scale(1.5)":"scale(1)",transition:"all 0.4s ease",cursor:"none",position:"relative"},...b},p))}),e.jsxs(W,{children:[t==="home"&&e.jsx(fe,{onNavigate:k},"home"),t==="work"&&e.jsx(Ie,{onCardClick:r},"work"),t==="about"&&e.jsx(Ce,{},"about"),t==="contact"&&e.jsx(ze,{},"contact")]}),e.jsx(W,{children:n&&e.jsx(He,{project:n,onClose:()=>r(null),onMediaClick:a})}),e.jsx(W,{children:s&&e.jsx(Le,{item:s,onClose:()=>a(null),onItemClick:a})})]})}function he({label:t,active:i,onClick:n,onLight:r}){const s=C();return e.jsxs("button",{onClick:n,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:r?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:i?1:.86,textShadow:r?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...s,children:[t,e.jsx("span",{style:{position:"absolute",bottom:-4,left:0,height:1,background:"var(--sky)",width:i?"100%":0,transition:"width 0.4s var(--ease-out)",display:"none"}})]})}function ce(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const i=t.__realmSupported();return{ok:!!i.ok,why:i.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const $=["Shyon","Shiri"],pe=x,me={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},ge={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:pe}}};function ue({isMobile:t}){return e.jsx(h.h1,{className:"ss-hero-name","aria-label":$.join(" "),variants:me,initial:"hidden",animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:$.map(i=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...i].map((n,r)=>e.jsx(h.span,{className:"ss-hero-ch",variants:ge,children:n},i+r))},i))})}function fe({onNavigate:t}){const[i,n]=l.useState(!1),[r,s]=l.useState(window.innerWidth<=640),[a]=l.useState(ce),d=C(),c=l.useRef(null);l.useEffect(()=>{const o=()=>{s(window.innerWidth<=640)};return window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[]);const m=()=>{const o=c.current;o&&o.scrollTo({top:o.clientHeight,behavior:"smooth"})};return e.jsxs(h.div,{...M,ref:c,className:"ss-home-page ss-home-scroll",style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",alt:"",onLoad:()=>n(!0),className:i?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{style:{position:"absolute",bottom:r?"14vh":"24vh",left:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(ue,{isMobile:r}),e.jsxs(h.p,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.8,delay:.58,ease:x},style:{marginTop:16,maxWidth:460,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:["Click"," ",e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:o=>{(o.key==="Enter"||o.key===" ")&&t("work")},...d,style:{color:"#38bdf8",textDecoration:"underline",textUnderlineOffset:"3px",textDecorationThickness:"1.5px",fontWeight:600,cursor:"none"},children:"here"})," ","to browse my site, or scroll down for the interactive 3D environment built into it."]})]}),e.jsx(h.button,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:1.15},className:"ss-story-cue",onClick:m,...d,style:{cursor:"none"},children:e.jsx("span",{className:"ss-cue-arrow",children:"▼"})})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(P,{id:"open",label:"My Lego Realm",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(h.img,{className:"ss-open-img",variants:J,src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the Ruins, the Coffee Shop, the Cottage across the river, and the Modern House with a car on its driveway.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(L,{className:"ss-open-title",text:"My Lego Realm",variant:X,stagger:.07}),e.jsx(L,{className:"ss-open-line",text:"An interactive real-time 3D environment, built brick by brick in Blender. Walk the town and step inside any building to see the work it holds.",variant:K,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(P,{id:"map",label:"The town",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(Y,{pair:!0,kicker:"What it is",body:"A small town built on a LEGO-inspired baseplate. Each structure holds a different branch of the work, and walking into one is how you open it."}),e.jsx(je,{}),e.jsx("div",{className:"ss-map-hint",children:"Pick a structure to see what it holds"})]})}),e.jsx(P,{id:"why",label:"Why I made it",className:"ss-slide-why",stagger:.2,children:e.jsxs("div",{className:"ss-quiet",children:[e.jsx(Y,{pair:!0,kicker:`Why I
