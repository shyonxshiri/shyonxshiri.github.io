...
`;function ke(){const t=d.useRef(null);return d.useEffect(()=>{const r=t.current;if(!r)return;const o=requestAnimationFrame(()=>r.classList.add("ss-cursor-ready"));let c=-1,n=-1;const a=l=>{r.style.left=l.clientX+"px",r.style.top=l.clientY+"px",c>=0&&(l.clientX!==c||l.clientY!==n)&&(r.style.opacity="1"),c=l.clientX,n=l.clientY},p=()=>{r.style.opacity="0"},m=l=>l.preventDefault();return window.addEventListener("mousemove",a),document.addEventListener("mouseleave",p),document.addEventListener("dragstart",m),()=>{cancelAnimationFrame(o),window.removeEventListener("mousemove",a),document.removeEventListener("mouseleave",p),document.removeEventListener("dragstart",m)}},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function H(){const t=d.useCallback(()=>document.body.classList.add("ss-hover"),[]),r=d.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:r}}const P=[.32,.72,0,1],A=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches;function Ee({page:t,children:r}){const o=ce(),[c,n]=d.useState(t),[a,p]=d.useState(null),[m,l]=d.useState(!1),s=d.useRef(null);return d.useEffect(()=>{!a&&t!==c&&(l(!1),p(t))},[t,c,a]),d.useEffect(()=>{if(!a)return;let h=!1;const u=Array.from(s.current?.querySelectorAll("img")||[]);return Promise.all(u.filter(w=>w.loading!=="lazy").map(w=>w.decode().catch(()=>{}))).then(()=>{h||l(!0)}),()=>{h=!0}},[a]),e.jsx(e.Fragment,{children:[c,...a?[a]:[]].map(h=>{const u=h===a;return e.jsx(v.div,{"data-page":h,ref:u?s:void 0,"aria-hidden":a&&!u?!0:void 0,initial:{opacity:u?0:1},animate:{opacity:u&&!m?0:1},transition:{duration:o||!u?0:.38,ease:[.4,0,.2,1]},onAnimationComplete:w=>{u&&m&&typeof w=="object"&&"opacity"in w&&w.opacity===1&&(n(h),p(null))},style:{position:"absolute",inset:0,zIndex:u?2:1,isolation:"isolate",background:"#060606",pointerEvents:a?"none":"auto"},children:r(h)},h)})})}function Se(){const[t,r]=d.useState("home"),o=d.useRef(!1),[c,n]=d.useState(null),[a,p]=d.useState(null),m=t==="about";d.useEffect(()=>{if(document.getElementById("ss-global"))return;const s=document.createElement("style");s.id="ss-global",s.innerHTML=ve,document.head.appendChild(s)},[]),d.useEffect(()=>{const s=t==="about"?"#f1eff2":"#060606";document.documentElement.style.backgroundColor=s,document.body.style.backgroundColor=s},[t]);const l=d.useCallback(s=>{s!==t&&(o.current=!0,n(null),p(null),r(s))},[t]);return d.useEffect(()=>{const s=h=>{if(a){h.key==="Escape"&&p(null);return}if(c){h.key==="Escape"&&n(null);return}};return window.addEventListener("keydown",s),()=>window.removeEventListener("keydown",s)},[a,c]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx("svg",{width:"0",height:"0","aria-hidden":"true",focusable:"false",style:{position:"absolute",pointerEvents:"none"},children:e.jsx("defs",{children:e.jsxs("filter",{id:"ss-portrait-detail",x:"0",y:"0",width:"100%",height:"100%",colorInterpolationFilters:"sRGB",children:[e.jsx("feGaussianBlur",{in:"SourceGraphic",stdDeviation:"0.65",edgeMode:"duplicate",result:"soft"}),e.jsx("feComposite",{in:"SourceGraphic",in2:"soft",operator:"arithmetic",k1:"0",k2:"1.35",k3:"-0.35",k4:"0"})]})})}),e.jsx(ke,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",pointerEvents:"none"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none",pointerEvents:"auto"},children:xe.map(s=>e.jsx("li",{children:e.jsx(Te,{label:s.charAt(0).toUpperCase()+s.slice(1),active:t===s,onClick:()=>l(s),onLight:m})},s))})]}),e.jsx(Ee,{page:t,children:s=>e.jsxs(e.Fragment,{children:[s==="home"&&e.jsx(Ce,{onNavigate:l,intro:!o.current}),s==="work"&&e.jsx(Ve,{onCardClick:n}),s==="about"&&e.jsx(ye,{}),s==="contact"&&e.jsx(Ye,{})]})}),e.jsx(Z,{children:c&&e.jsx($e,{project:c,onClose:()=>n(null),onMediaClick:p})}),e.jsx(Z,{children:a&&e.jsx(qe,{item:a,onClose:()=>p(null),onItemClick:p})})]})}function Te({label:t,active:r,onClick:o,onLight:c}){const n=H();return e.jsx("button",{onClick:o,"aria-current":r?"page":void 0,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:12,fontWeight:r?650:500,letterSpacing:"0.05em",textTransform:"uppercase",color:c?"#14110b":"var(--white)",background:"none",border:"none",cursor:"none",opacity:r?1:.86,textShadow:c?"0 0 2px rgba(255,253,249,1), 0 0 4px rgba(255,253,249,1), 0 0 10px rgba(255,253,249,1), 0 0 20px rgba(255,253,249,.9)":"0 0 2px rgba(0,0,0,.95), 0 1px 3px rgba(0,0,0,1), 0 0 10px rgba(0,0,0,.95)",transition:"opacity .3s var(--ease-out), color .45s var(--ease-out), text-shadow .45s var(--ease-out)",position:"relative"},...n,children:t})}function je(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const r=t.__realmSupported();return{ok:!!r.ok,why:r.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const oe=["Shyon","Shiri"],Ne=P,Ae={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},Re={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:Ne}}};function Ie({isMobile:t,intro:r}){return e.jsx(v.h1,{className:"ss-hero-name","aria-label":oe.join(" "),variants:Ae,initial:r&&!A?"hidden":!1,animate:"show",style:{fontSize:t?"clamp(46px,7.4vw,74px)":"clamp(68px,9.4vw,148px)"},children:oe.map(o=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...o].map((c,n)=>e.jsx(v.span,{className:"ss-hero-ch",variants:Re,children:c},o+n))},o))})}function Ce({onNavigate:t,intro:r}){const[o,c]=d.useState(!1),[n,a]=d.useState(window.innerWidth<=640),[p]=d.useState(je),m=H(),l=d.useRef(null),[s,h]=d.useState(!1),u=d.useRef(!1);d.useEffect(()=>{const y=()=>{a(window.innerWidth<=640)};return window.addEventListener("resize",y),()=>window.removeEventListener("resize",y)},[]);const w=d.useRef(null);d.useEffect(()=>()=>w.current?.(),[]);const T=y=>{w.current?.();const b=l.current;b&&y==="open"&&(b.dataset.locked="false",h(!0));const z=b?.querySelector(`[data-slide="${y}"]`);if(!b||!z)return;const L=b.scrollTop,f=Math.min(b.scrollHeight-b.clientHeight,L+z.getBoundingClientRect().top-b.getBoundingClientRect().top);if(A){b.scrollTo({top:f,behavior:"instant"});return}const S=f-L,N=Math.min(2600,1200+Math.abs(S)*.45)*.75,C=performance.now(),R=b.style.scrollSnapType,j=b.style.scrollBehavior;b.style.scrollSnapType="none",b.style.scrollBehavior="auto";let I=0;const k=()=>{cancelAnimationFrame(I),b.style.scrollSnapType=R,b.style.scrollBehavior=j,b.removeEventListener("wheel",k),b.removeEventListener("touchstart",k),b.removeEventListener("pointerdown",k),window.removeEventListener("keydown",k),w.current=null};w.current=k,b.addEventListener("wheel",k,{passive:!0}),b.addEventListener("touchstart",k,{passive:!0}),b.addEventListener("pointerdown",k,{passive:!0}),window.addEventListener("keydown",k);const M=B=>{const i=Math.min(1,(B-C)/N),g=(1-Math.cos(Math.PI*i))/2;b.scrollTop=L+S*g,i<1?I=requestAnimationFrame(M):k()};I=requestAnimationFrame(M)};return e.jsxs(v.div,{ref:l,className:"ss-home-page ss-home-scroll","data-locked":!s,onScroll:y=>{const b=y.currentTarget;s&&(b.scrollTop>4&&(u.current=!0),u.current&&b.scrollTop<=1&&(w.current?.(),u.current=!1,b.dataset.locked="true",h(!1)))},style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-home-hero ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",decoding:"async",width:"1920",height:"1080",alt:"",onLoad:()=>c(!0),className:o?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"url(#ss-portrait-detail) brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{className:"ss-hero-intro",style:{position:"absolute",bottom:n?"14vh":"24vh",left:"8vw",right:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(Ie,{isMobile:n,intro:r}),e.jsxs(v.div,{className:"ss-hero-summary",initial:A||!r?!1:{opacity:0,y:8},animate:{opacity:1,y:0},transition:{duration:.38,delay:A||!r?0:.5,ease:P},children:[e.jsx("p",{style:{marginTop:20,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:"Browse the site using the navigation buttons or view it in LEGO form."}),e.jsx("div",{className:"ss-hero-actions",children:e.jsx("button",{type:"button",className:"ss-hero-secondary",onClick:()=>T("open"),...m,children:"View My LEGO Portfolio"})})]})]})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(K,{id:"open",label:"My LEGO Portfolio",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(v.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_mansion_portrait.jpg",alt:"My LEGO character facing the camera, with the mansion, upstairs balcony, and four cars behind him.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(J,{className:"ss-open-title",text:"My LEGO Portfolio",variant:pe,stagger:.07}),e.jsx(J,{className:"ss-open-line",text:"My portfolio, built in LEGO. Walk between buildings to browse projects and learn about me.",variant:ne,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(K,{id:"map",label:"Navigation",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(le,{pair:!0,kicker:"Navigation",body:"The coffee shop opens client work, the cottage holds selected projects, and the house leads to About. NABU is at the crystal above the ruins."}),e.jsx(Fe,{}),e.jsx("div",{className:"ss-map-hint",children:"Select a building to preview it"})]})}),e.jsxs(K,{id:"shop",label:"Development",className:"ss-slide-shop",stagger:.18,children:[e.jsx(le,{pair:!0,kicker:"Development",body:"Built in Blender and brought into the browser with Three.js. Compressed models, collision detection, and a day-night cycle make the portfolio a place you can move through. Most builds are my own, alongside a few modified free assets."}),e.jsx(Le,{})]})]}),e.jsxs(K,{id:"close",label:"View My LEGO Portfolio",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(v.img,{className:"ss-open-img",variants:re,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",loading:"lazy",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(v.dl,{className:"ss-figs",variants:he,children:Oe.map(y=>e.jsxs(v.div,{className:"ss-fig",variants:He,children:[e.jsxs("dd",{children:[y.n,e.jsx("i",{children:y.unit})]}),e.jsx("dt",{children:y.label})]},y.label))}),e.jsx(J,{className:"ss-open-line",text:p.ok?"Controls are displayed on entry.":"View my LEGO Portfolio on a supported desktop or laptop. You can browse the same projects in Work on this device.",variant:ne,stagger:.018}),e.jsxs(v.div,{variants:me,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[p.ok?e.jsxs("a",{href:"/lego.html",...m,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"View My LEGO Portfolio"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"var(--sf)"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),p.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:y=>{(y.key==="Enter"||y.key===" ")&&t("work")},...m,className:"ss-tap",style:{fontFamily:"var(--sf)",fontSize:11.5,fontWeight:590,letterSpacing:"0.05em",textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:p.ok?"or browse my work":"Browse my work"})]})]})]})]}),s&&e.jsx(Ue,{scrollRef:l})]},"home")}const F=P,Be={hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}},he={hidden:{},show:{transition:{staggerChildren:.03,delayChildren:0}}},pe={hidden:{opacity:0,y:8},show:{opacity:1,y:0,transition:{duration:.36,ease:F}}},ne={hidden:{opacity:0,y:5},show:{opacity:1,y:0,transition:{duration:.32,ease:F}}},me={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:F}}},Pe={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:F}}},Me={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:F,staggerChildren:.13,delayChildren:.14}}},re={hidden:{opacity:0,scale:1.015},show:{opacity:1,scale:1,transition:{duration:1.9,ease:F}}};function J({text:t,variant:r,className:o,style:c}){const n=[];return t.split(`
`).forEach((a,p)=>{p>0&&n.push(e.jsx("br",{},"br"+p));const m=a.split(" ");m.forEach((l,s)=>n.push(e.jsxs("span",{className:"ss-w",style:{display:"inline-block"},children:[l,s<m.length-1?" ":""]},p+"-"+s)))}),e.jsx(v.p,{className:o,style:c,variants:r,children:n})}const De={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.85,ease:P}}},X=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The coffee shop in progress, assembled from individual bricks on the same stud grid used by the engine."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"Building the ruins in Edit Mode. The highlighted brick course forms the next section above the doorway."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull’s UV layout on the left and its mapped texture on the right. Printed details are applied through the same workflow."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The house during construction, with the node graph for its tinted window material below the viewport."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"Checking the cottage’s materials and lighting in Blender before export."}];function Le(){const[t,r]=d.useState(0);return e.jsxs(v.div,{className:"ss-sheet",variants:he,children:[e.jsx("div",{className:"ss-sheet-grid",children:X.map((o,c)=>e.jsxs(v.button,{className:`ss-cell${c===t?" on":""}`,variants:Me,onMouseEnter:()=>r(c),onFocus:()=>r(c),"aria-label":o.scene,children:[e.jsx(v.span,{className:"ss-cell-shot",variants:De,children:e.jsx("img",{src:o.src,alt:o.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:o.scene})]},o.src))}),e.jsxs(v.p,{className:"ss-sheet-cap",variants:Pe,children:[e.jsx("b",{children:X[t].scene}),X[t].caption]})]})}const Oe=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],He={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.6,ease:P}}},q=[{id:"shop",name:"The Coffee Shop",cat:"Client Work",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full-stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Selected Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Coursework and independent projects in 3D, physical objects, electronics, and image-making."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU streetwear brand."}],ze={hidden:{opacity:0,scale:.55},show:{opacity:1,scale:1,transition:{duration:.55,ease:P}}},_e={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.45,ease:P}}};function Fe(){const t=d.useRef(null),r=d.useRef(null),[o,c]=d.useState({left:0,top:0,w:0,h:0}),[n,a]=d.useState({w:0,h:0}),[p,m]=d.useState({l:0,r:0}),[l,s]=d.useState(0),[h,u]=d.useState(null),[w,T]=d.useState(!1);d.useEffect(()=>{const f=t.current;if(!f)return;const S=2400,N=1350,C=()=>{const j=f.getBoundingClientRect();if(!j.width||!j.height)return;const I=Math.min(j.width/S,j.height/N),k=S*I,M=N*I;c({left:(j.width-k)/2,top:(j.height-M)/2,w:k,h:M});const B=document.documentElement.clientWidth;let i=0,g=B;for(let x=f;x&&x!==document.documentElement;x=x.parentElement)if(getComputedStyle(x).overflowX!=="visible"){const _=x.getBoundingClientRect();i=Math.max(i,_.left),g=Math.min(g,_.right)}m({l:i+8-j.left,r:Math.min(g-8,B-64)-j.left}),a({w:j.width,h:j.height})};C();const R=new ResizeObserver(C);return R.observe(f),()=>R.disconnect()},[]),d.useLayoutEffect(()=>{if(!h)return;const f=r.current;f&&s(f.offsetHeight)},[h,n.w]);const y=q.find(f=>f.id===h)||null,b=y?z(y):void 0;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(v.div,{className:"ss-map-stage",ref:t,variants:me,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,loading:"lazy",decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:o.left,top:o.top,width:o.w,height:o.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",loading:"lazy",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),q.map(f=>e.jsxs(v.button,{variants:ze,className:`ss-map-pin${f.flip?" flip":""}${h===f.id?" on":""}`+(h===f.id&&b?.covered?" hushed":""),style:{left:f.x+"%",top:f.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{w||u(f.id)},onMouseLeave:()=>{w||u(null)},onFocus:()=>u(f.id),onClick:()=>{const S=h===f.id&&w;T(!S),u(S?null:f.id)},"aria-label":f.name+", "+f.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:f.cat})]},f.id))]})]}),L()]});function z(f){if(!n.w||!o.w)return;const S=10,N=20,C=16,R=Math.min(n.w*.28,306),j=l||R*9/16+104,I=E=>({x:o.left+o.w*E.x/100,y:o.top+o.h*E.y/100}),k=I(f),M=q.filter(E=>E.id!==f.id).map(I),B=f.x<50,i=f.y<55,g=[[B,i],[B,!i],[!B,i],[!B,!i]];let x=null;for(const[E,_]of g){const D=Math.min(S,p.l),U=Math.max(n.w-S,p.r),W=Math.max(D,Math.min(E?k.x+N:k.x-N-R,U-R)),G=Math.max(S,Math.min(_?k.y+N:k.y-N-j,n.h-j-S));let V=10*M.filter(Y=>Y.x>W-C&&Y.x<W+R+C&&Y.y>G-C&&Y.y<G+j+C).length;const Q=14+7.6*f.cat.length,ee=f.flip?k.x-10-Q:k.x+10,te=ee<W+R+4&&ee+Q>W-4&&k.y-11<G+j+4&&k.y+11>G-4;te&&V++;const se={left:W,top:G,hits:V,tag:te};if(!V){x=se;break}(!x||V<x.hits)&&(x=se)}return{style:{left:x.left,top:x.top,right:"auto",bottom:"auto"},covered:x.tag}}function L(){return e.jsx(Z,{children:y&&e.jsxs(v.div,{ref:r,className:"ss-map-card",style:b?.style,variants:_e,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:y.src,alt:y.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-name",children:y.name}),e.jsx("p",{children:y.line})]})]},y.id)})}}function K({id:t,label:r,className:o,stagger:c,children:n}){const a=c?{hidden:{},show:{transition:{staggerChildren:.04,delayChildren:0}}}:Be;return e.jsx(v.section,{className:`ss-slide ss-snap${o?" "+o:""}`,"data-slide":t,"data-label":r,variants:a,initial:"hidden",whileInView:"show",viewport:{amount:.2,once:!0},children:e.jsx("div",{className:"ss-slide-inner",children:n})})}function We(t){const[r,o]=d.useState(A?1:0);return d.useEffect(()=>{if(A)return;const c=t.current;if(!c)return;const n=c.closest(".ss-home-scroll");let a=0;const p=()=>{a=0;const l=window.innerHeight||1,s=c.getBoundingClientRect(),h=(l-s.top)/Math.max(1,s.height*.75);o(h<0?0:h>1?1:h)},m=()=>{a||(a=requestAnimationFrame(p))};return(n||window).addEventListener("scroll",m,{passive:!0}),window.addEventListener("resize",m),p(),()=>{a&&cancelAnimationFrame(a),(n||window).removeEventListener("scroll",m),window.removeEventListener("resize",m)}},[t]),r}function Ge({text:t,p:r}){const o=t.split(" "),c=o.length;return e.jsx(e.Fragment,{children:o.map((n,a)=>{const p=a/c*.82,m=Math.min(1,Math.max(0,(r-p)/.2));return e.jsxs("span",{style:{color:`rgba(245,242,237,${(.22+.56*m).toFixed(3)})`,transition:"color .12s linear"},children:[n,a<c-1?" ":""]},n+a)})})}function le({kicker:t,body:r,pair:o,children:c}){const n=e.jsx(J,{className:"ss-story-kicker",text:t,variant:pe,stagger:.055}),a=d.useRef(null),p=We(a),m=e.jsx(Ge,{text:r,p});return o?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:n}),e.jsx("div",{className:"ss-chapter-body",ref:a,children:m})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[n,e.jsx("div",{className:"ss-chapter-body",ref:a,children:m}),c]})}function Ue({scrollRef:t}){const[r,o]=d.useState([]),[c,n]=d.useState(0),a=d.useRef([]);d.useEffect(()=>{const l=t.current;if(!l)return;const s=Array.from(l.querySelectorAll("[data-slide]"));a.current=s,o(s.map(u=>({id:u.dataset.slide||"",label:u.dataset.label||""})));const h=new IntersectionObserver(u=>{for(const w of u)if(w.isIntersecting){const T=a.current.indexOf(w.target);T>=0&&n(T)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return s.forEach(u=>h.observe(u)),()=>h.disconnect()},[t]);const p=l=>{const s=t.current,h=a.current[l];!s||!h||s.scrollTo({top:s.scrollTop+h.getBoundingClientRect().top-s.getBoundingClientRect().top,behavior:A?"auto":"smooth"})};if(r.length<2)return null;const m=c>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${m?" on":""}`,"aria-hidden":!m,children:r.map((l,s)=>e.jsx("button",{type:"button",className:`ss-deck-tick${s===c?" on":""}`,onClick:()=>p(s),"aria-label":l.label,"aria-current":s===c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:l.label})},l.id))}),e.jsxs("div",{className:`ss-deck-count${m?" on":""}`,children:[e.jsx("b",{children:String(c+1).padStart(2,"0")})," / ",String(r.length).padStart(2,"0")]})]})}function de({index:t,orbit:r,radius:o,style:c,...n}){const a=ae(r,m=>{const l=(t-m)*2*Math.PI/O.length,s=Math.sin(l)*o/Math.sin(2*Math.PI/O.length),h=(Math.cos(l)-1)*220;return`translate3d(${s}px,0,${h}px) rotateY(${-Math.sin(l)*34}deg) scale(${.9+.1*Math.cos(l)})`}),p=ae(r,m=>Math.round((Math.cos((t-m)*2*Math.PI/O.length)+1)*100)+1);return e.jsx(v.div,{...n,draggable:!1,onDragStart:m=>m.preventDefault(),style:{...c,transform:a,zIndex:p,backfaceVisibility:"hidden",WebkitBackfaceVisibility:"hidden"}})}function Ve({onCardClick:t}){const r=H(),[o,c]=d.useState({width:window.innerWidth,height:window.innerHeight}),n=o.width>=1024;d.useEffect(()=>{const i=()=>{c({width:window.innerWidth,height:window.innerHeight})};return window.addEventListener("resize",i),()=>window.removeEventListener("resize",i)},[]);const a=O.length,[p,m]=d.useState(0),l=(p%a+a)%a,s=ue(0),[h,u]=d.useState(!1),w=i=>{s.stop(),u(!0),fe(s,i,{duration:A?0:.72,ease:[.42,0,.22,1],onComplete:()=>{m(i),u(!1)}})};d.useEffect(()=>()=>s.stop(),[s]);const T=i=>{w(i+Math.round((s.get()-i)/a)*a)},y=d.useRef(null),b=d.useRef(!1),z=d.useRef(null);d.useEffect(()=>{const i=z.current;if(!i)return;let g=0,x=!1,E=0;const _=D=>{if(D.ctrlKey||Math.abs(D.deltaX)<=Math.abs(D.deltaY))return;D.preventDefault();const U=performance.now();U-E>180&&(g=0,x=!1),E=U,g+=D.deltaX*(D.deltaMode===1?16:D.deltaMode===2?i.clientWidth:1),!x&&Math.abs(g)>=32&&(x=!0,w(Math.round(s.get())+Math.sign(g)))};return i.addEventListener("wheel",_,{passive:!1}),()=>i.removeEventListener("wheel",_)},[s]);const L=i=>w(Math.round(s.get())+i),f=o.width<=640,S=n?380:Math.min(o.width*(f?.64:.7),f?290:330),N=Math.min(S*1.32,Math.max(f?230:290,o.height*(f?.42:.5))),C=S*(n?1.4:f?1.08:1.24),R={"creative-projects":{base:"#041007",glow:"radial-gradient(ellipse 70% 72% at 46% 43%, rgba(30,154,35,.34) 0%, rgba(18,120,21,.17) 40%, transparent 78%)"},"professional-services":{base:"#d9d2df",glow:"radial-gradient(ellipse 80% 85% at 72% 58%, rgba(125,78,164,.36) 0%, rgba(125,78,164,.14) 48%, transparent 85%), radial-gradient(ellipse 62% 70% at 18% 22%, rgba(246,242,247,.75) 0%, transparent 85%)"},nabu:{base:"#0a1020",glow:"radial-gradient(ellipse 76% 70% at 42% 40%, rgba(84,120,157,.29) 0%, rgba(43,53,105,.16) 45%, transparent 80%)"}},j=O[l]?.id,I=j==="professional-services",k=I?"#14110b":"var(--white)",M=I?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",B=R[j]||R["creative-projects"];return e.jsx(v.div,{className:"ss-work-page",style:{position:"absolute",inset:0,overflowX:"hidden",overflowY:"auto",overscrollBehaviorY:"none",background:"#0c0d0f"},children:e.jsxs("div",{className:"ss-work-layout",style:{position:"relative",minHeight:"max(660px, 100dvh)",overflow:"hidden"},children:[e.jsx(v.div,{"aria-hidden":"true",animate:{backgroundColor:B.base},transition:{duration:A?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none"}}),Object.entries(R).map(([i,g])=>e.jsx(v.div,{"aria-hidden":"true",animate:{opacity:i===j?1:0},transition:{duration:A?0:.65},style:{position:"absolute",inset:0,pointerEvents:"none",background:g.glow}},i)),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"115px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(v.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{fontFamily:"var(--sf)",fontSize:"clamp(38px,5vw,64px)",letterSpacing:"-0.065em",fontWeight:550,lineHeight:1,color:k,textShadow:M,transition:"color 0.7s ease"},children:"Work"}),e.jsx("p",{id:"ss-work-hint",style:{marginTop:14,maxWidth:290,fontSize:14,lineHeight:1.5,color:k,opacity:.75,transition:"color .7s ease"},children:"Swipe or drag to browse. Select a project to view."})]}),e.jsx("div",{ref:z,className:"ss-work-carousel","aria-describedby":"ss-work-hint",role:"region","aria-label":"Work categories","aria-roledescription":"carousel",style:{position:"absolute",left:0,right:0,top:f?`max(${230+N/2}px, 50%)`:"50%",height:N+64,transform:"translateY(-50%)",display:"flex",alignItems:"center",justifyContent:"center",perspective:1100,touchAction:"pan-y pinch-zoom",userSelect:"none"},onPointerDown:i=>{!i.isPrimary||i.button!==0||y.current||(y.current={id:i.pointerId,x:i.clientX,y:i.clientY,dragging:!1,orbitStart:s.get()},b.current=!1)},onPointerMove:i=>{const g=y.current;if(!g||g.id!==i.pointerId)return;const x=i.clientX-g.x,E=i.clientY-g.y;Math.hypot(x,E)>8&&(b.current=!0),!g.dragging&&Math.abs(x)>8&&Math.abs(x)>Math.abs(E)*1.15&&(g.dragging=!0,s.stop(),u(!0),g.orbitStart=s.get(),i.currentTarget.setPointerCapture(i.pointerId)),g.dragging&&s.set(g.orbitStart-Math.max(-.65,Math.min(.65,x*.65/S)))},onPointerUp:i=>{const g=y.current;if(!g||g.id!==i.pointerId)return;const x=i.clientX-g.x,E=i.clientY-g.y;g.dragging&&Math.abs(x)>=Math.max(22,S*.08)&&Math.abs(x)>Math.abs(E)*1.15?w(Math.round(g.orbitStart)+(x<0?1:-1)):g.dragging&&w(Math.round(s.get())),y.current=null,i.currentTarget.hasPointerCapture(i.pointerId)&&i.currentTarget.releasePointerCapture(i.pointerId)},onPointerCancel:()=>{y.current=null,b.current=!0,w(Math.round(s.get()))},onLostPointerCapture:i=>{y.current?.id===i.pointerId&&(y.current=null,b.current=!0,w(Math.round(s.get())))},onClickCapture:i=>{b.current&&i.detail!==0&&(i.preventDefault(),i.stopPropagation())},onKeyDown:i=>{if(i.key==="ArrowLeft"||i.key==="ArrowRight"){i.preventDefault();const g=(l+(i.key==="ArrowRight"?1:-1)+a)%a,x=i.currentTarget;T(g),requestAnimationFrame(()=>x.querySelectorAll('[role="button"]')[g]?.focus({preventScroll:!0}))}},children:O.map((i,g)=>{const x=(g-l+a)%a;return i.id==="nabu"?e.jsxs(de,{index:g,orbit:s,radius:C,className:"ss-project-card ss-project-card-nabu","data-active":x===0&&!h,role:"button",tabIndex:0,"aria-label":`${x===0?"Open":"Select"} ${i.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),x===0&&!h?t(i):T(g))},onClick:()=>{b.current||(x===0&&!h?t(i):T(g))},...r,style:{position:"absolute",width:S,height:N,cursor:"none",transformStyle:"flat",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",transform:`translate(${-Math.min(S,N*.78)*25.5/1080}px, ${-Math.min(S,N*.78)*16/1080}px)`,display:"block",pointerEvents:"none",filter:"drop-shadow(0 26px 55px rgba(0,0,0,.55))",transition:"filter .5s ease"}}),e.jsx("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:k,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:i.title})})]},i.id):e.jsxs(de,{index:g,orbit:s,radius:C,role:"button",tabIndex:0,"aria-label":`${x===0?"Open":"Select"} ${i.title}`,onKeyDown:E=>{(E.key==="Enter"||E.key===" ")&&(E.preventDefault(),x===0&&!h?t(i):T(g))},className:"ss-card ss-project-card","data-active":x===0&&!h,onClick:()=>{b.current||(x===0&&!h?t(i):T(g))},...r,style:{position:"absolute",width:S,height:N,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:"0 30px 65px rgba(0,0,0,.5)",transformStyle:"flat"},children:[e.jsx("img",{src:i.img,alt:i.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:i.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:f?"18px 16px":"24px 22px",pointerEvents:"none"},children:e.jsx("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:i.title})})})]},i.id)})}),e.jsxs("div",{className:"ss-work-controls",style:{position:"absolute",bottom:f?20:28,left:0,right:0,display:"flex",justifyContent:"center",alignItems:"center",gap:8,zIndex:20},children:[e.jsx("button",{type:"button","aria-label":"Previous category",onClick:()=>L(-1),style:{color:k,width:44,height:44},children:"←"}),O.map((i,g)=>e.jsx("button",{type:"button","aria-label":`Show ${i.title}`,"aria-pressed":g===l,onClick:()=>T(g),style:{width:44,height:44,display:"grid",placeItems:"center"},children:e.jsx("span",{style:{display:"block",width:g===l?26:8,height:8,borderRadius:980,background:g===l?"#38bdf8":I?"#777":"#aaa",transition:"width .3s ease"}})},i.id)),e.jsx("button",{type:"button","aria-label":"Next category",onClick:()=>L(1),style:{color:k,width:44,height:44},children:"→"})]})]})},"work")}function Ye(){const t=H(),r=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(v.div,{className:"ss-contact-page",style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsxs("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,overflow:"hidden",pointerEvents:"none"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"var(--sf)",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}})]}),e.jsxs("div",{className:"ss-contact-content",style:{position:"relative",zIndex:10,width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(v.h2,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},className:"ss-contact-heading",style:{fontFamily:"var(--sf)",fontSize:"clamp(46px,6.2vw,96px)",fontWeight:550,letterSpacing:"-0.065em",lineHeight:1,color:"var(--white)"},children:["Get in touch",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(v.p,{initial:!1,animate:{opacity:1},transition:{duration:.34,delay:.04},className:"ss-contact-description",style:{fontFamily:"var(--sf)",fontWeight:400,fontSize:"clamp(15px,1.5vw,18px)",lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--mid)",maxWidth:300,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(v.div,{initial:!1,animate:{opacity:1,y:0},transition:{duration:.34,delay:.04,ease:P},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:r.map(o=>e.jsxs("a",{className:"ss-contact-entry",href:o.href,target:o.target,rel:o.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},...t,children:[e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?"clamp(15px,2.4vw,21px)":"clamp(21px,2.8vw,30px)",fontWeight:600,letterSpacing:"-0.02em",color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:o.label}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:window.innerWidth<=640?13.5:17,fontWeight:400,letterSpacing:"-0.005em",color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:o.value}),e.jsx("span",{style:{fontFamily:"var(--sf)",fontSize:17,color:"var(--sky)",flexShrink:0},children:"→"})]},o.label))})]})]},"contact")}function $e({project:t,onClose:r,onMediaClick:o}){const c=H(),n=d.useRef(null);d.useEffect(()=>{const l=document.activeElement,s=n.current;s?.querySelector("button")?.focus({preventScroll:!0});const h=u=>{if(u.key!=="Tab"||!s)return;const w=Array.from(s.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(b=>b.getClientRects().length>0),T=w[0],y=w[w.length-1];u.shiftKey&&document.activeElement===T?(u.preventDefault(),y?.focus()):!u.shiftKey&&document.activeElement===y&&(u.preventDefault(),T?.focus())};return s?.addEventListener("keydown",h),()=>{s?.removeEventListener("keydown",h),l?.isConnected&&l.focus({preventScroll:!0})}},[]);const[a,p]=d.useState(window.innerWidth),m=a>=1024;return d.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),d.useEffect(()=>{const l=()=>{p(window.innerWidth)};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),e.jsx(v.div,{ref:n,role:"dialog","aria-modal":"true","aria-label":t.title,initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:A?.001:.4},onClick:r,style:{position:"fixed",inset:0,zIndex:11e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(v.div,{initial:{opacity:0,scale:A?1:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:A?1:.96},transition:{duration:A?.001:.4,ease:P},onClick:l=>l.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:r,className:"ss-modal-close","aria-label":"Close project gallery",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"var(--sf)",fontSize:15,fontWeight:400,lineHeight:1.5,letterSpacing:"-0.005em",color:"var(--sky)",marginTop:10},children:t.id==="creative-projects"?"Coursework and independent projects in 3D, physical objects, electronics, and image-making.":t.id==="professional-services"?"Websites, identities, and print work made for clients.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":""})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const l=t.media.filter(u=>!u.hidden),s=a<=640?2:a<=1023?3:4,h=Array.from({length:s},()=>[]);return l.forEach((u,w)=>h[w%s].push(u)),h.map((u,w)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:u.map((T,y)=>e.jsx(Ke,{item:T,onClick:()=>o(T)},y))},w))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, minmax(0, 220px))",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(l=>!l.hidden).map((l,s)=>e.jsx(Je,{item:l,onClick:()=>o(l)},s))}),!m&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"var(--sf)",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"Scroll to browse"})]})})}function Ke({item:t,onClick:r}){const o=H(),c=t.aspectRatio||"4/3";return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-scell",onClick:r,...o,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:c},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--mid)",marginTop:4},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Je({item:t,onClick:r}){const o=H();return e.jsxs("button",{type:"button","aria-label":`View ${t.title}`,className:"ss-tile",onClick:r,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...o,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:11,fontWeight:500,fontVariantNumeric:"tabular-nums",color:"var(--sky)",marginTop:2},children:[t.year,t.credit&&e.jsx("span",{style:{display:"block",lineHeight:1.5},children:t.credit})]})]})]})}function Xe({pages:t,title:r,labels:o}){const c=d.useRef(null),[n,a]=d.useState(0),p=d.useRef(0),m=ce(),l=s=>{const h=c.current;h&&h.scrollTo({left:Math.max(0,Math.min(t.length-1,s))*h.clientWidth,behavior:m?"instant":"smooth"})};return d.useEffect(()=>{const s=c.current;if(!s)return;const h=new ResizeObserver(()=>s.scrollTo({left:p.current*s.clientWidth,behavior:"instant"}));return h.observe(s),()=>h.disconnect()},[]),e.jsxs("div",{className:"ss-booklet-reader",children:[e.jsx("div",{ref:c,className:"ss-booklet-track",tabIndex:0,role:"region","aria-label":`${r}, scroll through ${o?"pieces":"pages"}`,onScroll:s=>{p.current=Math.round(s.currentTarget.scrollLeft/s.currentTarget.clientWidth),a(p.current)},onKeyDown:s=>{(s.key==="ArrowRight"||s.key==="ArrowLeft")&&(s.preventDefault(),l(n+(s.key==="ArrowRight"?1:-1)))},children:t.map((s,h)=>e.jsx("figure",{className:"ss-booklet-page",children:e.jsx("img",{src:s,alt:o?.[h]?`${r}, ${o[h]}`:`${r}, page ${h+1} of ${t.length}`,loading:h?"lazy":"eager"})},s))}),e.jsxs("div",{className:"ss-booklet-controls",children:[e.jsx("button",{onClick:()=>l(n-1),disabled:n===0,"aria-label":o?"Previous piece":"Previous booklet page",children:"←"}),e.jsx("span",{"aria-live":"polite",children:o?`${o[n]} · ${n+1} of ${t.length}`:`Page ${n+1} of ${t.length}`}),e.jsx("button",{onClick:()=>l(n+1),disabled:n===t.length-1,"aria-label":o?"Next piece":"Next booklet page",children:"→"})]})]})}function qe({item:t,onClose:r,onItemClick:o}){const c=H(),n=d.useRef(null);d.useEffect(()=>{const p=document.activeElement,m=n.current;m?.querySelector("button")?.focus({preventScroll:!0});const l=s=>{if(s.key!=="Tab"||!m)return;const h=Array.from(m.querySelectorAll('button, a[href], video[controls], [tabindex="0"]')).filter(T=>T.getClientRects().length>0),u=h[0],w=h[h.length-1];s.shiftKey&&document.activeElement===u?(s.preventDefault(),w?.focus()):!s.shiftKey&&document.activeElement===w&&(s.preventDefault(),u?.focus())};return m?.addEventListener("keydown",l),()=>{m?.removeEventListener("keydown",l),p?.isConnected&&p.focus({preventScroll:!0})}},[]);const a=t;return e.jsxs(v.div,{ref:n,role:"dialog","aria-modal":"true","aria-labelledby":"ss-viewer-title",initial:{opacity:0},animate:{opacity:1,pointerEvents:"auto"},exit:{opacity:0,pointerEvents:"none"},transition:{duration:A?.001:.25},onClick:r,style:{position:"fixed",inset:0,zIndex:12e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[e.jsx("button",{onClick:r,className:"ss-media-viewer-close","aria-label":"Close asset viewer",...c,children:e.jsx("svg",{width:"20",height:"20",viewBox:"0 0 24 24","aria-hidden":"true",children:e.jsx("path",{d:"m6 6 12 12M18 6 6 18",fill:"none",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})})}),e.jsxs("div",{onClick:p=>p.stopPropagation(),className:"ss-media-viewer",children:[e.jsx("div",{className:"ss-viewer-media",children:e.jsx("div",{className:`ss-viewer-canvas${a.pages?" ss-booklet-media":""}`,style:{"--asset-ratio":a.aspectRatio||"4/3"},children:a.pages?e.jsx(Xe,{pages:a.pages,title:a.title,labels:a.pageLabels},a.src):a.type==="video"?e.jsx("video",{src:a.src,poster:a.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},a.src):e.jsx("img",{src:a.src,alt:a.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:a.scale?`scale(${a.scale})`:"scale(1)"}},a.src)})}),e.jsxs("div",{className:"ss-viewer-info",children:[e.jsx("div",{id:"ss-viewer-title",className:"ss-asset-title",children:t.title}),e.jsxs("div",{style:{fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:[t.year,t.credit&&e.jsx("div",{style:{marginTop:8,textTransform:"none",letterSpacing:0,lineHeight:1.5,color:"var(--mid)"},children:t.credit})]}),t.desc&&e.jsx("p",{style:{fontFamily:"var(--sf)",fontSize:16,lineHeight:1.55,letterSpacing:"-0.005em",color:"rgba(245,242,237,.75)",fontWeight:400,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((p,m)=>e.jsxs("button",{onClick:()=>{const l=O.flatMap(s=>s.media).find(s=>s.title===p);l&&o&&o(l)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...c,children:["View ",p," →"]},m))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"var(--sf)",fontSize:10.5,fontWeight:600,letterSpacing:"0.06em",textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...c,children:"Visit Website →"})]})]})]})}be.createRoot(document.getElementById("root")).render(e.jsx(d.StrictMode,{children:e.jsx(Se,{})}));
