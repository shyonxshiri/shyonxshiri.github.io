import{r as oe,a as r,j as e,A as D,m as h,u as q}from"./vendor-D85UCaVR.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))c(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const m of o.addedNodes)m.tagName==="LINK"&&m.rel==="modulepreload"&&c(m)}).observe(document,{childList:!0,subtree:!0});function n(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function c(i){if(i.ep)return;i.ep=!0;const o=n(i);fetch(i.href,o)}})();var L={},K;function ne(){if(K)return L;K=1;var t=oe();return L.createRoot=t.createRoot,L.hydrateRoot=t.hydrateRoot,L}var re=ne();const O=[{id:"creative-projects",title:"Personal Projects",tag:"Design, 3D & Craft",img:"/assets/3D_Models_Cover_Pic.jpg",size:"tall",objectPosition:"45% 90%",media:[{type:"video",src:"/assets/Broken_NPC.MP4",poster:"/assets/Broken_NPC.jpg",title:"The Broken NPC",year:2024,desc:"A detailed 3D scene depicting in-game rendering errors from GTA San Andreas, created entirely using Blender.",aspectRatio:"16/9",relatedItems:[]},{type:"video",src:"/assets/Blender_Case_Video.mp4",poster:"/assets/Blender_Case.jpg",title:"Apple Accessory Prototypes",year:2024,desc:"3D designed Apple product case prototypes developed using Blender.",aspectRatio:"16/9",relatedItems:["Custom Airpod Case","Custom Phone Case"]},{type:"video",src:"/assets/Shiri_Video_Game.mp4",poster:"/assets/Shiri_VIdeo_Game.jpg",title:"Video Game Demo",year:2024,desc:"Animated and assembled collection of images created in Adobe After Effects.",aspectRatio:"16/9"},{type:"image",src:"/assets/Venom.PNG",title:"Rendered 3D Model",year:2024,desc:"Movie character modeled, textured, and rendered in Blender.",aspectRatio:"16/9"},{type:"image",src:"/assets/My_Case.jpg",title:"Custom Phone Case",year:2025,desc:"Finalized rendition of the iPhone case prototype, designed to resemble liquid metal.",aspectRatio:"5/6",relatedItems:["Apple Accessory Prototypes"]},{type:"image",src:"/assets/Airpod_Case.JPG",title:"Custom Airpod Case",year:2026,desc:"Finalized rendition of the Airpod case prototype, designed to resemble liquid metal.",aspectRatio:"4/5",relatedItems:["Apple Accessory Prototypes"]},{type:"image",src:"/assets/New_Radar_Sensor_front.jpg",title:"Radar — Front View",year:2024,desc:"Front of the radar enclosure. Paired ultrasonic transducers, a 16x2 character LCD, and a recessed speaker cone, all set into a 3D printed shell.",aspectRatio:"4/3",hidden:!0,relatedItems:["Radar — Back View","Hardware Builds Together","HMI Sensor System"]},{type:"image",src:"/assets/New_Radar_Sensor_Back.jpg",title:"Radar — Back View",year:2024,desc:"Back of the radar enclosure, showing the access panel, wiring routing, and the power and control cutouts.",aspectRatio:"4/3",hidden:!0,relatedItems:["Radar — Front View","Hardware Builds Together","HMI Sensor System"]},{type:"image",src:"/assets/New_LED_Box_Front.jpg",title:"RGB Box — Front View",year:2024,desc:"Front of the RGB controller. A faceted 3D printed shell with the addressable LED strip seated in a chamfered channel.",aspectRatio:"4/3",hidden:!0,relatedItems:["RGB Box — Back View","Hardware Builds Together","Custom RGB Controller"]},{type:"image",src:"/assets/New_LED_Box_Back.jpg",title:"RGB Box — Back View",year:2024,desc:"Back of the RGB controller, with the potentiometer, mode button, and toggle switch mounted through the top panel.",aspectRatio:"4/3",hidden:!0,relatedItems:["RGB Box — Front View","Hardware Builds Together","Custom RGB Controller"]},{type:"image",src:"/assets/Programming_Cover_Pic.jpg",title:"Hardware Builds Together",year:2024,desc:"The radar module and the RGB controller side by side. Each enclosure was modeled around its own board, display, and controls, then 3D printed and finished by hand.",aspectRatio:"4/3",hidden:!0,relatedItems:["HMI Sensor System","Custom RGB Controller"]},{type:"image",src:"/assets/Max_Pic.JPG",title:"Candid Studio Portrait",year:2024,desc:"Studio portrait shot with controlled lighting.",aspectRatio:"2/3"},{type:"image",src:"/assets/Photography_1.jpg",title:"Studio Photography",year:2024,desc:"Studio photography focused on composition and lighting.",aspectRatio:"1/1"},{type:"video",src:"/assets/New_Radar_Sensor.mp4",poster:"/assets/New_Radar_Sensor_front.jpg",title:"HMI Sensor System",year:2024,desc:"Interactive radar module converting ultrasonic data into real-time feedback. Custom 3D printed enclosure with LCD and speaker.",aspectRatio:"4/3",relatedItems:["Radar — Front View","Radar — Back View","Hardware Builds Together"]},{type:"video",src:"/assets/New_LED_Box.mp4",poster:"/assets/New_LED_Box_Front.jpg",title:"Custom RGB Controller",year:2024,desc:"Functional system built from scratch. 3D printed geometric casing housing the microcontroller.",aspectRatio:"4/3",relatedItems:["RGB Box — Front View","RGB Box — Back View","Hardware Builds Together"]},{type:"image",src:"/assets/Shyon_Sculpture.jpg",title:"Product, not Consumer",year:2024,desc:"Hand-fabricated steel sculpture referencing consumer tech culture, welded, ground, sanded and finished.",aspectRatio:"5/4"},{type:"image",src:"/assets/Adverstisement_Project.jpg",title:"Campaign Project",year:2024,desc:"Conceptual brand advertisement built around scenic composition.",aspectRatio:"16/9"}]},{id:"professional-services",title:"Professional Services",tag:"Web & Design",img:"/assets/Everly_Cover_Image.png",size:"wide",media:[{type:"image",src:"/assets/Mina_Website.png",title:"UI/UX — minasech.net",year:2025,desc:"Full-stack website design including React frontend and responsive interface.",link:"https://minasech.net",wide:!0,aspectRatio:"16/9"},{type:"image",src:"/assets/Everly_Cover_Image.png",title:"Everly Care Home",year:2026,desc:"Full-stack website design and development including branding, responsive interface, and complete deployment for a senior care community business.",link:"https://everlycarehome.com",wide:!0,aspectRatio:"16/9"},{type:"image",src:"/assets/RealEstate_Luning_Flyer.jpg",title:"Real Estate Marketing — Luning Dr",year:2022,desc:"Property marketing flyer designed for Real Estate Experts, pairing a hero listing photo with clean typographic hierarchy, a status badge, and agent branding.",aspectRatio:"3/4"},{type:"image",src:"/assets/RealEstate_Colleen_Flyer.jpg",title:"Real Estate Marketing — Colleen Dr",year:2022,desc:"A dual-agent listing flyer combining property details, brand elements, and paired agent headshots in a balanced square format.",aspectRatio:"1/1"},{type:"image",src:"/assets/RealEstate_MorningStar_Flyer.png",title:"Compass × Real Estate Experts — Morning Star Dr",year:2022,desc:"A premium listing announcement co-branded with Compass, layering sales highlights, pricing, and property specs over a bold editorial layout.",aspectRatio:"4/5"},{type:"image",src:"/assets/RealEstate_MoskowiteCorner_Concept.jpg",title:"Moskowite Corner — Concept Visualization",year:2026,desc:"An AI-generated concept visualization for a real estate redevelopment study at Moskowite Corner, CA. It shows a closed gas station lot rebuilt as a fuel and retail stop, modeled from aerial references for a developer evaluating the property.",aspectRatio:"5/3",relatedItems:["Moskowite Corner — Existing Site"]},{type:"image",src:"/assets/RealEstate_MoskowiteCorner_Before.png",title:"Moskowite Corner — Existing Site",year:2026,desc:"The existing site before redevelopment. A closed 1.26 acre gas station lot with parking and an office building.",aspectRatio:"16/9",hidden:!0,relatedItems:["Moskowite Corner — Concept Visualization"]}]},{id:"nabu",title:"NABU",tag:"Clothing Brand",img:"/assets/New_NABU_Cover_Card.png",size:"tall",media:[{type:"video",src:"/assets/Nabu_Poster_Banner.mp4",poster:"/assets/Nabu_Poster_Banner.jpg",title:"NABU Promotional Video",year:2023,desc:"Promotional video for NABU clothing, animated in Adobe After Effects.",wide:!0},{type:"video",src:"/assets/NABU_PUFFER_AD.mp4",poster:"/assets/NABU_Puffer_AD.jpg",title:"NABU 2026 Teaser",year:2025,desc:"Promotional video for NABU's puffer jacket collection.",relatedItems:["NABU Puffer Front","NABU Puffer Back"]},{type:"video",src:"/assets/NABU_SALE_AD.mp4",poster:"/assets/NABU_SALE_AD.jpg",title:"NABU 2025 Summer Collection",year:2025,desc:"Promotional video for the NABU 2025 summer collection."},{type:"image",src:"/assets/Stevie_Pic.JPG",title:"NABU 2023 Spring Collection",year:2022,desc:"Portrait photography for the NABU 2023 spring collection."},{type:"image",src:"/assets/NABU_Puffer_Front.jpg",title:"NABU Puffer Front",year:2025,desc:"Studio still from the puffer collection shoot. Woven bandana panelling across the body, sleeves, and hood, shot on a white cyclorama.",aspectRatio:"9/16",hidden:!0,relatedItems:["NABU Puffer Back","NABU 2026 Teaser"]},{type:"image",src:"/assets/NABU_Puffer_Back.jpg",title:"NABU Puffer Back",year:2025,desc:"Back of the same puffer, showing how the bandana medallion is centered and mirrored across the shoulders and hem.",aspectRatio:"2/3",hidden:!0,relatedItems:["NABU Puffer Front","NABU 2026 Teaser"]},{type:"image",src:"/assets/Digital_Media_Cover.jpg",title:"NABU 2024 Rerelease Promotion",year:2024,desc:"Promotional campaign for the 2024 rerelease of NABU's Persian rug pants.",aspectRatio:"3/4"}]}],C=["home","work","about","contact"],le=`
  :root {
    --black: #060606;
    --white: #f5f2ed;
    --cream: #ede8e0;
...
`;function de(){const t=r.useRef(null);return r.useEffect(()=>{const s=n=>{t.current&&(t.current.style.left=n.clientX+"px",t.current.style.top=n.clientY+"px")};return window.addEventListener("mousemove",s),()=>window.removeEventListener("mousemove",s)},[]),e.jsx("div",{id:"ss-cursor-dot",ref:t})}function I(){const t=r.useCallback(()=>document.body.classList.add("ss-hover"),[]),s=r.useCallback(()=>document.body.classList.remove("ss-hover"),[]);return{onMouseEnter:t,onMouseLeave:s}}const N=[.32,.72,0,1],B=typeof window<"u"&&typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches,F=B?{initial:{opacity:0},animate:{opacity:1,transition:{duration:.001}},exit:{opacity:0,transition:{duration:.001}}}:{initial:{opacity:0,scale:1.012},animate:{opacity:1,scale:1,transition:{duration:.62,ease:N,opacity:{duration:.42,ease:"linear"}}},exit:{opacity:0,transition:{duration:.42,ease:"linear"}}};function ce(){const[t,s]=r.useState("home"),[n,c]=r.useState(null),[i,o]=r.useState(null),[m,p]=r.useState(null),g=r.useCallback((l,d)=>{o(d?{rect:d.getBoundingClientRect(),node:d.cloneNode(!0)}:null),c(l)},[]),[a,k]=r.useState(window.innerWidth>=1024),w=C.indexOf(t),S=r.useRef(!1),A=I();r.useEffect(()=>{if(document.getElementById("ss-global"))return;const l=document.createElement("style");l.id="ss-global",l.innerHTML=le,document.head.appendChild(l)},[]),r.useEffect(()=>{const l=()=>{k(window.innerWidth>=1024)};return window.addEventListener("resize",l),()=>window.removeEventListener("resize",l)},[]),r.useEffect(()=>{const l=t==="about"?"#ede8e0":"#060606";document.documentElement.style.backgroundColor=l,document.body.style.backgroundColor=l},[t]);const f=r.useRef(w);r.useEffect(()=>{f.current=w},[w]);const u=r.useRef(t);r.useEffect(()=>{u.current=t},[t]);const y=r.useRef(!1);r.useEffect(()=>{y.current=!!n||!!m},[n,m]);const x=r.useCallback(l=>{l!==t&&(c(null),p(null),s(l))},[t]);r.useEffect(()=>{const l=d=>{if(y.current||S.current||u.current==="home"||u.current==="work"&&window.innerWidth<1024)return;const b=d.target;if(b.closest(".ss-modal-grid")||b.closest(".ss-media-viewer")||Math.abs(d.deltaX)>Math.abs(d.deltaY)*.5)return;const R=d.deltaY>0?1:-1,T=Math.max(0,Math.min(C.length-1,f.current+R));T!==f.current&&(S.current=!0,s(C[T]),setTimeout(()=>{S.current=!1},1100))};return window.addEventListener("wheel",l,{passive:!0}),()=>window.removeEventListener("wheel",l)},[]);const j=r.useRef(0),v=r.useRef(0);return r.useEffect(()=>{const l=b=>{j.current=b.touches[0].clientY,v.current=b.touches[0].clientX},d=b=>{if(y.current||S.current||u.current==="home"||u.current==="work"||b.target.closest(".ss-modal-grid"))return;const T=j.current-b.changedTouches[0].clientY,z=v.current-b.changedTouches[0].clientX;if(Math.abs(T)<120||Math.abs(T)<Math.abs(z)*3)return;const E=T>0?1:-1,P=Math.max(0,Math.min(C.length-1,f.current+E));P!==f.current&&(S.current=!0,s(C[P]),setTimeout(()=>{S.current=!1},1100))};return window.addEventListener("touchstart",l,{passive:!0}),window.addEventListener("touchend",d,{passive:!0}),()=>{window.removeEventListener("touchstart",l),window.removeEventListener("touchend",d)}},[]),r.useEffect(()=>{const l=d=>{if(m){d.key==="Escape"&&p(null);return}if(n){d.key==="Escape"&&c(null);return}t!=="home"&&((d.key==="ArrowDown"||d.key==="ArrowRight")&&s(C[Math.min(C.length-1,w+1)]),(d.key==="ArrowUp"||d.key==="ArrowLeft")&&s(C[Math.max(0,w-1)]))};return window.addEventListener("keydown",l),()=>window.removeEventListener("keydown",l)},[w,m,n]),e.jsxs("div",{style:{position:"fixed",inset:0,width:"100%",height:"100dvh",overflow:"hidden",background:"#060606"},children:[e.jsx(de,{}),e.jsxs("nav",{style:{position:"fixed",top:0,left:0,right:0,zIndex:1e4,display:"flex",alignItems:"center",justifyContent:"space-between",paddingTop:"max(28px, calc(28px + env(safe-area-inset-top)))",paddingBottom:"28px",paddingLeft:"max(48px, calc(48px + env(safe-area-inset-left)))",paddingRight:"max(48px, calc(48px + env(safe-area-inset-right)))",mixBlendMode:t==="about"&&a?"normal":"difference"},children:[e.jsx("div",{style:{visibility:"hidden"}}),e.jsx("ul",{style:{display:"flex",gap:40,listStyle:"none"},children:C.map(l=>e.jsx("li",{children:e.jsx(he,{label:l.charAt(0).toUpperCase()+l.slice(1),active:t===l,onClick:()=>x(l),currentPage:t,wideAbout:t==="about"&&a})},l))})]}),e.jsx("div",{style:{position:"fixed",right:"max(32px, calc(32px + env(safe-area-inset-right)))",top:"50%",transform:"translateY(-50%)",zIndex:400,display:"flex",flexDirection:"column",gap:12,mixBlendMode:t==="about"&&a?"normal":"difference"},children:C.map(l=>e.jsx("button",{onClick:()=>x(l),className:"ss-tap","aria-label":l,style:{width:10,height:10,borderRadius:"50%",border:"1px solid rgba(245,242,237,0.4)",background:t===l?"var(--white)":"transparent",transform:t===l?"scale(1.5)":"scale(1)",transition:"all 0.4s ease",cursor:"none",position:"relative"},...A},l))}),e.jsxs(D,{children:[t==="home"&&e.jsx(ye,{onNavigate:x},"home"),t==="work"&&e.jsx(Re,{onCardClick:g},"work"),t==="about"&&e.jsx(Ce,{},"about"),t==="contact"&&e.jsx(Ie,{},"contact")]}),e.jsx(D,{children:n&&e.jsx(ze,{project:n,from:i,onClose:()=>c(null),onMediaClick:p})}),e.jsx(D,{children:m&&e.jsx(Pe,{item:m,onClose:()=>p(null),onItemClick:p})})]})}function he({label:t,active:s,onClick:n,currentPage:c,wideAbout:i}){const o=I(),m=c==="about";return e.jsxs("button",{onClick:n,className:"ss-tap",style:{fontFamily:"'Space Mono', monospace",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:i?"#000000":"var(--white)",background:"none",border:"none",cursor:"none",opacity:m||s?1:.55,transition:"opacity 0.3s ease, color 0.3s ease",position:"relative"},...o,children:[t,e.jsx("span",{style:{position:"absolute",bottom:-4,left:0,height:1,background:"var(--sky)",width:s?"100%":0,transition:"width 0.4s var(--ease-out)",display:"none"}})]})}function pe(){const t=window;if(typeof t.__realmSupported!="function")return{ok:!0,why:"",message:""};try{const s=t.__realmSupported();return{ok:!!s.ok,why:s.why||"",message:typeof t.__realmSupportMessage=="function"?t.__realmSupportMessage():""}}catch{return{ok:!0,why:"",message:""}}}const J=["Shyon","Shiri"],me=N,ue={hidden:{},show:{transition:{staggerChildren:.052,delayChildren:.32}}},ge={hidden:{opacity:0,y:"-0.85em",scale:1.06,filter:"blur(3px)"},show:{opacity:1,y:["-0.85em","0.045em","0em"],scale:[1.06,.985,1],filter:["blur(3px)","blur(0px)","blur(0px)"],transition:{duration:.76,times:[0,.72,1],ease:me}}};function fe({isMobile:t}){return e.jsx(h.h1,{className:"ss-hero-name","aria-label":J.join(" "),variants:ue,initial:"hidden",animate:"show",style:{fontSize:t?"clamp(58px,9vw,92px)":"clamp(84px,12.5vw,200px)"},children:J.map(s=>e.jsx("span",{className:"ss-hero-line","aria-hidden":"true",children:[...s].map((n,c)=>e.jsx(h.span,{className:"ss-hero-ch",variants:ge,children:n},s+c))},s))})}function ye({onNavigate:t}){const[s,n]=r.useState(!1),[c,i]=r.useState(window.innerWidth<=640),[o]=r.useState(pe),m=I(),p=r.useRef(null);r.useEffect(()=>{const a=()=>{i(window.innerWidth<=640)};return window.addEventListener("resize",a),()=>window.removeEventListener("resize",a)},[]);const g=()=>{const a=p.current;a&&a.scrollTo({top:a.clientHeight,behavior:"smooth"})};return e.jsxs(h.div,{...F,ref:p,className:"ss-home-page ss-home-scroll",style:{position:"absolute",inset:0,background:"#060606"},children:[e.jsxs("div",{className:"ss-snap","data-slide":"hero","data-label":"Top",style:{position:"relative",height:"100dvh",overflow:"hidden"},children:[e.jsx("img",{src:"/assets/New_Shiri_Site_Pic.jpg",alt:"",onLoad:()=>n(!0),className:s?"ss-hero-bg ss-hero-bg-active":"ss-hero-bg",style:{position:"absolute",inset:0,width:"100%",height:"100%",objectFit:"cover",objectPosition:"65% 5%",filter:"brightness(0.62) contrast(1.1)",zIndex:1}}),e.jsx("div",{style:{position:"absolute",inset:0,zIndex:2,background:"radial-gradient(ellipse 65% 100% at 72% 50%, transparent 25%, rgba(6,6,6,.65) 70%), linear-gradient(to bottom, rgba(6,6,6,.25) 0%, transparent 30%, transparent 65%, rgba(6,6,6,.85) 100%)"}}),e.jsxs("div",{style:{position:"absolute",bottom:c?"14vh":"24vh",left:"8vw",zIndex:10,transition:"bottom 0.3s ease"},children:[e.jsx(fe,{isMobile:c}),e.jsxs(h.p,{initial:{opacity:0,y:16},animate:{opacity:1,y:0},transition:{duration:.8,delay:.58,ease:N},style:{marginTop:16,maxWidth:460,fontSize:16,lineHeight:1.5,color:"rgba(245,242,237,.82)"},children:["Click"," ",e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:a=>{(a.key==="Enter"||a.key===" ")&&t("work")},...m,style:{color:"#38bdf8",textDecoration:"underline",textUnderlineOffset:"3px",textDecorationThickness:"1.5px",fontWeight:600,cursor:"none"},children:"here"})," ","to browse my site, or scroll down for the interactive 3D environment built into it."]})]}),e.jsx(h.button,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:1.15},className:"ss-story-cue",onClick:g,...m,style:{cursor:"none"},children:e.jsx("span",{className:"ss-cue-arrow",children:"▼"})})]}),e.jsxs("div",{className:"ss-story",style:{position:"relative",background:"#060606",padding:"0 8vw"},children:[e.jsxs(H,{id:"open",label:"My Lego Realm",className:"ss-slide-open",stagger:.14,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(h.img,{className:"ss-open-img",variants:Q,src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the Ruins, the Coffee Shop, the Cottage across the river, and the Modern House with a car on its driveway.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(_,{className:"ss-open-title",text:"My Lego Realm",variant:X,stagger:.07}),e.jsx(_,{className:"ss-open-line",text:"An interactive real time 3D environment, built brick by brick in Blender. Walk the town and step inside any building to see the work it holds.",variant:$,stagger:.018})]})]}),e.jsxs("div",{style:{maxWidth:1180,margin:"0 auto"},children:[e.jsx(H,{id:"map",label:"The town",className:"ss-slide-map",stagger:.18,children:e.jsxs("div",{className:"ss-map-col",children:[e.jsx(Y,{pair:!0,kicker:"What it is",body:"A small town built on a LEGO inspired baseplate. Each structure holds a different branch of the work, and walking into one is how you open it."}),e.jsx(Te,{}),e.jsx("div",{className:"ss-map-hint",children:"Pick a structure to see what it holds"})]})}),e.jsx(H,{id:"why",label:"Why I made it",stagger:.2,children:e.jsxs("div",{className:"ss-quiet",children:[e.jsx(Y,{pair:!0,kicker:`Why I
made it`,body:"The environment is a work sample in its own right. Building it took the same disciplines the rest of the portfolio presents, hard surface modeling and UV work in Blender, real time rendering and collision in the browser, and the front end engineering that ties the two together. It also goes back to where my work started, stop motion films built from LEGO, and to the technologies I have taken on since."}),e.jsx(xe,{scene:"The player figure",src:"/assets/story/story_figure_front.jpg",caption:"A younger me by design. Assembled from separate parts rather than one mesh: each was modeled and textured on its own, then measured into place and bound to the rig at load time."})]})}),e.jsxs(H,{id:"shop",label:"How I made it",stagger:.18,children:[e.jsx(Y,{pair:!0,kicker:`How I
made it`,body:"Every structure was assembled from individual bricks in Blender. Most are my own builds, with some free assets worked in and modified to fit. Each model is exported as glTF, Draco compressed, and loaded by a custom Three.js engine that runs directly in the browser. The world uses the exact LEGO stud pitch as its grid, collision is rasterized per brick rather than per bounding box, stair climbing runs on a walkable heightmap, and the lighting completes a full day cycle every seven minutes."}),e.jsx(ve,{})]})]}),e.jsxs(H,{id:"close",label:"Try it",className:"ss-slide-close",stagger:.16,children:[e.jsxs("div",{className:"ss-open-bg",children:[e.jsx(h.img,{className:"ss-open-img",variants:Q,src:"/assets/story/story_aerial_sunset.jpg",alt:"The town from above at sunset, the lampposts coming on.",decoding:"async"}),e.jsx("div",{className:"ss-open-veil","aria-hidden":!0})]}),e.jsxs("div",{className:"ss-open-copy",children:[e.jsx(h.dl,{className:"ss-figs",variants:ee,children:ke.map(a=>e.jsxs(h.div,{className:"ss-fig",variants:Ee,children:[e.jsxs("dd",{children:[a.n,e.jsx("i",{children:a.unit})]}),e.jsx("dt",{children:a.label})]},a.label))}),e.jsx(_,{className:"ss-open-title ss-close-title",text:o.ok?"Walk it yourself":"The finished build",variant:X,stagger:.07}),e.jsx(_,{className:"ss-open-line",text:o.ok?"The full version runs on this site, with the day cycle and all four portals active.":"The full version runs on this site on a desktop or laptop, with the day cycle and all four portals active.",variant:$,stagger:.018}),e.jsxs(h.div,{variants:te,style:{display:"flex",alignItems:"center",gap:22,flexWrap:"wrap",marginTop:26},children:[o.ok?e.jsxs("a",{href:"/lego.html",...m,className:"ss-contact-btn",style:{display:"inline-flex",alignItems:"center",gap:10,padding:"16px 30px",borderRadius:980,minHeight:46,border:"1px solid rgba(245,242,237,.4)",color:"var(--white)",textDecoration:"none",fontSize:13,fontWeight:600,cursor:"none"},children:[e.jsx("span",{children:"Enter My Lego Realm"}),e.jsx("span",{children:"→"})]}):e.jsxs("p",{style:{maxWidth:430,fontSize:14,lineHeight:1.6,color:"rgba(245,242,237,.62)",fontFamily:"'Cormorant Garamond', Georgia, serif"},children:[e.jsx("span",{style:{display:"block",marginBottom:6,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)"},children:"Desktop only"}),o.message]}),e.jsx("span",{role:"button",tabIndex:0,onClick:()=>t("work"),onKeyDown:a=>{(a.key==="Enter"||a.key===" ")&&t("work")},...m,className:"ss-tap",style:{fontFamily:"'Space Mono', monospace",fontSize:11,letterSpacing:2,textTransform:"uppercase",color:"rgba(245,242,237,.72)",textDecoration:"underline",textUnderlineOffset:"4px",cursor:"none",display:"inline-block"},children:o.ok?"or browse the work":"Browse the work"})]})]})]})]}),e.jsx(Ne,{scrollRef:p})]},"home")}const M=N,be={hidden:{},show:{transition:{staggerChildren:.14,delayChildren:.06}}},ee={hidden:{},show:{transition:{staggerChildren:.11,delayChildren:.04}}},X={hidden:{opacity:0,y:"0.55em",rotateX:-68,transformPerspective:700},show:{opacity:1,y:"0em",rotateX:0,transition:{duration:.66,ease:M}}},$={hidden:{opacity:0,y:10},show:{opacity:1,y:0,transition:{duration:.5,ease:M}}},te={hidden:{opacity:0,y:22},show:{opacity:1,y:0,transition:{duration:.72,ease:M}}},we={hidden:{opacity:0,clipPath:"inset(0% 100% 0% 0%)"},show:{opacity:1,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.62,ease:M}}},se={hidden:{opacity:0,y:14,clipPath:"inset(0% 0% 100% 0%)"},show:{opacity:1,y:0,clipPath:"inset(0% 0% -6% 0%)",transition:{duration:.7,ease:M}}},ae={hidden:{y:30,borderColor:"rgba(245,242,237,0)"},show:{y:0,borderColor:"rgba(245,242,237,0.16)",transition:{duration:.8,ease:M,staggerChildren:.13,delayChildren:.14}}},Q={hidden:{opacity:0,scale:1.09},show:{opacity:1,scale:1,transition:{duration:1.9,ease:M}}};function _({text:t,variant:s,stagger:n=.03,className:c,style:i}){const o=[];return t.split(`
`).forEach((m,p)=>{p>0&&o.push(e.jsx("br",{},"br"+p));const g=m.split(" ");g.forEach((a,k)=>o.push(e.jsxs(h.span,{className:"ss-w",variants:s,style:{display:"inline-block",willChange:"transform"},children:[a,k<g.length-1?" ":""]},p+"-"+k)))}),e.jsx(h.p,{className:c,style:i,variants:{hidden:{},show:{transition:{staggerChildren:n}}},children:o})}const W=t=>s=>Math.min(1,Math.floor(s*t)/(t-1)),ie={hidden:{clipPath:"inset(100% 0% 0% 0%)"},show:{clipPath:"inset(0% 0% 0% 0%)",transition:{duration:1.05,ease:W(6)}}};function xe({scene:t,src:s,caption:n}){return e.jsxs(h.figure,{className:"ss-plate",variants:ae,children:[e.jsx(h.span,{className:"ss-plate-label",variants:we,children:t}),e.jsx(h.div,{className:"ss-plate-shot",variants:ie,children:e.jsx("img",{src:s,alt:t,loading:"lazy",decoding:"async"})}),e.jsx(h.figcaption,{variants:se,children:n})]})}const V=[{scene:"Assembly",src:"/assets/story/story_blender_shop_assembly.jpg",caption:"The Coffee Shop part way up: walls built to the halfway course, the roof and awning not yet placed, the umbrella pole still bare. Every piece is a separate modeled brick that snaps to the same stud grid the engine uses."},{scene:"Mesh editing",src:"/assets/story/story_blender_ruins_edit.jpg",caption:"The ruins in Edit Mode, built up to the doorway arch with the upper storey still to come. The highlighted course is the one going on next."},{scene:"Sculpting",src:"/assets/story/story_blender_hair_sculpt.jpg",caption:"The character's hair in Sculpt Mode under a clay material. Roughly 8,000 vertices shaped by hand, then exported with cleaned normals for smooth shading."},{scene:"UV and texturing",src:"/assets/story/story_blender_skull_uv.jpg",caption:"The skull prop in the UV Editing workspace. On the left the mesh is unwrapped flat over its painted texture, on the right the same texture is shown mapped onto the model. Every printed detail in the world is applied this way."},{scene:"Figure assembly",src:"/assets/story/story_blender_figure_exploded.jpg",caption:"The minifig broken into its parts: hair, head, torso, and arms. The legs are a separate asset, attached to the hip pivots at runtime so the walk cycle can swing them."},{scene:"Materials",src:"/assets/story/story_blender_house_nodes.jpg",caption:"The Modern House with the ground floor closed and the upper storey just started. The node graph under the viewport defines the tinted window glass: fully metallic, zero roughness, reduced alpha."},{scene:"Render preview",src:"/assets/story/story_blender_cottage_render.jpg",caption:"The Cottage with its walls finished and the roof not yet on, in a rendered viewport under a warm sun. Renders like this were used to check color and lighting before export."}];function ve(){const[t,s]=r.useState(0);return e.jsxs(h.div,{className:"ss-sheet",variants:ee,children:[e.jsx("div",{className:"ss-sheet-grid",children:V.map((n,c)=>e.jsxs(h.button,{className:`ss-cell${c===t?" on":""}`,variants:ae,onMouseEnter:()=>s(c),onFocus:()=>s(c),"aria-label":n.scene,children:[e.jsx(h.span,{className:"ss-cell-shot",variants:ie,children:e.jsx("img",{src:n.src,alt:n.scene,loading:"lazy",decoding:"async"})}),e.jsx("span",{className:"ss-cell-label",children:n.scene})]},n.src))}),e.jsxs(h.p,{className:"ss-sheet-cap",variants:se,children:[e.jsx("b",{children:V[t].scene}),V[t].caption]})]})}const ke=[{n:"15.9",unit:"M",label:"Triangles a frame"},{n:"689",unit:"",label:"Draw calls"},{n:"35",unit:"",label:"Models loaded"},{n:"7",unit:"min",label:"Full day cycle"}],Ee={hidden:{opacity:0,y:14},show:{opacity:1,y:0,transition:{duration:.5,ease:W(4)}}},Z=[{id:"shop",name:"The Coffee Shop",cat:"Professional Services",x:18.2,y:26,flip:!1,src:"/assets/story/story_shop_evening.jpg",line:"Commissioned client work. Full stack websites, brand and print for small businesses, and concept visualization."},{id:"cottage",name:"The Cottage",cat:"Personal Projects",x:53.5,y:25,flip:!1,src:"/assets/story/story_sunset.jpg",line:"Self directed work. 3D modeling and rendering, product prototypes, custom hardware, photography and fabrication."},{id:"house",name:"The Modern House",cat:"About",x:93.5,y:38,flip:!0,src:"/assets/story/story_lamp_night.jpg",line:"Background and training, and how the disciplines across the rest of the site fit together."},{id:"ruins",name:"The Ruins",cat:"NABU",x:13,y:85,flip:!1,src:"/assets/story/story_crystal_night.jpg",line:"Art direction, promotional video and campaign photography for the NABU clothing label."}],je={hidden:{opacity:0,scale:0},show:{opacity:1,scale:1,transition:{duration:.5,ease:W(4)}}},Se={hidden:{opacity:0,clipPath:"inset(100% 0% 0% 0%)"},show:{opacity:1,clipPath:"inset(0% 0% 0% 0%)",transition:{duration:.5,ease:W(5)}}};function Te(){const t=r.useRef(null),[s,n]=r.useState({left:0,top:0,w:0,h:0}),[c,i]=r.useState(null),[o,m]=r.useState(!1);r.useEffect(()=>{const a=t.current;if(!a)return;const k=2400,w=1350,S=()=>{const f=a.getBoundingClientRect();if(!f.width||!f.height)return;const u=Math.min(f.width/k,f.height/w),y=k*u,x=w*u;n({left:(f.width-y)/2,top:(f.height-x)/2,w:y,h:x})};S();const A=new ResizeObserver(S);return A.observe(a),()=>A.disconnect()},[]);const p=Z.find(a=>a.id===c)||null;return e.jsxs("div",{className:"ss-map-frame",children:[e.jsxs(h.div,{className:"ss-map-stage",ref:t,variants:te,children:[e.jsx("img",{className:"ss-map-bed",src:"/assets/story/story_aerial_town.jpg",alt:"","aria-hidden":!0,decoding:"async"}),e.jsxs("div",{className:"ss-map-fit",style:{left:s.left,top:s.top,width:s.w,height:s.h},children:[e.jsx("img",{className:"ss-map-img",src:"/assets/story/story_aerial_town.jpg",alt:"The town from above: the Coffee Shop, the Cottage, the Modern House and the Ruins.",decoding:"async"}),Z.map(a=>e.jsxs(h.button,{variants:je,className:`ss-map-pin${a.flip?" flip":""}${c===a.id?" on":""}`,style:{left:a.x+"%",top:a.y+"%",x:"-50%",y:"-50%"},onMouseEnter:()=>{o||i(a.id)},onMouseLeave:()=>{o||i(null)},onFocus:()=>i(a.id),onClick:()=>{const k=c===a.id&&o;m(!k),i(k?null:a.id)},"aria-label":a.name+", "+a.cat,children:[e.jsx("span",{className:"ss-map-stud","aria-hidden":!0}),e.jsx("span",{className:"ss-map-tag",children:a.cat})]},a.id))]})]}),g()]});function g(){return e.jsx(D,{children:p&&e.jsxs(h.div,{className:"ss-map-card",variants:Se,initial:"hidden",animate:"show",exit:{opacity:0,transition:{duration:.16}},children:[e.jsx("img",{src:p.src,alt:p.name,decoding:"async"}),e.jsxs("div",{className:"ss-map-card-body",children:[e.jsx("span",{className:"ss-map-card-cat",children:p.cat}),e.jsx("span",{className:"ss-map-card-name",children:p.name}),e.jsx("p",{children:p.line})]})]},p.id)})}}function H({id:t,label:s,className:n,stagger:c,children:i}){const o=c?{hidden:{},show:{transition:{staggerChildren:c,delayChildren:.06}}}:be;return e.jsx(h.section,{className:`ss-slide ss-snap${n?" "+n:""}`,"data-slide":t,"data-label":s,variants:o,initial:"hidden",whileInView:"show",viewport:{amount:.35},children:e.jsx("div",{className:"ss-slide-inner",children:i})})}function Y({kicker:t,body:s,pair:n,children:c}){const i=e.jsx(_,{className:"ss-story-kicker",text:t,variant:X,stagger:.055}),o=e.jsx(_,{text:s,variant:$,stagger:.016});return n?e.jsxs("div",{className:"ss-chapter-head",children:[e.jsx("div",{children:i}),e.jsx("div",{className:"ss-chapter-body",children:o})]}):e.jsxs("div",{className:"ss-chapter-stack",children:[i,e.jsx("div",{className:"ss-chapter-body",children:o}),c]})}function Ne({scrollRef:t}){const[s,n]=r.useState([]),[c,i]=r.useState(0),o=r.useRef([]);r.useEffect(()=>{const g=t.current;if(!g)return;const a=Array.from(g.querySelectorAll("[data-slide]"));o.current=a,n(a.map(w=>({id:w.dataset.slide||"",label:w.dataset.label||""})));const k=new IntersectionObserver(w=>{for(const S of w)if(S.isIntersecting){const A=o.current.indexOf(S.target);A>=0&&i(A)}},{root:null,rootMargin:"-48% 0px -48% 0px",threshold:0});return a.forEach(w=>k.observe(w)),()=>k.disconnect()},[t]);const m=g=>{const a=t.current,k=o.current[g];!a||!k||a.scrollTo({top:a.scrollTop+k.getBoundingClientRect().top-a.getBoundingClientRect().top,behavior:"smooth"})};if(s.length<2)return null;const p=c>0;return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:`ss-deck-rail${p?" on":""}`,"aria-hidden":!p,children:s.map((g,a)=>e.jsx("button",{type:"button",className:`ss-deck-tick${a===c?" on":""}`,onClick:()=>m(a),"aria-label":g.label,"aria-current":a===c,style:{cursor:"none"},children:e.jsx("span",{className:"ss-deck-tip",children:g.label})},g.id))}),e.jsxs("div",{className:`ss-deck-count${p?" on":""}`,children:[e.jsx("b",{children:String(c+1).padStart(2,"0")})," / ",String(s.length).padStart(2,"0")]})]})}function Ae({base:t,emit:s}){const n=r.useRef(null),c=r.useRef({base:t,emit:s});return r.useEffect(()=>{c.current={base:t,emit:s}},[t,s]),r.useEffect(()=>{const i=n.current;if(!i)return;const o=i.getContext("2d");if(!o)return;const m=Math.min(window.devicePixelRatio||1,2);let p=0,g=0,a=0,k=performance.now();const w=()=>{p=i.clientWidth,g=i.clientHeight,i.width=Math.max(1,Math.floor(p*m)),i.height=Math.max(1,Math.floor(g*m)),o.setTransform(m,0,0,m,0,0)};w(),window.addEventListener("resize",w);const S=Array.from({length:12},()=>({x:Math.random(),y:Math.random(),r:110+Math.random()*280,vx:(Math.random()-.5)*.024,vy:(Math.random()-.5)*.024,ph:Math.random()*Math.PI*2,sp:.07+Math.random()*.12,a:.14+Math.random()*.12})),A=j=>{const v=j.replace("#",""),l=parseInt(v.length===3?v.split("").map(d=>d+d).join(""):v,16);return{r:l>>16&255,g:l>>8&255,b:l&255}},f=j=>{const v=j.split(",").map(Number);return{r:v[0],g:v[1],b:v[2]}},u=A(t),y=f(s),x=j=>{const v=Math.min(.05,(j-k)/1e3);k=j;const l=A(c.current.base),d=f(c.current.emit),b=Math.min(1,v*1.3);u.r+=(l.r-u.r)*b,u.g+=(l.g-u.g)*b,u.b+=(l.b-u.b)*b,y.r+=(d.r-y.r)*b,y.g+=(d.g-y.g)*b,y.b+=(d.b-y.b)*b,o.fillStyle=`rgb(${u.r|0},${u.g|0},${u.b|0})`,o.fillRect(0,0,p,g);const R=y.r|0,T=y.g|0,z=y.b|0;for(const E of S){E.x+=E.vx*v,E.y+=E.vy*v,E.ph+=E.sp*v,E.x<-.2&&(E.x=1.2),E.x>1.2&&(E.x=-.2),E.y<-.2&&(E.y=1.2),E.y>1.2&&(E.y=-.2);const P=(E.x+Math.sin(E.ph)*.02)*p,G=(E.y+Math.cos(E.ph*.8)*.02)*g,U=o.createRadialGradient(P,G,0,P,G,E.r);U.addColorStop(0,`rgba(${R},${T},${z},${E.a})`),U.addColorStop(1,`rgba(${R},${T},${z},0)`),o.fillStyle=U,o.beginPath(),o.arc(P,G,E.r,0,Math.PI*2),o.fill()}a=requestAnimationFrame(x)};return a=requestAnimationFrame(x),()=>{cancelAnimationFrame(a),window.removeEventListener("resize",w)}},[]),e.jsx("canvas",{ref:n,"aria-hidden":!0,style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block",zIndex:0}})}function Re({onCardClick:t}){const s=I(),[n,c]=r.useState(window.innerWidth>=1024);r.useEffect(()=>{const d=()=>{c(window.innerWidth>=1024)};return window.addEventListener("resize",d),()=>window.removeEventListener("resize",d)},[]);const[i,o]=r.useState(0),m=O.length,p=r.useRef(0),g=r.useRef(!1);r.useEffect(()=>{const d=setTimeout(()=>o(b=>(b+1)%m),3e4);return()=>clearTimeout(d)},[i,m]);const a=d=>o(b=>(b+d+m)%m),k=window.innerWidth<=640,w=n?380:Math.min(window.innerWidth*.7,330),S=Math.min(w*1.32,window.innerHeight*.56),A=w*(n?1.12:.7),f={"creative-projects":{base:"#030b05",emit:"46,224,120"},"professional-services":{base:"#ffffff",emit:"150,152,158"},nabu:{base:"#0d1015",emit:"84,168,255"}},u=O[i]?.id,y=u==="professional-services",x=y?"#14110b":"var(--white)",j=x,v=y?"0 1px 12px rgba(255,255,255,.6)":"0 1px 14px rgba(0,0,0,.6)",l=f[u]||f["creative-projects"];return e.jsxs(h.div,{...F,style:{position:"absolute",inset:0,overflow:"hidden",background:"#0c0d0f"},children:[e.jsx(Ae,{base:l.base,emit:l.emit}),e.jsx("div",{"aria-hidden":!0,style:{position:"absolute",inset:0,pointerEvents:"none",opacity:.03,backgroundImage:`url("data:image/svg+xml,%3Csvg viewBox='0 0 200 200' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='wn'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='0.9' numOctaves='4' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100%25' height='100%25' filter='url(%23wn)'/%3E%3C/svg%3E")`,backgroundSize:"180px"}}),e.jsxs("div",{style:{position:"absolute",top:0,left:0,padding:"44px 5vw 0",zIndex:10,maxWidth:780},children:[e.jsx(h.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.8,delay:.1,ease:N},style:{fontSize:"clamp(38px,5vw,84px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:x,textShadow:v,transition:"color 0.7s ease"},children:"Work"}),e.jsx(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.35,ease:N},style:{marginTop:10,maxWidth:640},children:n&&e.jsx("p",{style:{fontSize:15,lineHeight:1.45,color:j,textShadow:v,transition:"color 0.7s ease"},children:"Commissioned client work, plus personal and academic projects across every medium."})})]}),e.jsx("div",{style:{position:"absolute",left:0,right:0,top:0,bottom:0,display:"flex",alignItems:"center",justifyContent:"center",perspective:1800,touchAction:"pan-y"},onPointerDown:d=>{p.current=d.clientX,g.current=!1},onPointerMove:d=>{Math.abs(d.clientX-p.current)>8&&(g.current=!0)},onPointerUp:d=>{const b=d.clientX-p.current;b<-48?a(1):b>48&&a(-1)},children:O.map((d,b)=>{const R=(b-i+m)%m,T=R===0?{x:0,scale:1,rotateY:0,opacity:1,z:3}:R===1?{x:A,scale:.82,rotateY:-14,opacity:1,z:2}:{x:-A,scale:.82,rotateY:14,opacity:1,z:2};return d.id==="nabu"?e.jsxs(h.div,{animate:{x:T.x,scale:T.scale,rotateY:T.rotateY,opacity:T.opacity},transition:{duration:.6,ease:N},onClick:z=>{g.current||(R===0?t(d,z.currentTarget):o(b))},...s,style:{position:"absolute",width:w,height:S,zIndex:T.z,cursor:"none",transformStyle:"preserve-3d",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[e.jsx("img",{src:d.img,alt:d.title,style:{width:"100%",height:"78%",objectFit:"contain",objectPosition:"center",display:"block",pointerEvents:"none",filter:R===0?"drop-shadow(0 26px 55px rgba(0,0,0,.55))":"none",transition:"filter .5s ease"}}),e.jsxs("div",{style:{textAlign:"center",marginTop:14,pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:x,lineHeight:1.05,fontWeight:600,transition:"color 0.7s ease"},children:d.title}),e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginTop:7},children:d.tag})]})]},d.id):e.jsxs(h.div,{className:"ss-card",animate:{x:T.x,scale:T.scale,rotateY:T.rotateY,opacity:T.opacity},transition:{duration:.6,ease:N},onClick:z=>{g.current||(R===0?t(d,z.currentTarget):o(b))},...s,style:{position:"absolute",width:w,height:S,zIndex:T.z,borderRadius:22,overflow:"hidden",background:"#111",cursor:"none",boxShadow:R===0?"0 40px 90px rgba(0,0,0,.6)":"0 20px 50px rgba(0,0,0,.5)",transformStyle:"preserve-3d"},children:[e.jsx("img",{src:d.img,alt:d.title,style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:d.objectPosition||"center",display:"block",pointerEvents:"none",filter:"brightness(0.95)",transition:"filter .5s ease"}}),e.jsxs("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to top, rgba(6,6,6,.92) 0%, rgba(6,6,6,.4) 42%, rgba(6,6,6,0) 78%)",display:"flex",flexDirection:"column",justifyContent:"flex-end",padding:"24px 22px",pointerEvents:"none"},children:[e.jsx("div",{style:{fontSize:12,letterSpacing:1.5,color:"var(--sky)",textTransform:"uppercase",fontWeight:500,marginBottom:6},children:d.tag}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"space-between",gap:10},children:[e.jsx("div",{style:{fontSize:24,letterSpacing:-.3,color:"var(--white)",lineHeight:1.05,fontWeight:600},children:d.title}),R===0&&e.jsx("span",{style:{fontSize:13,color:"var(--white)",whiteSpace:"nowrap",fontWeight:500},children:"View →"})]})]})]},d.id)})}),e.jsx("div",{style:{position:"absolute",bottom:k?22:30,left:0,right:0,display:"flex",justifyContent:"center",gap:9,zIndex:20},children:O.map((d,b)=>e.jsx("div",{onClick:()=>o(b),...s,style:{width:b===i?26:8,height:8,borderRadius:980,background:b===i?"#38bdf8":y?"rgba(20,17,11,.3)":"rgba(245,242,237,.28)",cursor:"none",transition:"all .45s var(--ease-out)"}},b))})]},"work")}function Ce(){const[t,s]=r.useState(!1);return e.jsx(h.div,{...F,style:{position:"absolute",inset:0,background:"var(--cream)",overflow:"hidden"},className:"ss-about-page",children:e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"1fr 1fr",height:"100%",width:"100%"},children:[e.jsxs("div",{className:"ss-about-text-column",style:{display:"flex",flexDirection:"column",justifyContent:"center",padding:window.innerWidth<=640?"60px 3vw 60px 3vw":"clamp(32px, 6vh, 80px) 60px clamp(32px, 6vh, 80px) 8vw",overflow:"hidden"},children:[e.jsx(h.div,{initial:{opacity:0,x:-20},animate:{opacity:1,x:0},transition:{duration:.7,delay:.1,ease:N},className:"ss-about-subtitle",style:{fontFamily:"'Space Mono', monospace",fontSize:12,letterSpacing:4,textTransform:"uppercase",color:"var(--accent)",marginBottom:16},children:"Designer & Maker"}),e.jsxs(h.h2,{initial:{opacity:0,x:-30},animate:{opacity:1,x:0},transition:{duration:.8,delay:.2,ease:N},style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(64px,7.4vw,124px)",letterSpacing:4,lineHeight:.92,color:"#060606",marginBottom:16},children:["Shyon",e.jsx("br",{}),"Shiri"]}),e.jsx(h.div,{className:"ss-about-rule",initial:{width:0},animate:{width:80},transition:{duration:1,delay:.5,ease:N},style:{height:1,background:"#060606",margin:"16px 0"}}),e.jsxs(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.55,ease:N},children:[e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:20,fontWeight:300,lineHeight:1.75,color:"#3a3a3a",maxWidth:480},children:"I'm a graphic designer and developer in the Bay Area, with a BA in Graphic Design from San Jose State, 2025. I take a project from identity through to a deployed site, so design, front end, and deployment are one job rather than three handoffs. I also evaluate multimodal AI systems against rubrics, writing the corrected ground truth where models fail."}),e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:20,fontWeight:300,lineHeight:1.75,color:"#3a3a3a",maxWidth:480,marginTop:20},children:"Most of what I design ends up physical or interactive rather than sitting on a page. That is why the same portfolio holds 3D printed hardware enclosures, a welded steel sculpture, and a LEGO world running in this browser."})]})]}),e.jsxs(h.div,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.9,delay:.1},style:{position:"relative",overflow:"hidden",background:"#1a1a1a"},children:[e.jsx("img",{src:"/assets/Shyon_About.png",alt:"Shyon Shiri",onLoad:()=>s(!0),className:t?"ss-about-photo ss-about-photo-active":"ss-about-photo",style:{width:"100%",height:"100%",objectFit:"cover",objectPosition:"center 10%",filter:"grayscale(20%) contrast(1.05)"}}),e.jsx("div",{style:{position:"absolute",inset:0,background:"linear-gradient(to right, rgba(237,232,224,.2) 0%, transparent 30%), linear-gradient(to bottom, rgba(6,6,6,.35) 0%, transparent 30%, transparent 60%, rgba(6,6,6,.18) 100%)"}})]})]})},"about")}function Ie(){const t=I(),s=[{href:"mailto:shyon2001@gmail.com",label:"Email Me",value:"shyon2001@gmail.com",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:e.jsx("path",{d:"M3 8l9 6 9-6M3 8v10a1 1 0 001 1h16a1 1 0 001-1V8M3 8a1 1 0 011-1h16a1 1 0 011 1"})})},{href:"https://www.linkedin.com/in/shyonshiri/",label:"LinkedIn",value:"in/shyonshiri",target:"_blank",icon:e.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",children:e.jsx("path",{d:"M20.45 20.45h-3.55v-5.57c0-1.33-.03-3.04-1.85-3.04-1.85 0-2.14 1.45-2.14 2.94v5.67H9.35V9h3.41v1.56h.05c.48-.9 1.64-1.85 3.37-1.85 3.6 0 4.27 2.37 4.27 5.45v6.29zM5.34 7.43a2.06 2.06 0 110-4.12 2.06 2.06 0 010 4.12zm1.78 13.02H3.56V9h3.56v11.45zM22.23 0H1.77C.8 0 0 .77 0 1.72v20.56C0 23.23.8 24 1.77 24h20.46c.98 0 1.77-.77 1.77-1.72V1.72C24 .77 23.2 0 22.23 0z"})})},{href:"/My Resume.pdf",label:"Resume",value:"My Resume.pdf",target:"_blank",icon:e.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[e.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),e.jsx("polyline",{points:"14 2 14 8 20 8"}),e.jsx("line",{x1:"16",y1:"13",x2:"8",y2:"13"}),e.jsx("line",{x1:"16",y1:"17",x2:"8",y2:"17"})]})}];return e.jsxs(h.div,{...F,style:{position:"absolute",inset:0,background:"#060606",display:"flex",flexDirection:"column",justifyContent:"center",overflow:"hidden"},children:[e.jsx("div",{style:{position:"absolute",left:-30,bottom:"-12vh",fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(220px, 34vw, 460px)",lineHeight:.8,letterSpacing:6,color:"rgba(245,242,237,.05)",whiteSpace:"nowrap",filter:"blur(9px)",zIndex:1,userSelect:"none",pointerEvents:"none"},children:"CONTACT"}),e.jsx("div",{style:{position:"absolute",right:"-12vw",top:"-22vh",width:"min(900px, 100vw)",height:"min(900px, 100vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.35) 0%, rgba(56,189,248,0) 65%)",filter:"blur(65px)",zIndex:1,pointerEvents:"none"}}),e.jsx("div",{style:{position:"absolute",left:"-15vw",bottom:"-25vh",width:"min(1100px, 120vw)",height:"min(1100px, 120vw)",borderRadius:"50%",background:"radial-gradient(circle, rgba(56,189,248,.15) 0%, rgba(56,189,248,0) 60%)",filter:"blur(75px)",zIndex:1,pointerEvents:"none"}}),e.jsxs("div",{style:{position:"relative",zIndex:10,padding:window.innerWidth<=640?"0 18px":"0 9vw",width:"100%"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",gap:window.innerWidth<=640?20:40,flexWrap:"wrap",marginBottom:window.innerWidth<=640?24:44},children:[e.jsx("div",{children:e.jsxs(h.h2,{initial:{opacity:0,y:30},animate:{opacity:1,y:0},transition:{duration:.9,delay:.35,ease:N},className:"ss-contact-heading",style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:"clamp(64px,9vw,128px)",letterSpacing:5,lineHeight:.86,color:"var(--white)"},children:["Let's Work",e.jsx("span",{style:{color:"var(--white)"},children:"."})]})}),e.jsx(h.p,{initial:{opacity:0},animate:{opacity:1},transition:{duration:.8,delay:.5},className:"ss-contact-description",style:{fontFamily:"'Cormorant Garamond', serif",fontStyle:"italic",fontWeight:300,fontSize:"clamp(18px,2vw,22px)",color:"var(--mid)",maxWidth:280,textAlign:"right",marginBottom:8},children:"Open to freelance, collaborations & full-time roles."})]}),e.jsx(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},transition:{duration:.8,delay:.65,ease:N},style:{display:"flex",flexDirection:"column",borderTop:"1px solid rgba(245,242,237,.14)"},children:s.map((n,c)=>e.jsxs("a",{href:n.href,target:n.target,rel:n.target?"noopener noreferrer":void 0,style:{display:"flex",alignItems:"center",gap:window.innerWidth<=640?16:28,padding:window.innerWidth<=640?"16px 8px":"26px 8px",textDecoration:"none",borderBottom:"1px solid rgba(245,242,237,.14)",transition:"background 0.3s ease, padding-left 0.3s ease",cursor:"none"},onMouseEnter:i=>{i.currentTarget.style.background="rgba(56,189,248,.07)",i.currentTarget.style.paddingLeft="24px"},onMouseLeave:i=>{i.currentTarget.style.background="transparent",i.currentTarget.style.paddingLeft="8px"},...t,children:[e.jsx("span",{style:{fontFamily:"'Space Mono', monospace",fontSize:window.innerWidth<=640?10:12,letterSpacing:2,color:"var(--sky)",width:34,flexShrink:0},children:String(c+1).padStart(2,"0")}),e.jsx("span",{style:{fontFamily:"'Bebas Neue', sans-serif",fontSize:window.innerWidth<=640?"clamp(18px,3vw,28px)":"clamp(28px,4vw,40px)",letterSpacing:2,color:"var(--white)",width:window.innerWidth<=640?"auto":240,flexShrink:0},children:n.label}),e.jsx("span",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:window.innerWidth<=640?14:20,color:"var(--mid)",flex:1,minWidth:0,overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap"},children:n.value}),e.jsx("span",{style:{fontFamily:"'Space Mono', monospace",fontSize:18,color:"var(--sky)",flexShrink:0},children:"→"})]},n.label))})]})]},"contact")}function ze({project:t,from:s,onClose:n,onMediaClick:c}){const i=I(),[o,m]=r.useState(window.innerWidth>=1024),p=r.useRef(null),g=r.useRef(null),[a,k]=r.useState(null),w=q(),S=q();r.useLayoutEffect(()=>{const f=p.current;if(!f)return;const u=f.getBoundingClientRect(),y=B?null:s?.rect;if(!y||!u.width||!u.height||!y.width||!y.height){w.set({x:0,y:0,scaleX:B?1:.96,scaleY:B?1:.96,opacity:0}),w.start({x:0,y:0,scaleX:1,scaleY:1,opacity:1,transition:{duration:B?.001:.4,ease:N}});return}const x={x:y.left+y.width/2-(u.left+u.width/2),y:y.top+y.height/2-(u.top+u.height/2),sx:y.width/u.width,sy:y.height/u.height};k(x);const j=g.current;if(j&&s){j.style.left=u.left+"px",j.style.top=u.top+"px",j.style.width=u.width+"px",j.style.height=u.height+"px";const l=s.node;l.style.transform="none",l.style.position="absolute",l.style.inset="0",l.style.width="100%",l.style.height="100%",l.style.margin="0",l.style.zIndex="0",j.replaceChildren(l)}w.set({x:x.x,y:x.y,scaleX:x.sx,scaleY:x.sy,opacity:0}),S.set({x:x.x,y:x.y,scaleX:x.sx,scaleY:x.sy,opacity:1});const v={duration:.62,ease:N};w.start({x:0,y:0,scaleX:1,scaleY:1,opacity:1,transition:{...v,opacity:{duration:.3,delay:.12,ease:"linear"}}}),S.start({x:0,y:0,scaleX:1,scaleY:1,opacity:0,transition:{...v,opacity:{duration:.34,ease:"linear"}}})},[]);const A=a?{x:a.x,y:a.y,scaleX:a.sx,scaleY:a.sy,opacity:0,transition:{duration:.42,ease:N,opacity:{duration:.16,delay:.24,ease:"linear"}}}:B?{opacity:0,transition:{duration:.001}}:{opacity:0,scaleX:.96,scaleY:.96,transition:{duration:.3,ease:N}};return r.useEffect(()=>(document.body.style.overflow="hidden",()=>{document.body.style.overflow=""}),[]),r.useEffect(()=>{const f=()=>{m(window.innerWidth>=1024)};return window.addEventListener("resize",f),()=>window.removeEventListener("resize",f)},[]),e.jsxs(h.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.42,ease:"linear"},onClick:n,style:{position:"fixed",inset:0,zIndex:2e3,background:"rgba(6,6,6,.93)",backdropFilter:"blur(20px)",display:"flex",alignItems:"center",justifyContent:"center"},children:[s&&!B&&e.jsx(h.div,{ref:g,animate:S,exit:{opacity:0,transition:{duration:.12}},"aria-hidden":!0,style:{position:"fixed",left:0,top:0,zIndex:2002,pointerEvents:"none",overflow:"hidden"}}),e.jsxs(h.div,{ref:p,initial:!1,animate:w,exit:A,onClick:f=>f.stopPropagation(),className:"ss-work-modal",style:{position:"relative",width:"76vw",maxWidth:1080,maxHeight:"80dvh",display:"flex",flexDirection:"column"},children:[e.jsx("button",{onClick:n,className:"ss-modal-close",style:{position:"absolute",top:60,right:20,background:"none",border:"none",cursor:"none",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:2001},...i,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",alignItems:"flex-end",justifyContent:"space-between",paddingBottom:18,borderBottom:"1px solid rgba(245,242,237,.1)",marginBottom:22},children:e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontSize:"clamp(36px,4.4vw,64px)",letterSpacing:"-0.02em",fontWeight:700,lineHeight:1,color:"var(--white)"},children:t.title}),e.jsx("div",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:16,color:"var(--sky)",marginTop:8},children:t.id==="creative-projects"?"A selection of projects that demonstrate my range across various creative disciplines and mediums.":t.id==="professional-services"?"Client-focused work including UI/UX, web development, branding and marketing assets.":t.id==="nabu"?"Design and creative direction for NABU, a streetwear brand that draws from Persian and Assyrian heritage.":"testing"})]})}),["creative-projects","professional-services"].includes(t.id)?e.jsxs("div",{style:{position:"relative",flex:1,minHeight:0,display:"flex",flexDirection:"column"},children:[e.jsx("div",{className:"ss-scroll",style:{flex:1,minHeight:0,overflowY:"auto",overflowX:"hidden",paddingRight:8,display:"flex",gap:14,alignItems:"flex-start"},children:(()=>{const f=t.media.filter(x=>!x.hidden),u=window.innerWidth<=640?2:window.innerWidth<=1023?3:4,y=Array.from({length:u},()=>[]);return f.forEach((x,j)=>y[j%u].push(x)),y.map((x,j)=>e.jsx("div",{style:{flex:1,minWidth:0,display:"flex",flexDirection:"column",gap:14},children:x.map((v,l)=>e.jsx(Be,{item:v,onClick:()=>c(v)},l))},j))})()}),e.jsx("div",{className:"ss-scroll-fade"})]}):e.jsx("div",{className:"ss-modal-grid",style:{display:"grid",gridTemplateColumns:t.id==="3d-rendering"?"repeat(3, 240px)":t.id==="fabrication"?"repeat(1, 420px)":["3d-modelling","programming"].includes(t.id)?"repeat(2, 300px)":"repeat(4, 220px)",gap:38,overflowY:"auto",overflowX:"hidden",maxHeight:"calc(80dvh - 150px)",paddingRight:8,justifyContent:"center",gridAutoRows:"max-content"},children:t.media.filter(f=>!f.hidden).map((f,u)=>e.jsx(Me,{item:f,onClick:()=>c(f)},u))}),!o&&e.jsx("div",{style:{marginTop:24,textAlign:"center",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:1,color:"var(--mid)",textTransform:"uppercase"},children:"↻ Swipe to explore"})]})]})}function Be({item:t,onClick:s}){const n=I(),c=t.aspectRatio||"4/3";return e.jsxs("div",{className:"ss-scell",onClick:s,...n,children:[e.jsxs("div",{className:"ss-sthumb",style:{aspectRatio:c},children:[e.jsx("img",{src:t.type==="video"?t.poster:t.src,alt:t.title,loading:"lazy"}),t.type==="video"&&e.jsx("div",{style:{position:"absolute",top:12,right:12,width:34,height:34,borderRadius:"50%",background:"rgba(6,6,6,.5)",border:"1px solid rgba(245,242,237,.35)",display:"flex",alignItems:"center",justifyContent:"center",backdropFilter:"blur(6px)"},children:e.jsx("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:2},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})]}),e.jsxs("div",{className:"ss-sbody",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:13,fontWeight:600,color:"var(--white)",lineHeight:1.25},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,color:"var(--mid)",marginTop:4},children:t.year})]})]})}function Me({item:t,onClick:s}){const n=I();return e.jsxs("div",{className:"ss-tile",onClick:s,style:{position:"relative",overflow:"hidden",background:"#111",minHeight:t.type==="video"?"250px":"auto",cursor:"none",borderRadius:12,aspectRatio:t.aspectRatio?t.aspectRatio:void 0},...n,children:[t.type==="video"?e.jsxs(e.Fragment,{children:[e.jsx("img",{src:t.poster,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:"cover"}}),e.jsx("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",background:"rgba(6,6,6,.3)",transition:"background 0.3s ease"},children:e.jsx("div",{style:{width:52,height:52,borderRadius:"50%",border:"1.5px solid rgba(245,242,237,.7)",display:"flex",alignItems:"center",justifyContent:"center",transition:"transform 0.3s ease, border-color 0.3s ease"},children:e.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"var(--white)",style:{marginLeft:3},children:e.jsx("path",{d:"M8 5v14l11-7z"})})})})]}):e.jsx("img",{src:t.src,alt:t.title,loading:"lazy",style:{width:"100%",height:"100%",objectFit:t.aspectRatio?"cover":"contain"}}),e.jsxs("div",{style:{position:"absolute",bottom:0,left:0,right:0,padding:"20px 16px 14px",background:"linear-gradient(to top, rgba(6,6,6,.85) 0%, transparent 100%)",opacity:0,transition:"opacity 0.3s ease"},className:"ss-tile-info",children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:14,color:"var(--white)",fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,color:"var(--sky)",letterSpacing:1,marginTop:2},children:t.year})]})]})}function Pe({item:t,onClose:s,onItemClick:n}){const c=I(),i=t;return e.jsx(h.div,{initial:{opacity:0},animate:{opacity:1},exit:{opacity:0},transition:{duration:.35},onClick:s,style:{position:"fixed",inset:0,zIndex:3e3,background:"rgba(6,6,6,.97)",backdropFilter:"blur(30px)",display:"flex",alignItems:"center",justifyContent:"center"},children:e.jsxs(h.div,{initial:{opacity:0,scale:.96},animate:{opacity:1,scale:1},exit:{opacity:0,scale:.96},transition:{duration:.35,ease:N},onClick:o=>o.stopPropagation(),className:"ss-media-viewer",style:{position:"relative",maxWidth:"92vw",maxHeight:"88dvh",display:"flex",alignItems:"flex-start",gap:48},children:[e.jsx("button",{onClick:s,className:"ss-media-viewer-close",style:{position:"absolute",top:100,right:20,background:"none",border:"none",cursor:"none",fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--mid)",transition:"color 0.3s ease",padding:"4px 8px",zIndex:3001},...c,children:"✕ Close"}),e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:16,flexShrink:0},children:e.jsx("div",{style:{width:"60vw",height:"80dvh",display:"flex",alignItems:"center",justifyContent:"center",overflow:"hidden",borderRadius:20,flexShrink:0,backgroundColor:i.removeBackground?"transparent":"inherit",position:"relative"},children:i.type==="video"?e.jsx("video",{src:i.src,poster:i.poster,controls:!0,autoPlay:!0,muted:!0,playsInline:!0,style:{width:"100%",height:"100%",objectFit:"contain",maxWidth:"100%",maxHeight:"100%",display:"block"}},i.src):e.jsx("img",{src:i.src,alt:i.title,style:{width:"100%",height:"100%",objectFit:"contain",transform:i.scale?`scale(${i.scale})`:"scale(1)"}},i.src)})}),e.jsxs("div",{style:{flex:1,minWidth:200,maxWidth:340,paddingTop:140},children:[e.jsx("div",{className:"ss-asset-title",style:{fontSize:64,letterSpacing:.5,lineHeight:1.02,color:"var(--white)",marginBottom:24,fontWeight:600},children:t.title}),e.jsx("div",{style:{fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,color:"var(--sky)",textTransform:"uppercase",marginBottom:20},children:t.year}),t.desc&&e.jsx("p",{style:{fontFamily:"'Cormorant Garamond', serif",fontSize:18,lineHeight:1.7,color:"rgba(245,242,237,.75)",fontWeight:300,marginBottom:32},children:t.desc}),t.relatedItems&&t.relatedItems.length>0?e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:12,marginTop:48},children:t.relatedItems.map((o,m)=>e.jsxs("button",{onClick:()=>{const p=O.flatMap(g=>g.media).find(g=>g.title===o);p&&n&&n(p)},style:{display:"inline-flex",alignItems:"center",gap:8,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)",background:"none",border:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none",textDecoration:"none",textAlign:"left"},...c,children:["View ",o," →"]},m))}):null,t.link&&e.jsx("a",{href:t.link,target:"_blank",rel:"noopener noreferrer",style:{display:"inline-flex",alignItems:"center",gap:8,marginTop:28,fontFamily:"'Space Mono', monospace",fontSize:10,letterSpacing:2,textTransform:"uppercase",color:"var(--sky)",textDecoration:"none",borderBottom:"1px solid var(--sky)",paddingBottom:2,cursor:"none"},...c,children:"Visit Website →"})]})]})})}re.createRoot(document.getElementById("root")).render(e.jsx(r.StrictMode,{children:e.jsx(ce,{})}));
