...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    media: [
      ...
      { type: "image", src: "/assets/RealEstate_Luning_Alt.jpg", title: "Luning Dr — Alternate Layout", year: 2022, desc: "An alternate take on the same listing flyer, reworking the hero crop and information layout to explore a different visual balance.", aspectRatio: "3/4" },
