...
**Homepage storyboard pass (2026-08-25, NOT yet committed or deployed):** the homepage now scrolls. The naming is now **"Lego Realm"** (user says "My Lego Realm"; renamed from "My Space", see memory). Changes, all in `src/App.tsx` plus new assets:
